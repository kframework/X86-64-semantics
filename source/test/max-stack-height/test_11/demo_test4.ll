...
define x86_64_sysvcc i64 @demo4_entry(i64 inreg) {
driverBlock:
  %1 = alloca %struct.regs
  %2 = getelementptr inbounds %struct.regs* %1, i64 0, i32 5
  store i64 %0, i64* %2
  %3 = getelementptr inbounds %struct.regs* %1, i64 0, i32 3
  store i64 %0, i64* %3
  %4 = getelementptr inbounds %struct.regs* %1, i64 0, i32 8
  store i64 %0, i64* %4
  %rl = alloca %struct.rlimit
  %5 = getelementptr inbounds %struct.rlimit* %rl, i32 0, i32 0
  store i64 0, i64* %5
  %6 = ptrtoint %struct.rlimit* %rl to i64
  %7 = call x86_64_sysvcc i64 @getrlimit(i32 3, i64 %6)
  %8 = getelementptr %struct.rlimit* %rl, i64 0, i32 0
  %9 = load i64* %8
  %10 = call x86_64_sysvcc i64 @mmap(i64 0, i64 %9, i32 3, i32 131106, i32 -1, i32 0)
  %11 = add i64 %10, %9
  %12 = add i64 %11, -104
  %13 = getelementptr inbounds %struct.regs* %1, i64 0, i32 6
  %14 = getelementptr inbounds %struct.regs* %1, i64 0, i32 70
  %15 = getelementptr inbounds %struct.regs* %1, i64 0, i32 71
  store i64 %10, i64* %15
  store i64 %11, i64* %14
  %16 = getelementptr inbounds %struct.regs* %1, i64 0, i32 23
  store i1 false, i1* %16
  store i64 %12, i64* %13
  call x86_64_sysvcc void @sub_20(%struct.regs* %1)
  %rl1 = alloca %struct.rlimit
  %17 = getelementptr inbounds %struct.rlimit* %rl1, i32 0, i32 0
  store i64 0, i64* %17
  %18 = ptrtoint %struct.rlimit* %rl1 to i64
  %19 = call x86_64_sysvcc i64 @getrlimit(i32 3, i64 %18)
  %20 = getelementptr %struct.rlimit* %rl1, i64 0, i32 0
  %21 = load i64* %20
  %22 = tail call x86_64_sysvcc i32 @munmap(i64 %10, i64 %21)
  %23 = getelementptr inbounds %struct.regs* %1, i64 0, i32 0
  %24 = load i64* %23
  ret i64 %24
}

declare x86_64_sysvcc i64 @getrlimit(i32, i64)

declare x86_64_sysvcc i64 @mmap(i64, i64, i32, i32, i32, i32)

declare x86_64_sysvcc i32 @munmap(i64, i64)
