...
block_0x98:                                       ; preds = %block_0x74
  ...
  %.lcssa7.lcssa = phi i64 [ %.lcssa7, %block_0x74 ]
  %.lcssa8.lcssa = phi i64 [ %.lcssa8, %block_0x74 ]
  ...
  %75 = add i64 %2, -40
  %76 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 3), i64 %.lcssa8.lcssa), !mcsema_real_eip !7
  %77 = add i64 %2, -28, !mcsema_real_eip !8
  %78 = trunc i64 %76 to i32, !mcsema_real_eip !8
  %79 = inttoptr i64 %77 to i32*
  store i32 %78, i32* %79, align 4, !mcsema_real_eip !8
  %uadd75 = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %75, i64 32)
  %80 = extractvalue { i64, i1 } %uadd75, 0
  %81 = xor i64 %80, %75, !mcsema_real_eip !9
  %82 = and i64 %81, 16, !mcsema_real_eip !9
  %83 = icmp ne i64 %82, 0, !mcsema_real_eip !9
  %84 = icmp slt i64 %80, 0
  %85 = icmp eq i64 %80, 0, !mcsema_real_eip !9
  %86 = add i64 %2, 9223372036854775768
  %87 = and i64 %81, %86, !mcsema_real_eip !9
  %88 = icmp slt i64 %87, 0
  %89 = trunc i64 %80 to i8, !mcsema_real_eip !9
  %90 = tail call i8 @llvm.ctpop.i8(i8 %89), !mcsema_real_eip !9
  %91 = and i8 %90, 1
  %92 = icmp eq i8 %91, 0
  %93 = extractvalue { i64, i1 } %uadd75, 1
  %94 = inttoptr i64 %80 to i64*, !mcsema_real_eip !10
  %95 = load i64* %94, align 8, !mcsema_real_eip !10
  %96 = add i64 %80, 16, !mcsema_real_eip !11
  store i64 %76, i64* %RAX, align 8, !mcsema_real_eip !11
  store i64 %1, i64* %RBX, align 8, !mcsema_real_eip !11
  store i64 %.lcssa.lcssa, i64* %RCX, align 8, !mcsema_real_eip !11
  store i64 %.lcssa7.lcssa, i64* %RDX, align 8, !mcsema_real_eip !11
  store i64 %.lcssa8.lcssa, i64* %RSI, align 8, !mcsema_real_eip !11
  store i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 3), i64* %RDI, align 8, !mcsema_real_eip !11
  store i64 %96, i64* %RSP, align 8, !mcsema_real_eip !11
  store i64 %95, i64* %RBP, align 8, !mcsema_real_eip !11
  %97 = bitcast i64* %R8 to <2 x i64>*
  store <2 x i64> %5, <2 x i64>* %97, align 8
  %98 = bitcast i64* %R10 to <2 x i64>*
  store <2 x i64> %7, <2 x i64>* %98, align 8
  %99 = bitcast i64* %R12 to <2 x i64>*
  store <2 x i64> %9, <2 x i64>* %99, align 8
  %100 = bitcast i64* %R14 to <2 x i64>*
  store <2 x i64> %11, <2 x i64>* %100, align 8
  store i64 %12, i64* %RIP, align 8, !mcsema_real_eip !11
  store i1 %93, i1* %CF, align 1, !mcsema_real_eip !11
  store i1 %92, i1* %PF, align 1, !mcsema_real_eip !11
  store i1 %83, i1* %AF, align 1, !mcsema_real_eip !11
  store i1 %85, i1* %ZF, align 1, !mcsema_real_eip !11
  store i1 %84, i1* %SF, align 1, !mcsema_real_eip !11
  store i1 %88, i1* %OF, align 1, !mcsema_real_eip !11
  ...
  store <2 x i64> %64, <2 x i64>* %101, align 1
...
block_0x74:                                       ; preds = %block_0x30
  %.lcssa8 = phi i64 [ %121, %block_0x30 ]
  %.lcssa7 = phi i64 [ %115, %block_0x30 ]
  %.lcssa = phi i64 [ %112, %block_0x30 ]
  %102 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 3), i64 %.lcssa8), !mcsema_real_eip !12
  %103 = trunc i64 %102 to i32, !mcsema_real_eip !6
  store i32 %103, i32* %74, align 4, !mcsema_real_eip !6
  %104 = load i32* %68, align 4, !mcsema_real_eip !13
  %105 = add i32 %104, 1
  store i32 %105, i32* %68, align 4, !mcsema_real_eip !14
  %106 = add i32 %104, -6
  %107 = icmp slt i32 %106, 0
  %108 = sub i32 5, %104
  %109 = and i32 %105, %108
  %110 = icmp slt i32 %109, 0
  %tmp74 = xor i1 %107, %110
  br i1 %tmp74, label %block_0x1c, label %block_0x98, !mcsema_real_eip !15

block_0x30:                                       ; preds = %block_0x30, %block_0x1c
  %111 = phi i32 [ 0, %block_0x1c ], [ %125, %block_0x30 ]
  %112 = sext i32 %111 to i64, !mcsema_real_eip !16
  %113 = load i32* %68, align 4, !mcsema_real_eip !17
  %114 = sext i32 %113 to i64, !mcsema_real_eip !17
  %115 = mul i64 %114, 11, !mcsema_real_eip !18
  %116 = add i64 %112, ptrtoint (%0* @data_0x3b2 to i64)
  %117 = add i64 %116, %115, !mcsema_real_eip !19
  %118 = inttoptr i64 %117 to i8*
  %119 = load i8* %118, align 1, !mcsema_real_eip !19
  %120 = sext i8 %119 to i64
  %121 = and i64 %120, 4294967295
  %122 = tail call x86_64_sysvcc i64 @printf(i64 ptrtoint (%1* @data_0x3ff to i64), i64 %121), !mcsema_real_eip !20
...
block_0x13d.i:                                    ; preds = %block_0x130.i, %block_0x13d.i.preheader
  ...
  %RSI_val.1.i = phi i64 [ %RSI_val.8.i, %block_0x130.i ], [ %68, %block_0x13d.i.preheader ]
  ...
  %112 = add i64 %110, %111, !mcsema_real_eip !43
...
block_0x1f8.i:                                    ; preds = %block_0x17c.i, %block_0x1a4.i
  %159 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 5), i64 %RSI_val.1.i), !mcsema_real_eip !74
  ...
  %163 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 45), i64 %RSI_val.1.i), !mcsema_real_eip !76
...
block_0x256.i:                                    ; preds = %block_0x1f8.i, %block_0x22a.i
  %190 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 56), i64 35), !mcsema_real_eip !84
  ...
  %194 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 66), i64 %111), !mcsema_real_eip !86
...
block_0x317.i:                                    ; preds = %block_0x2fe.i, %block_0x256.i, %block_0x28c.i
  ...
  %RSI_val.3.i = phi i64 [ %209, %block_0x256.i ], [ %232, %block_0x2fe.i ], [ %188, %block_0x28c.i ]
...
block_0x2b8.i:                                    ; preds = %block_0x256.i, %block_0x28c.i
  ...
  %RSI_val.4.i = phi i64 [ %209, %block_0x256.i ], [ %188, %block_0x28c.i ]
...
block_0x30b.i:                                    ; preds = %block_0x2fe.i, %block_0x2c5.i, %block_0x2b8.i
  %RSI_val.5.i = phi i64 [ %232, %block_0x2fe.i ], [ %232, %block_0x2c5.i ], [ %RSI_val.4.i, %block_0x2b8.i ]
...
block_0x34d.i:                                    ; preds = %block_0x323.i, %block_0x30b.i, %block_0x317.i
  ...
  %RSI_val.6.i = phi i64 [ %RSI_val.7.i, %block_0x323.i ], [ %RSI_val.3.i, %block_0x317.i ], [ %RSI_val.5.i, %block_0x30b.i ]
  ...
  store i64 %RSI_val.6.i, i64* %RSI.i, align 8, !mcsema_real_eip !111
...
block_0x323.i:                                    ; preds = %block_0x30b.i, %block_0x317.i
  ...
  %RSI_val.7.i = phi i64 [ %RSI_val.3.i, %block_0x317.i ], [ %RSI_val.5.i, %block_0x30b.i ]
...
block_0x32f.i:                                    ; preds = %block_0x323.i
  %330 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 85), i64 %RSI_val.7.i), !mcsema_real_eip !119
  ...
  store i64 %RSI_val.7.i, i64* %RSI.i, align 8, !mcsema_real_eip !111
...
block_0x130.i:                                    ; preds = %block_0x32f.i, %block_0x34d.i
  ...
  %RSI_val.8.in.i = phi i32 [ %421, %block_0x32f.i ], [ %321, %block_0x34d.i ]
  ...
  %RSI_val.8.i = zext i32 %RSI_val.8.in.i to i64
  ...
  br i1 %tmp364.i, label %block_0x13d.i, label %sub_c0.exit.loopexit, !mcsema_real_eip !37
...
sub_c0.exit.loopexit:                             ; preds = %block_0x130.i
  %RSI_val.8.i.lcssa = phi i64 [ %RSI_val.8.i, %block_0x130.i ]
...
sub_c0.exit:                                      ; preds = %sub_c0.exit.loopexit, %driverBlockRaw
  %R15_val.0.i = phi i64 [ %12, %driverBlockRaw ], [ %R15_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %STACK_LIMIT_val.0.i = phi i64 [ %64, %driverBlockRaw ], [ %STACK_LIMIT_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %STACK_BASE_val.0.i = phi i64 [ %63, %driverBlockRaw ], [ %STACK_BASE_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM15_val.0.i = phi i128 [ %62, %driverBlockRaw ], [ %XMM15_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM14_val.0.i = phi i128 [ %61, %driverBlockRaw ], [ %XMM14_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM13_val.0.i = phi i128 [ %60, %driverBlockRaw ], [ %XMM13_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM12_val.0.i = phi i128 [ %59, %driverBlockRaw ], [ %XMM12_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM11_val.0.i = phi i128 [ %58, %driverBlockRaw ], [ %XMM11_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM10_val.0.i = phi i128 [ %57, %driverBlockRaw ], [ %XMM10_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM9_val.0.i = phi i128 [ %56, %driverBlockRaw ], [ %XMM9_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM8_val.0.i = phi i128 [ %55, %driverBlockRaw ], [ %XMM8_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM7_val.0.i = phi i128 [ %54, %driverBlockRaw ], [ %XMM7_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM6_val.0.i = phi i128 [ %53, %driverBlockRaw ], [ %XMM6_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM5_val.0.i = phi i128 [ %52, %driverBlockRaw ], [ %XMM5_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM4_val.0.i = phi i128 [ %51, %driverBlockRaw ], [ %XMM4_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM3_val.0.i = phi i128 [ %50, %driverBlockRaw ], [ %XMM3_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM2_val.0.i = phi i128 [ %49, %driverBlockRaw ], [ %XMM2_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM1_val.0.i = phi i128 [ %48, %driverBlockRaw ], [ %XMM1_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %XMM0_val.0.i = phi i128 [ %47, %driverBlockRaw ], [ %XMM0_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_LASTDATA_OFF_val.0.i = phi i64 [ %46, %driverBlockRaw ], [ %FPU_LASTDATA_OFF_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_LASTDATA_SEG_val.0.i = phi i16 [ %45, %driverBlockRaw ], [ %FPU_LASTDATA_SEG_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_LASTIP_OFF_val.0.i = phi i64 [ %44, %driverBlockRaw ], [ %FPU_LASTIP_OFF_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_LASTIP_SEG_val.0.i = phi i16 [ %43, %driverBlockRaw ], [ %FPU_LASTIP_SEG_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_TAG_val.sroa.0.0.i = phi i64 [ %42, %driverBlockRaw ], [ %FPU_TAG_val.sroa.0.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_IM_val.0.i = phi i1 [ %39, %driverBlockRaw ], [ %FPU_IM_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_DM_val.0.i = phi i1 [ %38, %driverBlockRaw ], [ %FPU_DM_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_ZM_val.0.i = phi i1 [ %37, %driverBlockRaw ], [ %FPU_ZM_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_OM_val.0.i = phi i1 [ %36, %driverBlockRaw ], [ %FPU_OM_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_UM_val.0.i = phi i1 [ %35, %driverBlockRaw ], [ %FPU_UM_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_PM_val.0.i = phi i1 [ %34, %driverBlockRaw ], [ %FPU_PM_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_PC_val.0.i = phi i2 [ %33, %driverBlockRaw ], [ %FPU_PC_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_RC_val.0.i = phi i2 [ %32, %driverBlockRaw ], [ %FPU_RC_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_X_val.0.i = phi i1 [ %31, %driverBlockRaw ], [ %FPU_X_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_IE_val.0.i = phi i1 [ %30, %driverBlockRaw ], [ %FPU_IE_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_DE_val.0.i = phi i1 [ %29, %driverBlockRaw ], [ %FPU_DE_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_ZE_val.0.i = phi i1 [ %28, %driverBlockRaw ], [ %FPU_ZE_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_OE_val.0.i = phi i1 [ %27, %driverBlockRaw ], [ %FPU_OE_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_UE_val.0.i = phi i1 [ %26, %driverBlockRaw ], [ %FPU_UE_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_PE_val.0.i = phi i1 [ %25, %driverBlockRaw ], [ %FPU_PE_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_SF_val.0.i = phi i1 [ %24, %driverBlockRaw ], [ %FPU_SF_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_ES_val.0.i = phi i1 [ %23, %driverBlockRaw ], [ %FPU_ES_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_C0_val.0.i = phi i1 [ %22, %driverBlockRaw ], [ %FPU_C0_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_C1_val.0.i = phi i1 [ %21, %driverBlockRaw ], [ %FPU_C1_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_C2_val.0.i = phi i1 [ %20, %driverBlockRaw ], [ %FPU_C2_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_TOP_val.0.i = phi i3 [ %19, %driverBlockRaw ], [ %FPU_TOP_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_C3_val.0.i = phi i1 [ %18, %driverBlockRaw ], [ %FPU_C3_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %FPU_B_val.0.i = phi i1 [ %17, %driverBlockRaw ], [ %FPU_B_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %DF_val.0.i = phi i1 [ %14, %driverBlockRaw ], [ %DF_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %RIP_val.0.i = phi i64 [ %13, %driverBlockRaw ], [ %RIP_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %R14_val.0.i = phi i64 [ %11, %driverBlockRaw ], [ %R14_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %R13_val.0.i = phi i64 [ %10, %driverBlockRaw ], [ %R13_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %R12_val.0.i = phi i64 [ %9, %driverBlockRaw ], [ %R12_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %R11_val.0.i = phi i64 [ %8, %driverBlockRaw ], [ %R11_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %R10_val.0.i = phi i64 [ %7, %driverBlockRaw ], [ %R10_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %RSP_val.0.i = phi i64 [ %67, %driverBlockRaw ], [ %RSP_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %RBP_val.0.i = phi i64 [ %65, %driverBlockRaw ], [ %RBP_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %RSI_val.0.i = phi i64 [ %68, %driverBlockRaw ], [ %RSI_val.8.i.lcssa, %sub_c0.exit.loopexit ]
  %RDX_val.0.i = phi i64 [ 28, %driverBlockRaw ], [ %RDX_val.1.i.lcssa, %sub_c0.exit.loopexit ]
  %RBX_val.0.i = phi i64 [ %2, %driverBlockRaw ], [ %RBX_val.2.i.lcssa, %sub_c0.exit.loopexit ]
  %441 = phi <2 x i64> [ <i64 add (i64 ptrtoint (%0* @data_0x3b2 to i64), i64 11), i64 11>, %driverBlockRaw ], [ %.lcssa, %sub_c0.exit.loopexit ]
  %442 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 85), i64 %RSI_val.0.i), !mcsema_real_eip !123
