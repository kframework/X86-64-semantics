...
driverBlockRaw:
  ...
  %94 = add i32 %92, 20
  %95 = add i64 %6, -48, !mcsema_real_eip !9
...
block_0x3e.i.i:                                   ; preds = %driverBlockRaw
  ...
  %122 = add i64 %6, -44, !mcsema_real_eip !16
...
block_0x33.i.i:                                   ; preds = %driverBlockRaw
  ...
  %142 = add i64 %6, -44, !mcsema_real_eip !21
...
!9 = metadata !{i64 22, [21 x i8] c"\09movl\09%eax, -8(%rbp)\00"}
!10 = metadata !{i64 25, [21 x i8] c"\09movl\09-8(%rbp), %eax\00"}
...
!14 = metadata !{i64 62, [21 x i8] c"\09movl\09-8(%rbp), %eax\00"}
!15 = metadata !{i64 65, [16 x i8] c"\09subl\09$10, %eax\00"}
!16 = metadata !{i64 68, [21 x i8] c"\09movl\09%eax, -4(%rbp)\00"}
!17 = metadata !{i64 71, [21 x i8] c"\09movl\09-4(%rbp), %eax\00"}
...
!21 = metadata !{i64 57, [21 x i8] c"\09movl\09%eax, -4(%rbp)\00"}
