...
driverBlockRaw:
  ...
  %76 = tail call i8 @llvm.ctpop.i8(i8 %75), !mcsema_real_eip !3
  %77 = and i8 %76, 1
  %78 = icmp eq i8 %77, 0
  ...
  %84 = add i64 %7, -12, !mcsema_real_eip !4
  %85 = trunc i64 %6 to i32, !mcsema_real_eip !4
  %86 = inttoptr i64 %84 to i32*
  store i32 %85, i32* %86, align 4, !mcsema_real_eip !4
  %87 = inttoptr i64 %71 to i64*, !mcsema_real_eip !5
  store i64 %5, i64* %87, align 8, !mcsema_real_eip !5
  %88 = inttoptr i64 %5 to i64*, !mcsema_real_eip !6
  %89 = load i64* %88, align 8, !mcsema_real_eip !6
  %90 = tail call x86_64_sysvcc i64 @printf(i64 zext (i32 ptrtoint (%0* @data_0x2f to i32) to i64), i64 %89), !mcsema_real_eip !7
  %91 = load i64* %70, align 8, !mcsema_real_eip !8
  %92 = add i64 %7, 8, !mcsema_real_eip !9
  ...
  store i64 %89, i64* %RSI.i, align 8, !mcsema_real_eip !9
  store i64 zext (i32 ptrtoint (%0* @data_0x2f to i32) to i64), i64* %RDI.i, align 8, !mcsema_real_eip !9
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %20, i8* %1, i32 128, i32 8, i1 false), !mcsema_real_eip !9
...
!4 = metadata !{i64 8, [21 x i8] c"\09movl\09%edi, -4(%rbp)\00"}
!5 = metadata !{i64 11, [22 x i8] c"\09movq\09%rsi, -16(%rbp)\00"}
!6 = metadata !{i64 19, [19 x i8] c"\09movq\09(%rax), %rax\00"}
!7 = metadata !{i64 35, [9 x i8] c"\09callq\090\00"}
!8 = metadata !{i64 45, [7 x i8] c"\09leave\00"}
!9 = metadata !{i64 46, [6 x i8] c"\09retq\00"}
