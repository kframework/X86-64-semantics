...
print('[6;30;44m' + 'Opcode:punpckhwd_xmm_xmm' + '[0m')

R1 = BitVec('R1', 256)
R2 = BitVec('R2', 256)
CONST_BV_S16_V0 = BitVecVal(0, 16)

PK_R2 = (Concat(Extract( R2.size() - 0 - 1, R2.size() - 128, R2  ) , Concat(( ( ( Concat(Concat((CONST_BV_S16_V0), Extract( R1.size() - 144 - 1, R1.size() - 160, R1  ) ), Concat((CONST_BV_S16_V0), Extract( R1.size() - 144 - 1, R1.size() - 160, R1  ) )) | Concat(Extract( R1.size() - 128 - 1, R1.size() - 160, R1  ) , Concat(Extract( R1.size() - 144 - 1, R1.size() - 160, R1  ) , Extract( R1.size() - 144 - 1, R1.size() - 160, R1  ) )) )  ^ Concat(Concat((CONST_BV_S16_V0), Extract( R1.size() - 144 - 1, R1.size() - 160, R1  ) ), Concat((CONST_BV_S16_V0), Extract( R1.size() - 144 - 1, R1.size() - 160, R1  ) )) ) ^ Concat(Concat((CONST_BV_S16_V0), Extract( R2.size() - 128 - 1, R2.size() - 144, R2  ) ), Concat((CONST_BV_S16_V0), Extract( R2.size() - 144 - 1, R2.size() - 160, R2  ) )) ) , ( ( ( Concat(Concat((CONST_BV_S16_V0), Extract( R1.size() - 176 - 1, R1.size() - 192, R1  ) ), Concat((CONST_BV_S16_V0), Extract( R1.size() - 176 - 1, R1.size() - 192, R1  ) )) | Concat(Extract( R1.size() - 160 - 1, R1.size() - 192, R1  ) , Concat(Extract( R1.size() - 176 - 1, R1.size() - 192, R1  ) , Extract( R1.size() - 176 - 1, R1.size() - 192, R1  ) )) )  ^ Concat(Concat((CONST_BV_S16_V0), Extract( R1.size() - 176 - 1, R1.size() - 192, R1  ) ), Concat((CONST_BV_S16_V0), Extract( R1.size() - 176 - 1, R1.size() - 192, R1  ) )) ) ^ Concat(Concat((CONST_BV_S16_V0), Extract( R2.size() - 160 - 1, R2.size() - 176, R2  ) ), Concat((CONST_BV_S16_V0), Extract( R2.size() - 176 - 1, R2.size() - 192, R2  ) )) ) )) )
PS_R2 = (Concat((Extract (255, 128, ((R2)))), (Concat(((Concat((Concat((CONST_BV_S16_V0), (Extract (127, 112, ((R2)))))), (Concat((CONST_BV_S16_V0), (Extract (111, 96, ((R2)))))))) ^ ((Concat((Concat((CONST_BV_S16_V0), (Extract (111, 96, ((R1)))))), (Concat((CONST_BV_S16_V0), (Extract (111, 96, ((R1)))))))) ^ ((Concat((Extract (127, 96, ((R1)))), (Concat((Extract (111, 96, ((R1)))), (Extract (111, 96, ((R1)))))))) | (Concat((Concat((CONST_BV_S16_V0), (Extract (111, 96, ((R1)))))), (Concat((CONST_BV_S16_V0), (Extract (111, 96, ((R1))))))))))), ((Concat((Concat((CONST_BV_S16_V0), (Extract (95, 80, ((R2)))))), (Concat((CONST_BV_S16_V0), (Extract (79, 64, ((R2)))))))) ^ ((Concat((Concat((CONST_BV_S16_V0), (Extract (79, 64, ((R1)))))), (Concat((CONST_BV_S16_V0), (Extract (79, 64, ((R1)))))))) ^ ((Concat((Extract (95, 64, ((R1)))), (Concat((Extract (79, 64, ((R1)))), (Extract (79, 64, ((R1)))))))) | (Concat((Concat((CONST_BV_S16_V0), (Extract (79, 64, ((R1)))))), (Concat((CONST_BV_S16_V0), (Extract (79, 64, ((R1)))))))))))))))
