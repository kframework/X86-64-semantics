...
print('[6;30;44m' + 'Opcode:shlq_r64_one' + '[0m')
...
PK_CF = (Extract( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ).size() - 0 - 1, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ).size() - 1, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) )  )  ) == ONE1
...
PK_R2 = (Extract( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ).size() - 65, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) )  )  )
PS_R2 = (Extract (63, 0, (((Concat((CONST_BV_S1_V0), (R2))) + (Concat((CONST_BV_S1_V0), (R2)))))))
proverUtils.prove( PK_R2 == PS_R2 )

PK_SF = (Extract( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ).size() - 2, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) )  )  ) == ONE1
