...
print('[6;30;44m' + 'Opcode:notw_r16' + '[0m')

R1 = BitVec('R1', 64)
CONST_BV_S16_V65535 = BitVecVal(65535, 16)
CONST_BV_S16_Vffff = BitVecVal(0xffff, 16)

PK_R1 = (Concat(Extract( R1.size() - 0 - 1, R1.size() - 48, R1  ) , ( (CONST_BV_S16_V65535) ^ Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )  ) ) )
PS_R1 = (Concat((Extract (63, 16, ((R1)))), ((Extract (15, 0, ((R1)))) ^ (CONST_BV_S16_Vffff))))
