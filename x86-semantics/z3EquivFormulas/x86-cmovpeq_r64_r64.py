...
print('[6;30;44m' + 'Opcode:cmovpeq_r64_r64' + '[0m')
...
CONST_BV_S24_V1 = BitVecVal(0x1, 24)
CONST_BV_S24_V0 = BitVecVal(0x0, 24)

PK_R2 = ((If (((If ((( Extract( ( Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) + Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) + Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) ).size() - 9, ( Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) + Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) )  ) == (CONST_BV_S8_V0) )  ) , ( ( Concat((CONST_BV_S16_V0), Concat(Concat((CONST_BV_S7_V0), Extract( ( Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) + Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) ).size() - 0 - 1, ( Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) + Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) ).size() - 1, ( Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) + Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) )  ) ), (CONST_BV_S8_V1))) == (CONST_BV_S32_V0) )  ) , ( ( Concat((CONST_BV_S16_V0), Concat(Concat((CONST_BV_S7_V0), Extract( ( Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) + Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) ).size() - 0 - 1, ( Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) + Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) ).size() - 1, ( Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) + Concat((CONST_BV_S1_V0), ( Concat((CONST_BV_S7_V0), PF) ^ (CONST_BV_S8_V1) ) ) )  ) ), (CONST_BV_S8_V0))) == (CONST_BV_S32_V0) )  ) )) ) , ( R2 ) , ( R1 ) ))  )
PS_R2 = (If( ((Extract (7, 0, (((If( ((Concat((If( ((Extract (8, 8, (((If( (pf),(CONST_BV_S9_V0),(CONST_BV_S9_V1))) + (If( (pf),(CONST_BV_S9_V0),(CONST_BV_S9_V1))))))) == (CONST_BV_S1_V1)),(CONST_BV_S24_V1),(CONST_BV_S24_V0))), (If( ((Extract (7, 0, (((If( (pf),(CONST_BV_S9_V0),(CONST_BV_S9_V1))) + (If( (pf),(CONST_BV_S9_V0),(CONST_BV_S9_V1))))))) == (CONST_BV_S8_V0)),(CONST_BV_S8_V1),(CONST_BV_S8_V0))))) == (CONST_BV_S32_V0)),(CONST_BV_S9_V1),(CONST_BV_S9_V0))) + (If( ((Concat((If( ((Extract (8, 8, (((If( (pf),(CONST_BV_S9_V0),(CONST_BV_S9_V1))) + (If( (pf),(CONST_BV_S9_V0),(CONST_BV_S9_V1))))))) == (CONST_BV_S1_V1)),(CONST_BV_S24_V1),(CONST_BV_S24_V0))), (If( ((Extract (7, 0, (((If( (pf),(CONST_BV_S9_V0),(CONST_BV_S9_V1))) + (If( (pf),(CONST_BV_S9_V0),(CONST_BV_S9_V1))))))) == (CONST_BV_S8_V0)),(CONST_BV_S8_V1),(CONST_BV_S8_V0))))) == (CONST_BV_S32_V0)),(CONST_BV_S9_V1),(CONST_BV_S9_V0))))))) == (CONST_BV_S8_V0)),(R1),(R2)))
