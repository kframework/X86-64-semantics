...
PK_R3 = (Concat(Concat( vfnmadd132_double ( Extract( R2.size() - 0 - 1, R2.size() - 64, R2  ) , Extract( R3.size() - 0 - 1, R3.size() - 64, R3  ) , Extract( R1.size() - 0 - 1, R1.size() - 64, R1  )  ) ,  vfnmadd132_double ( Extract( R2.size() - 64 - 1, R2.size() - 128, R2  ) , Extract( R3.size() - 64 - 1, R3.size() - 128, R3  ) , Extract( R1.size() - 64 - 1, R1.size() - 128, R1  )  ) ), Concat( vfnmadd132_double ( Extract( R2.size() - 128 - 1, R2.size() - 192, R2  ) , Extract( R3.size() - 128 - 1, R3.size() - 192, R3  ) , Extract( R1.size() - 128 - 1, R1.size() - 192, R1  )  ) ,  vfnmadd132_double ( Extract( R2.size() - 192 - 1, R2.size() - 256, R2  ) , Extract( R3.size() - 192 - 1, R3.size() - 256, R3  ) , Extract( R1.size() - 192 - 1, R1.size() - 256, R1  )  ) )) )
