...
print('[6;30;44m' + 'Opcode:movq_xmm_r64' + '[0m')

R1 = BitVec('R1', 64)
R2 = BitVec('R2', 256)
CONST_BV_S64_V0 = BitVecVal(0, 64)

PK_R2 = (Concat(Extract( R2.size() - 0 - 1, R2.size() - 128, R2  ) , Concat((CONST_BV_S64_V0), ( R1 ^ (CONST_BV_S64_V0) ) )) )
PS_R2 = (Concat((Extract (255, 128, ((R2)))), (Concat((CONST_BV_S64_V0), ((CONST_BV_S64_V0) ^ (R1))))))
