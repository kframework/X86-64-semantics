...
print('[6;30;44m' + 'Opcode:vpmovzxwq_xmm_xmm' + '[0m')
...
PK_R2 = (Concat((CONST_BV_S128_V0), Concat(Concat((CONST_BV_S48_V0), Extract( R1.size() - 224 - 1, R1.size() - 240, R1  ) ), Concat((CONST_BV_S48_V0), Extract( R1.size() - 240 - 1, R1.size() - 256, R1  ) ))) )
PS_R2 = (Concat((CONST_BV_S128_V0), (Concat((Concat((CONST_BV_S48_V0), (Extract (31, 16, ((R1)))))), (Concat((CONST_BV_S48_V0), (Extract (15, 0, ((R1))))))))))
