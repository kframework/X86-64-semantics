...
PK_R2 = (Concat((CONST_BV_S128_V0), extractMask(Concat( cvt_int32_to_single ( (CONST_BV_S32_V0) ) , Concat( cvt_int32_to_single ( (CONST_BV_S32_V0) ) , Concat( cvt_int32_to_single ( (CONST_BV_S32_V0) ) , Concat( cvt_int32_to_single ( (CONST_BV_S32_V0) ) , Concat( cvt_int32_to_single ( Extract( R1.size() - 128 - 1, R1.size() - 160, R1  )  ) , Concat( cvt_int32_to_single ( Extract( R1.size() - 160 - 1, R1.size() - 192, R1  )  ) , Concat( cvt_int32_to_single ( Extract( R1.size() - 192 - 1, R1.size() - 224, R1  )  ) ,  cvt_int32_to_single ( Extract( R1.size() - 224 - 1, R1.size() - 256, R1  )  ) ))))))), 128, 0)) )
PS_R2 = (Concat((CONST_BV_S128_V0), (Concat(( cvt_int32_to_single ( (Extract (127, 96, ((R1)))))), (Concat(( cvt_int32_to_single ( (Extract (95, 64, ((R1)))))), (Concat(( cvt_int32_to_single ( (Extract (63, 32, ((R1)))))), ( cvt_int32_to_single ( (Extract (31, 0, ((R1))))))))))))))
