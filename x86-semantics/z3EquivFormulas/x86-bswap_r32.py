...
print('[6;30;44m' + 'Opcode:bswap_r32' + '[0m')

R1 = BitVec('R1', 64)
CONST_BV_S32_V0 = BitVecVal(0, 32)

PK_R1 = (Concat(Concat((CONST_BV_S32_V0), Extract( R1.size() - 56 - 1, R1.size() - 64, R1  ) ), Concat(Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) , Concat(Extract( R1.size() - 40 - 1, R1.size() - 48, R1  ) , Extract( R1.size() - 32 - 1, R1.size() - 40, R1  ) ))) )
PS_R1 = (Concat((Concat((Concat((CONST_BV_S32_V0), (Extract (7, 0, ((R1)))))), (Extract (15, 8, ((R1)))))), (Concat((Extract (23, 16, ((R1)))), (Extract (31, 24, ((R1))))))))
