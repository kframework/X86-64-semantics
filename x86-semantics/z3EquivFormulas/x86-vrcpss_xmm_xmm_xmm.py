...
print('[6;30;44m' + 'Opcode:vrcpss_xmm_xmm_xmm' + '[0m')
...
PK_R3 = (Concat(Concat((CONST_BV_S128_V0), Extract( R2.size() - 128 - 1, R2.size() - 224, R2  ) ),  approx_reciprocal_single ( Extract( R1.size() - 224 - 1, R1.size() - 256, R1  )  ) ) )
PS_R3 = (Concat((CONST_BV_S128_V0), (Concat((Extract (127, 32, ((R2)))), ( approx_reciprocal_single ( (Extract (31, 0, ((R1))))))))))
