...
print('[6;30;44m' + 'Opcode:cmovgew_r16_r16' + '[0m')
...
PK_R2 = ((If ((( Concat((CONST_BV_S56_V0), ( ( Concat((CONST_BV_S7_V0), SF) ^ Concat((CONST_BV_S7_V0), OF) ) ^ (CONST_BV_S8_V1) ) ) == (CONST_BV_S64_V0) )  ) , ( R2 ) , ( Concat(Extract( R2.size() - 0 - 1, R2.size() - 48, R2  ) , Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ) ) ) ))  )
PS_R2 = (Concat((Extract (63, 16, ((R2)))), (If( ((Concat((CONST_BV_S56_V0), ((CONST_BV_S8_V1) ^ ((If( (of),(CONST_BV_S8_V1),(CONST_BV_S8_V0))) ^ (If( (sf),(CONST_BV_S8_V1),(CONST_BV_S8_V0))))))) == (CONST_BV_S64_V0)),(Extract (15, 0, ((R2)))),(Extract (15, 0, ((R1))))))))
