...
print('[6;30;44m' + 'Opcode:cmovnleq_r64_r64' + '[0m')
...
CONST_BV_S32_V100 = BitVecVal(0x100, 32)
CONST_BV_S9_V1 = BitVecVal(0x1, 9)
CONST_BV_S9_V0 = BitVecVal(0x0, 9)

PK_R2 = ((If (((If ((( ZF == (CONST_BV_S1_V0) )  ) , ( ( Concat((CONST_BV_S16_V0), Concat(Concat((CONST_BV_S7_V0), ( ( SF ^ OF ) ^ (CONST_BV_S1_V1) ) ), (CONST_BV_S8_V0))) == (CONST_BV_S32_V0) )  ) , ( True ) )) ) , ( R2 ) , ( R1 ) ))  )
PS_R2 = (If( ((Extract (7, 0, (((If( ((If( (Or((And((True), ((Extract (0, 0, (((Concat((SignExt( 64 - (If( (zf),(CONST_BV_S8_V0),((CONST_BV_S8_V1) ^ ((If( (of),(CONST_BV_S8_V1),(CONST_BV_S8_V0))) ^ (If( (sf),(CONST_BV_S8_V1),(CONST_BV_S8_V0))))))).size(), (If( (zf),(CONST_BV_S8_V0),((CONST_BV_S8_V1) ^ ((If( (of),(CONST_BV_S8_V1),(CONST_BV_S8_V0))) ^ (If( (sf),(CONST_BV_S8_V1),(CONST_BV_S8_V0))))))))), (CONST_BV_S1_V0))) >> (Concat((CONST_BV_S57_V0), (CONST_BV_S8_V1))))))) == (CONST_BV_S1_V1)))), (False))),(CONST_BV_S32_V100),(CONST_BV_S32_V0))) == (CONST_BV_S32_V0)),(CONST_BV_S9_V1),(CONST_BV_S9_V0))) + (If( ((If( (Or((And((True), ((Extract (0, 0, (((Concat((SignExt( 64 - (If( (zf),(CONST_BV_S8_V0),((CONST_BV_S8_V1) ^ ((If( (of),(CONST_BV_S8_V1),(CONST_BV_S8_V0))) ^ (If( (sf),(CONST_BV_S8_V1),(CONST_BV_S8_V0))))))).size(), (If( (zf),(CONST_BV_S8_V0),((CONST_BV_S8_V1) ^ ((If( (of),(CONST_BV_S8_V1),(CONST_BV_S8_V0))) ^ (If( (sf),(CONST_BV_S8_V1),(CONST_BV_S8_V0))))))))), (CONST_BV_S1_V0))) >> (Concat((CONST_BV_S57_V0), (CONST_BV_S8_V1))))))) == (CONST_BV_S1_V1)))), (False))),(CONST_BV_S32_V100),(CONST_BV_S32_V0))) == (CONST_BV_S32_V0)),(CONST_BV_S9_V1),(CONST_BV_S9_V0))))))) == (CONST_BV_S8_V0)),(R1),(R2)))
