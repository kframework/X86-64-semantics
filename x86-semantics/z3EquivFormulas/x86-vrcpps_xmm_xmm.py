...
PK_R2 = (Concat((CONST_BV_S128_V0), Concat( approx_reciprocal_single ( Extract( R1.size() - 128 - 1, R1.size() - 160, R1  )  ) , Concat( approx_reciprocal_single ( Extract( R1.size() - 160 - 1, R1.size() - 192, R1  )  ) , Concat( approx_reciprocal_single ( Extract( R1.size() - 192 - 1, R1.size() - 224, R1  )  ) ,  approx_reciprocal_single ( Extract( R1.size() - 224 - 1, R1.size() - 256, R1  )  ) )))) )
