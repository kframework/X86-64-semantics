...
print('[6;30;44m' + 'Opcode:popcntl_r32_r32' + '[0m')
...
CONST_BV_S16_V0 = BitVecVal(0x0, 16)
CONST_BV_S8_V0 = BitVecVal(0x0, 8)
CONST_BV_S4_V0 = BitVecVal(0x0, 4)
CONST_BV_S2_V0 = BitVecVal(0x0, 2)
...
PK_R2 = (mi(64, countOnes(Extract( R1.size() - 32 - 1, R1.size() - 64, R1  ) , 0)) )
PS_R2 = (Concat((CONST_BV_S32_V0), ((Concat((CONST_BV_S16_V0), ((Concat((CONST_BV_S8_V0), ((Concat((CONST_BV_S4_V0), ((Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (31, 31, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (30, 30, ((R1))))))))) + (Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (29, 29, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (28, 28, ((R1)))))))))))) + (Concat((CONST_BV_S4_V0), ((Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (27, 27, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (26, 26, ((R1))))))))) + (Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (25, 25, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (24, 24, ((R1))))))))))))))) + (Concat((CONST_BV_S8_V0), ((Concat((CONST_BV_S4_V0), ((Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (23, 23, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (22, 22, ((R1))))))))) + (Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (21, 21, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (20, 20, ((R1)))))))))))) + (Concat((CONST_BV_S4_V0), ((Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (19, 19, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (18, 18, ((R1))))))))) + (Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (17, 17, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (16, 16, ((R1)))))))))))))))))) + (Concat((CONST_BV_S16_V0), ((Concat((CONST_BV_S8_V0), ((Concat((CONST_BV_S4_V0), ((Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (15, 15, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (14, 14, ((R1))))))))) + (Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (13, 13, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (12, 12, ((R1)))))))))))) + (Concat((CONST_BV_S4_V0), ((Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (11, 11, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (10, 10, ((R1))))))))) + (Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (9, 9, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (8, 8, ((R1))))))))))))))) + (Concat((CONST_BV_S8_V0), ((Concat((CONST_BV_S4_V0), ((Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (7, 7, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (6, 6, ((R1))))))))) + (Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (5, 5, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (4, 4, ((R1)))))))))))) + (Concat((CONST_BV_S4_V0), ((Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (3, 3, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (2, 2, ((R1))))))))) + (Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (1, 1, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (0, 0, ((R1)))))))))))))))))))))
proverUtils.prove( PK_R2 == PS_R2 )

PK_SF = ((CONST_BV_S1_V0) ) == ONE1
PS_SF = (False)
proverUtils.prove( PK_SF == PS_SF )

PK_ZF = ((If ((( Concat((CONST_BV_S32_V0), Extract( R1.size() - 32 - 1, R1.size() - 64, R1  ) ) == (CONST_BV_S64_V0) )  ) , ( (CONST_BV_S1_V1) ) , ( (CONST_BV_S1_V0) ) ))    ) == ONE1
PS_ZF = ((Concat((CONST_BV_S32_V0), (Extract (31, 0, ((R1)))))) == (CONST_BV_S64_V0))
