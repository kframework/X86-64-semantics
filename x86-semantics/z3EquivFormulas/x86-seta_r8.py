...
print('[6;30;44m' + 'Opcode:seta_r8' + '[0m')
...
PK_R1 = ((If ((( Extract( ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), ZF) ).size() - 1 - 1, ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), ZF) ).size() - 9, ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), ZF) )  ) == (CONST_BV_S8_V0) )  ) , ( Concat(Extract( R1.size() - 0 - 1, R1.size() - 56, R1  ) , (CONST_BV_S8_V0)) ) , ( Concat(Extract( R1.size() - 0 - 1, R1.size() - 56, R1  ) , Extract( ( Concat((CONST_BV_S9_V0), Extract( ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) ).size() - 1 - 1, ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) ).size() - 9, ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) )  ) ) + (CONST_BV_S17_V4) ).size() - 1 - 1, ( Concat((CONST_BV_S9_V0), Extract( ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) ).size() - 1 - 1, ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) ).size() - 9, ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) )  ) ) + (CONST_BV_S17_V4) ).size() - 9, ( Concat((CONST_BV_S9_V0), Extract( ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) ).size() - 1 - 1, ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) ).size() - 9, ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) )  ) ) + (CONST_BV_S17_V4) )  ) ) ) ))  )
PS_R1 = (Concat((Extract (63, 8, ((R1)))), (If( ((If( (zf),(CONST_BV_S8_V0),(CONST_BV_S8_Vff))) == (CONST_BV_S8_V0)),(CONST_BV_S8_V0),(If( (cf),(CONST_BV_S8_V0),(CONST_BV_S8_V1)))))))
