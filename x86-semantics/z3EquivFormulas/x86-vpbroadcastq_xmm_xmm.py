...
print('[6;30;44m' + 'Opcode:vpbroadcastq_xmm_xmm' + '[0m')

R1 = BitVec('R1', 256)
R2 = BitVec('R2', 256)
CONST_BV_S128_V0 = BitVecVal(0, 128)

PK_R2 = (Concat((CONST_BV_S128_V0), Concat(Extract( R1.size() - 192 - 1, R1.size() - 256, R1  ) , Extract( R1.size() - 192 - 1, R1.size() - 256, R1  ) )) )
PS_R2 = (Concat((CONST_BV_S128_V0), (Concat((Extract (63, 0, ((R1)))), (Extract (63, 0, ((R1))))))))
