...
print('[6;30;44m' + 'Opcode:xaddq_r64_r64' + '[0m')
...
PK_CF = (Extract( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) ).size() - 0 - 1, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) ).size() - 1, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) )  )  ) == ONE1
PS_CF = ((Extract (64, 64, (((Concat((CONST_BV_S1_V0), (R2))) + (Concat((CONST_BV_S1_V0), (R1))))))) == (CONST_BV_S1_V1))
proverUtils.prove( PK_CF == PS_CF )

PK_OF = ((If (( (And( ( Extract( R2.size() - 0 - 1, R2.size() - 1, R2  ) == Extract( R1.size() - 0 - 1, R1.size() - 1, R1  ) ) ,  (Not  ( ( Extract( R2.size() - 0 - 1, R2.size() - 1, R2  ) == Extract( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) ).size() - 2, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) )  ) )  ))  ))  ) , ( (CONST_BV_S1_V1) ) , ( (CONST_BV_S1_V0) ) ))  ) == ONE1
PS_OF = (And((((Extract (63, 63, ((R2)))) == (CONST_BV_S1_V1)) == ((Extract (63, 63, ((R1)))) == (CONST_BV_S1_V1))), (Not((((Extract (63, 63, ((R2)))) == (CONST_BV_S1_V1)) == ((Extract (63, 63, (((Concat((CONST_BV_S1_V0), (R2))) + (Concat((CONST_BV_S1_V0), (R1))))))) == (CONST_BV_S1_V1)))))))
proverUtils.prove( PK_OF == PS_OF )

PK_R2 = (Extract( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) ).size() - 65, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) )  )  )
PS_R2 = (Extract (63, 0, (((Concat((CONST_BV_S1_V0), (R2))) + (Concat((CONST_BV_S1_V0), (R1)))))))
...
PK_SF = (Extract( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) ).size() - 2, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) )  )  ) == ONE1
PS_SF = ((Extract (63, 63, (((Concat((CONST_BV_S1_V0), (R2))) + (Concat((CONST_BV_S1_V0), (R1))))))) == (CONST_BV_S1_V1))
proverUtils.prove( PK_SF == PS_SF )

PK_ZF = ((If ((( Extract( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) ).size() - 65, ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R1) )  ) == (CONST_BV_S64_V0) )  ) , ( (CONST_BV_S1_V1) ) , ( (CONST_BV_S1_V0) ) ))    ) == ONE1
PS_ZF = ((Extract (63, 0, (((Concat((CONST_BV_S1_V0), (R2))) + (Concat((CONST_BV_S1_V0), (R1))))))) == (CONST_BV_S64_V0))
