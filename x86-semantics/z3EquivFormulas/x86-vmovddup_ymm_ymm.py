...
print('[6;30;44m' + 'Opcode:vmovddup_ymm_ymm' + '[0m')

R1 = BitVec('R1', 256)
R2 = BitVec('R2', 256)

PK_R2 = (Concat(Concat(Extract( R1.size() - 64 - 1, R1.size() - 128, R1  ) , Extract( R1.size() - 64 - 1, R1.size() - 128, R1  ) ), Concat(Extract( R1.size() - 192 - 1, R1.size() - 256, R1  ) , Extract( R1.size() - 192 - 1, R1.size() - 256, R1  ) )) )
PS_R2 = (Concat((Concat((Extract (191, 128, ((R1)))), (Extract (191, 128, ((R1)))))), (Concat((Extract (63, 0, ((R1)))), (Extract (63, 0, ((R1))))))))
