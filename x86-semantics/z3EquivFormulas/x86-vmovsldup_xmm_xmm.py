...
print('[6;30;44m' + 'Opcode:vmovsldup_xmm_xmm' + '[0m')

R1 = BitVec('R1', 256)
R2 = BitVec('R2', 256)
CONST_BV_S128_V0 = BitVecVal(0, 128)

PK_R2 = (Concat((CONST_BV_S128_V0), Concat(Concat(Extract( R1.size() - 160 - 1, R1.size() - 192, R1  ) , Extract( R1.size() - 160 - 1, R1.size() - 192, R1  ) ), Concat(Extract( R1.size() - 224 - 1, R1.size() - 256, R1  ) , Extract( R1.size() - 224 - 1, R1.size() - 256, R1  ) ))) )
PS_R2 = (Concat((CONST_BV_S128_V0), (Concat((Concat((Extract (95, 64, ((R1)))), (Extract (95, 64, ((R1)))))), (Concat((Extract (31, 0, ((R1)))), (Extract (31, 0, ((R1))))))))))
