...
PK_CF = (Extract( ( Concat((CONST_BV_S1_V0), Extract( ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) ).size() - 9 - 1, ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) ).size() - 17, ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) )  ) ) + Concat((CONST_BV_S1_V0), Extract( ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) ).size() - 9 - 1, ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) ).size() - 17, ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) )  ) ) ).size() - 0 - 1, ( Concat((CONST_BV_S1_V0), Extract( ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) ).size() - 9 - 1, ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) ).size() - 17, ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) )  ) ) + Concat((CONST_BV_S1_V0), Extract( ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) ).size() - 9 - 1, ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) ).size() - 17, ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) )  ) ) ).size() - 1, ( Concat((CONST_BV_S1_V0), Extract( ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) ).size() - 9 - 1, ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) ).size() - 17, ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) )  ) ) + Concat((CONST_BV_S1_V0), Extract( ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) ).size() - 9 - 1, ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) ).size() - 17, ( Concat((CONST_BV_S16_V0), CF) + (CONST_BV_S17_V65535) )  ) ) )  )  ) == ONE1
PS_CF = ((Extract (8, 8, (((If( (cf),(CONST_BV_S9_V0),(CONST_BV_S9_Vff))) + (If( (cf),(CONST_BV_S9_V0),(CONST_BV_S9_Vff))))))) == (CONST_BV_S1_V1))
