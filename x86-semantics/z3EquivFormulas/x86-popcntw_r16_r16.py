...
print('[6;30;44m' + 'Opcode:popcntw_r16_r16' + '[0m')

R1 = BitVec('R1', 64)
R2 = BitVec('R2', 64)
CONST_BV_S1_V0 = BitVecVal(0, 1)
CONST_BV_S48_V0 = BitVecVal(0, 48)
...
PK_R2 = (Concat(Extract( R2.size() - 0 - 1, R2.size() - 48, R2  ) , Extract( mi(64, countOnes(Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ) , 0)).size() - 48 - 1, mi(64, countOnes(Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ) , 0)).size() - 64, mi(64, countOnes(Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ) , 0))  ) ) )
PS_R2 = (Concat((Extract (63, 16, ((R2)))), ((Concat((CONST_BV_S8_V0), ((Concat((CONST_BV_S4_V0), ((Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (15, 15, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (14, 14, ((R1))))))))) + (Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (13, 13, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (12, 12, ((R1)))))))))))) + (Concat((CONST_BV_S4_V0), ((Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (11, 11, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (10, 10, ((R1))))))))) + (Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (9, 9, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (8, 8, ((R1))))))))))))))) + (Concat((CONST_BV_S8_V0), ((Concat((CONST_BV_S4_V0), ((Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (7, 7, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (6, 6, ((R1))))))))) + (Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (5, 5, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (4, 4, ((R1)))))))))))) + (Concat((CONST_BV_S4_V0), ((Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (3, 3, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (2, 2, ((R1))))))))) + (Concat((CONST_BV_S2_V0), ((Concat((CONST_BV_S1_V0), (Extract (1, 1, ((R1)))))) + (Concat((CONST_BV_S1_V0), (Extract (0, 0, ((R1))))))))))))))))))
...
PK_ZF = ((If ((( Concat((CONST_BV_S48_V0), Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ) ) == (CONST_BV_S64_V0) )  ) , ( (CONST_BV_S1_V1) ) , ( (CONST_BV_S1_V0) ) ))    ) == ONE1
PS_ZF = ((Concat((CONST_BV_S48_V0), (Extract (15, 0, ((R1)))))) == (CONST_BV_S64_V0))
