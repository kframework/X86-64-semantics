...
print('[6;30;44m' + 'Opcode:vpmovzxdq_ymm_xmm' + '[0m')

R1 = BitVec('R1', 256)
R2 = BitVec('R2', 256)
CONST_BV_S32_V0 = BitVecVal(0, 32)

PK_R2 = (Concat(Concat(Concat(Concat((CONST_BV_S32_V0), Extract( R1.size() - 128 - 1, R1.size() - 160, R1  ) ), (CONST_BV_S32_V0)), Extract( R1.size() - 160 - 1, R1.size() - 192, R1  ) ), Concat(Concat((CONST_BV_S32_V0), Extract( R1.size() - 192 - 1, R1.size() - 224, R1  ) ), Concat((CONST_BV_S32_V0), Extract( R1.size() - 224 - 1, R1.size() - 256, R1  ) ))) )
PS_R2 = (Concat((Concat((Concat((Concat((CONST_BV_S32_V0), (Extract (127, 96, ((R1)))))), (CONST_BV_S32_V0))), (Extract (95, 64, ((R1)))))), (Concat((Concat((CONST_BV_S32_V0), (Extract (63, 32, ((R1)))))), (Concat((CONST_BV_S32_V0), (Extract (31, 0, ((R1))))))))))
