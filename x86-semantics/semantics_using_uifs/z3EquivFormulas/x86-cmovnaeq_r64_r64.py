...
print('[6;30;44m' + 'Opcode:cmovnaeq_r64_r64' + '[0m')
...
PK_R2 = ((If ((( Concat((CONST_BV_S16_V0), Concat(Concat((CONST_BV_S7_V0), CF), (CONST_BV_S8_V0))) == (CONST_BV_S32_V0) )  ) , ( R2 ) , ( R1 ) ))  )
PS_R2 = (If( ((Extract (7, 0, (((If( ((If( (cf),(CONST_BV_S32_V100),(CONST_BV_S32_V0))) == (CONST_BV_S32_V0)),(CONST_BV_S9_V1),(CONST_BV_S9_V0))) + (If( ((If( (cf),(CONST_BV_S32_V100),(CONST_BV_S32_V0))) == (CONST_BV_S32_V0)),(CONST_BV_S9_V1),(CONST_BV_S9_V0))))))) == (CONST_BV_S8_V0)),(R1),(R2)))
