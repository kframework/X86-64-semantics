...
print('[6;30;44m' + 'Opcode:vfnmsub231sd_xmm_xmm_xmm' + '[0m')
...
PK_R3 = (Concat((CONST_BV_S128_V0), Concat(Extract( R3.size() - 128 - 1, R3.size() - 192, R3  ) ,  vfmsub132_double ( vfnmsub132_double ( (If( mincmp_double ( Concat((CONST_BV_S32_V0), Extract( R2.size() - 160 - 1, R2.size() - 192, R2  ) ), Concat((CONST_BV_S32_V0), Extract( R2.size() - 224 - 1, R2.size() - 256, R2  ) ) ) == ONE1, Concat((CONST_BV_S32_V0), Extract( R2.size() - 160 - 1, R2.size() - 192, R2  ) ), Concat((CONST_BV_S32_V0), Extract( R2.size() - 224 - 1, R2.size() - 256, R2  ) ))), Extract( R2.size() - 192 - 1, R2.size() - 256, R2  ) , (If( mincmp_double ( Concat((CONST_BV_S32_V0), Extract( R2.size() - 160 - 1, R2.size() - 192, R2  ) ), Concat((CONST_BV_S32_V0), Extract( R2.size() - 224 - 1, R2.size() - 256, R2  ) ) ) == ONE1, Concat((CONST_BV_S32_V0), Extract( R2.size() - 160 - 1, R2.size() - 192, R2  ) ), Concat((CONST_BV_S32_V0), Extract( R2.size() - 224 - 1, R2.size() - 256, R2  ) ))) ), Extract( R3.size() - 192 - 1, R3.size() - 256, R3  ) , Extract( R1.size() - 192 - 1, R1.size() - 256, R1  )  ) )) )
PS_R3 = (Concat((CONST_BV_S128_V0), (Concat((Extract (127, 64, ((R3)))), ( vfmsub132_double ( ( vfnmsub132_double ( (If( (( mincmp_double ( (Concat((CONST_BV_S32_V0), (Extract (95, 64, ((R2)))))), (Concat((CONST_BV_S32_V0), (Extract (31, 0, ((R2)))))))) == (CONST_BV_S1_V1)),(Concat((CONST_BV_S32_V0), (Extract (95, 64, ((R2)))))),(Concat((CONST_BV_S32_V0), (Extract (31, 0, ((R2)))))))), (Extract (63, 0, ((R2)))), (If( (( mincmp_double ( (Concat((CONST_BV_S32_V0), (Extract (95, 64, ((R2)))))), (Concat((CONST_BV_S32_V0), (Extract (31, 0, ((R2)))))))) == (CONST_BV_S1_V1)),(Concat((CONST_BV_S32_V0), (Extract (95, 64, ((R2)))))),(Concat((CONST_BV_S32_V0), (Extract (31, 0, ((R2)))))))))), (Extract (63, 0, ((R3)))), (Extract (63, 0, ((R1))))))))))
