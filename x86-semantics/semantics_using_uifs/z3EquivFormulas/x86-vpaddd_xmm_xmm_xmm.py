...
print('[6;30;44m' + 'Opcode:vpaddd_xmm_xmm_xmm' + '[0m')
...
PK_R3 = (Concat((CONST_BV_S128_V0), Concat(Concat(Extract( ( Concat((CONST_BV_S33_V0), Extract( R2.size() - 128 - 1, R2.size() - 160, R2  ) ) + Concat((CONST_BV_S33_V0), Extract( R1.size() - 128 - 1, R1.size() - 160, R1  ) ) ).size() - 33 - 1, ( Concat((CONST_BV_S33_V0), Extract( R2.size() - 128 - 1, R2.size() - 160, R2  ) ) + Concat((CONST_BV_S33_V0), Extract( R1.size() - 128 - 1, R1.size() - 160, R1  ) ) ).size() - 65, ( Concat((CONST_BV_S33_V0), Extract( R2.size() - 128 - 1, R2.size() - 160, R2  ) ) + Concat((CONST_BV_S33_V0), Extract( R1.size() - 128 - 1, R1.size() - 160, R1  ) ) )  ) , Extract( ( Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 160 - 1, R2.size() - 192, R2  ) , Extract( R1.size() - 160 - 1, R1.size() - 192, R1  ) )) + Concat((CONST_BV_S33_V0), Extract( R2.size() - 160 - 1, R2.size() - 192, R2  ) ) ).size() - 33 - 1, ( Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 160 - 1, R2.size() - 192, R2  ) , Extract( R1.size() - 160 - 1, R1.size() - 192, R1  ) )) + Concat((CONST_BV_S33_V0), Extract( R2.size() - 160 - 1, R2.size() - 192, R2  ) ) ).size() - 65, ( Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 160 - 1, R2.size() - 192, R2  ) , Extract( R1.size() - 160 - 1, R1.size() - 192, R1  ) )) + Concat((CONST_BV_S33_V0), Extract( R2.size() - 160 - 1, R2.size() - 192, R2  ) ) )  ) ), Concat(Extract( ( Concat((CONST_BV_S1_V0), Concat(Extract( R1.size() - 192 - 1, R1.size() - 224, R1  ) , Extract( R1.size() - 192 - 1, R1.size() - 224, R1  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R1.size() - 192 - 1, R1.size() - 224, R1  ) , Extract( R2.size() - 192 - 1, R2.size() - 224, R2  ) )) ).size() - 33 - 1, ( Concat((CONST_BV_S1_V0), Concat(Extract( R1.size() - 192 - 1, R1.size() - 224, R1  ) , Extract( R1.size() - 192 - 1, R1.size() - 224, R1  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R1.size() - 192 - 1, R1.size() - 224, R1  ) , Extract( R2.size() - 192 - 1, R2.size() - 224, R2  ) )) ).size() - 65, ( Concat((CONST_BV_S1_V0), Concat(Extract( R1.size() - 192 - 1, R1.size() - 224, R1  ) , Extract( R1.size() - 192 - 1, R1.size() - 224, R1  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R1.size() - 192 - 1, R1.size() - 224, R1  ) , Extract( R2.size() - 192 - 1, R2.size() - 224, R2  ) )) )  ) , Extract( ( Concat((CONST_BV_S1_V0), Concat(Extract( R1.size() - 224 - 1, R1.size() - 256, R1  ) , Extract( R1.size() - 224 - 1, R1.size() - 256, R1  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R1.size() - 224 - 1, R1.size() - 256, R1  ) , Extract( R2.size() - 224 - 1, R2.size() - 256, R2  ) )) ).size() - 33 - 1, ( Concat((CONST_BV_S1_V0), Concat(Extract( R1.size() - 224 - 1, R1.size() - 256, R1  ) , Extract( R1.size() - 224 - 1, R1.size() - 256, R1  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R1.size() - 224 - 1, R1.size() - 256, R1  ) , Extract( R2.size() - 224 - 1, R2.size() - 256, R2  ) )) ).size() - 65, ( Concat((CONST_BV_S1_V0), Concat(Extract( R1.size() - 224 - 1, R1.size() - 256, R1  ) , Extract( R1.size() - 224 - 1, R1.size() - 256, R1  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R1.size() - 224 - 1, R1.size() - 256, R1  ) , Extract( R2.size() - 224 - 1, R2.size() - 256, R2  ) )) )  ) ))) )
PS_R3 = (Concat((CONST_BV_S128_V0), (Concat((Concat((Concat((Extract (31, 0, (((Concat((CONST_BV_S1_V0), (Concat((CONST_BV_S32_V0), (Extract (127, 96, ((R2)))))))) + (Concat((CONST_BV_S1_V0), (Concat((CONST_BV_S32_V0), (Extract (127, 96, ((R1)))))))))))), (Extract (31, 0, (((Concat((CONST_BV_S1_V0), (Concat((Extract (95, 64, ((R2)))), (Extract (95, 64, ((R1)))))))) + (Concat((CONST_BV_S1_V0), (Concat((CONST_BV_S32_V0), (Extract (95, 64, ((R2)))))))))))))), (Extract (31, 0, (((Concat((CONST_BV_S1_V0), (Concat((Extract (63, 32, ((R1)))), (Extract (63, 32, ((R1)))))))) + (Concat((CONST_BV_S1_V0), (Concat((Extract (63, 32, ((R1)))), (Extract (63, 32, ((R2)))))))))))))), (Extract (31, 0, (((Concat((CONST_BV_S1_V0), (Concat((Extract (31, 0, ((R1)))), (Extract (31, 0, ((R1)))))))) + (Concat((CONST_BV_S1_V0), (Concat((Extract (31, 0, ((R1)))), (Extract (31, 0, ((R2))))))))))))))))
