...
print('[6;30;44m' + 'Opcode:rolb_rh_one' + '[0m')
...
PK_CF = (Extract( ( Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) ).size() - 0 - 1, ( Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) ).size() - 1, ( Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) )  )  ) == ONE1
PS_CF = ((Extract (16, 16, (((Concat((CONST_BV_S1_V0), (Concat((Extract (15, 8, ((R2)))), (Extract (15, 8, ((R2)))))))) + (Concat((CONST_BV_S1_V0), (Concat((Extract (15, 8, ((R2)))), (Extract (15, 8, ((R2)))))))))))) == (CONST_BV_S1_V1))
proverUtils.prove( PK_CF == PS_CF )

PK_OF = ((If (( (And( ( Extract( R2.size() - 48 - 1, R2.size() - 49, R2  )  == Extract( R2.size() - 48 - 1, R2.size() - 49, R2  )  ) ,  (Not  ( ( Extract( R2.size() - 48 - 1, R2.size() - 49, R2  )  == Extract( ( Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) ).size() - 2, ( Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) )  )  )  ))  ))  ) , ( (CONST_BV_S1_V1) ) , ( (CONST_BV_S1_V0) ) ))  ) == ONE1
PS_OF = (And((((Extract (15, 15, ((R2)))) == (CONST_BV_S1_V1)) == ((Extract (15, 15, ((R2)))) == (CONST_BV_S1_V1))), (Not((((Extract (15, 15, ((R2)))) == (CONST_BV_S1_V1)) == ((Extract (15, 15, (((Concat((CONST_BV_S1_V0), (Concat((Extract (15, 8, ((R2)))), (Extract (15, 8, ((R2)))))))) + (Concat((CONST_BV_S1_V0), (Concat((Extract (15, 8, ((R2)))), (Extract (15, 8, ((R2)))))))))))) == (CONST_BV_S1_V1)))))))
proverUtils.prove( PK_OF == PS_OF )

PK_R2 = (Concat(Extract( R2.size() - 0 - 1, R2.size() - 48, R2  ) , Concat(Extract( ( Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) ).size() - 9, ( Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) + Concat((CONST_BV_S1_V0), Concat(Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) , Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) )) )  ) , Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) )) )
PS_R2 = (Concat((Concat((Extract (63, 16, ((R2)))), (Extract (15, 8, (((Concat((CONST_BV_S1_V0), (Concat((Extract (15, 8, ((R2)))), (Extract (15, 8, ((R2)))))))) + (Concat((CONST_BV_S1_V0), (Concat((Extract (15, 8, ((R2)))), (Extract (15, 8, ((R2)))))))))))))), (Extract (7, 0, ((R2))))))
