...
print('[6;30;44m' + 'Opcode:cvtsi2sdl_xmm_r32' + '[0m')

R1 = BitVec('R1', 64)
R2 = BitVec('R2', 256)

PK_R2 = (Concat(Extract( R2.size() - 0 - 1, R2.size() - 192, R2  ) ,  cvt_int32_to_double ( Extract( R1.size() - 32 - 1, R1.size() - 64, R1  )  ) ) )
PS_R2 = (Concat((Extract (255, 128, ((R2)))), (Concat((Extract (127, 64, ((R2)))), ( cvt_int32_to_double ( (Extract (31, 0, ((R1))))))))))
