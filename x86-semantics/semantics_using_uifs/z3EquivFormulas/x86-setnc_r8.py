...
print('[6;30;44m' + 'Opcode:setnc_r8' + '[0m')
...
PK_R1 = (Concat(Extract( R1.size() - 0 - 1, R1.size() - 56, R1  ) , ( (CONST_BV_S8_V1) ^ Concat((CONST_BV_S7_V0), CF) ) ) )
PS_R1 = (Concat((Extract (63, 8, ((R1)))), (If( (cf),(CONST_BV_S8_V0),(CONST_BV_S8_V1)))))
