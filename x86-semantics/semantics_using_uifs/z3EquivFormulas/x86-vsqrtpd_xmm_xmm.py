...
print('[6;30;44m' + 'Opcode:vsqrtpd_xmm_xmm' + '[0m')
...
PK_R2 = (Concat((CONST_BV_S128_V0), Concat( sqrt_double ( Extract( R1.size() - 128 - 1, R1.size() - 192, R1  )  ) ,  sqrt_double ( Extract( R1.size() - 192 - 1, R1.size() - 256, R1  )  ) )) )
PS_R2 = (Concat((CONST_BV_S64_V0), (Concat((CONST_BV_S64_V0), (Concat(( sqrt_double ( (Extract (127, 64, ((R1)))))), ( sqrt_double ( (Extract (63, 0, ((R1))))))))))))
