...
print('[6;30;44m' + 'Opcode:xchgb_r8_r8' + '[0m')

R1 = BitVec('R1', 64)
R2 = BitVec('R2', 64)

PK_R2 = (Concat(Extract( R2.size() - 0 - 1, R2.size() - 56, R2  ) , Extract( R1.size() - 56 - 1, R1.size() - 64, R1  ) ) )
PS_R2 = (Concat((Extract (63, 8, ((R2)))), (Extract (7, 0, ((R1))))))
