...
print('[6;30;44m' + 'Opcode:cmovll_r32_r32' + '[0m')
...
PK_R2 = ((If ((( ( ( Concat((CONST_BV_S7_V0), SF) ^ Concat((CONST_BV_S7_V0), OF) ) ^ (CONST_BV_S8_V1) ) == (CONST_BV_S8_V0) )  ) , ( Concat((CONST_BV_S32_V0), Extract( R1.size() - 32 - 1, R1.size() - 64, R1  ) ) ) , ( Concat((CONST_BV_S32_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) ) ))  )
PS_R2 = (Concat((CONST_BV_S32_V0), (If( (((CONST_BV_S8_V1) ^ ((If( (of),(CONST_BV_S8_V1),(CONST_BV_S8_V0))) ^ (If( (sf),(CONST_BV_S8_V1),(CONST_BV_S8_V0))))) == (CONST_BV_S8_V0)),(Extract (31, 0, ((R1)))),(Extract (31, 0, ((R2))))))))
