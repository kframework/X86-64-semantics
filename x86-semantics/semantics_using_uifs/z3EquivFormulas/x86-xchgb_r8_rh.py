...
print('[6;30;44m' + 'Opcode:xchgb_r8_rh' + '[0m')
...
PK_R2 = (Concat(Extract( R2.size() - 0 - 1, R2.size() - 56, R2  ) , Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) )
PS_R2 = (Concat((Extract (63, 8, ((R2)))), (Extract (15, 8, ((R1))))))
