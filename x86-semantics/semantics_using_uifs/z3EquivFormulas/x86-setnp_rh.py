...
print('[6;30;44m' + 'Opcode:setnp_rh' + '[0m')
...
PK_R1 = ((If ((( Concat((CONST_BV_S15_V0), PF) == (CONST_BV_S16_V0) )  ) , ( Concat(Extract( R1.size() - 0 - 1, R1.size() - 48, R1  ) , Concat((CONST_BV_S8_V1), Extract( R1.size() - 56 - 1, R1.size() - 64, R1  ) )) ) , ( Concat(Extract( R1.size() - 0 - 1, R1.size() - 48, R1  ) , Concat((CONST_BV_S8_V0), Extract( R1.size() - 56 - 1, R1.size() - 64, R1  ) )) ) ))  )
PS_R1 = (Concat((Concat((Extract (63, 16, ((R1)))), (If( ((If( (pf),(CONST_BV_S16_V1),(CONST_BV_S16_V0))) == (CONST_BV_S16_V0)),(CONST_BV_S8_V1),(CONST_BV_S8_V0))))), (Extract (7, 0, ((R1))))))
