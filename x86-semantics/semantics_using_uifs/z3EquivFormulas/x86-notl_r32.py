...
print('[6;30;44m' + 'Opcode:notl_r32' + '[0m')

R1 = BitVec('R1', 64)
CONST_BV_S64_V4294967295 = BitVecVal(4294967295, 64)
CONST_BV_S32_V0 = BitVecVal(0, 32)
CONST_BV_S64_Vffffffff = BitVecVal(0xffffffff, 64)

PK_R1 = (( (CONST_BV_S64_V4294967295) ^ Concat((CONST_BV_S32_V0), Extract( R1.size() - 32 - 1, R1.size() - 64, R1  ) ) )  )
PS_R1 = ((Concat((CONST_BV_S32_V0), (Extract (31, 0, ((R1)))))) ^ (CONST_BV_S64_Vffffffff))
