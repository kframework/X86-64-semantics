...
print('[6;30;44m' + 'Opcode:testw_r16_r16' + '[0m')
...
PK_SF = (( Extract( SignExt(64 - ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )).size(), ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ))).size() - 32 - 1, SignExt(64 - ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )).size(), ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ))).size() - 33, SignExt(64 - ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )).size(), ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )))  )  ^ ( Extract( SignExt(64 - ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )).size(), ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  ))).size() - 32 - 1, SignExt(64 - ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )).size(), ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  ))).size() - 33, SignExt(64 - ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )).size(), ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )))  )  ^ ( Extract( SignExt(64 - ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )).size(), ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  ))).size() - 32 - 1, SignExt(64 - ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )).size(), ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  ))).size() - 33, SignExt(64 - ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )).size(), ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )))  ) | Extract( SignExt(64 - ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )).size(), ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ))).size() - 32 - 1, SignExt(64 - ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )).size(), ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ))).size() - 33, SignExt(64 - ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )).size(), ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )))  ) )  ) )  ) == ONE1
PS_SF = (((((Extract (31, 31, ((SignExt( 64 - (Extract (15, 0, ((R1)))).size(), (Extract (15, 0, ((R1))))))))) | (Extract (31, 31, ((SignExt( 64 - (Extract (15, 0, ((R2)))).size(), (Extract (15, 0, ((R2)))))))))) ^ (Extract (31, 31, ((SignExt( 64 - (Extract (15, 0, ((R2)))).size(), (Extract (15, 0, ((R2)))))))))) ^ (Extract (31, 31, ((SignExt( 64 - (Extract (15, 0, ((R1)))).size(), (Extract (15, 0, ((R1)))))))))) == (CONST_BV_S1_V1))
proverUtils.prove( PK_SF == PS_SF )

PK_ZF = ((If ((( ( Extract( SignExt(64 - ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )).size(), ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ))).size() - 32 - 1, SignExt(64 - ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )).size(), ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ))).size() - 64, SignExt(64 - ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )).size(), ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )))  )  ^ ( Extract( SignExt(64 - ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )).size(), ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  ))).size() - 32 - 1, SignExt(64 - ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )).size(), ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  ))).size() - 64, SignExt(64 - ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )).size(), ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )))  )  ^ ( Extract( SignExt(64 - ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )).size(), ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  ))).size() - 32 - 1, SignExt(64 - ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )).size(), ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  ))).size() - 64, SignExt(64 - ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )).size(), ( Extract( R2.size() - 48 - 1, R2.size() - 64, R2  )))  ) | Extract( SignExt(64 - ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )).size(), ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ))).size() - 32 - 1, SignExt(64 - ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )).size(), ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ))).size() - 64, SignExt(64 - ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )).size(), ( Extract( R1.size() - 48 - 1, R1.size() - 64, R1  )))  ) )  ) ) == (CONST_BV_S32_V0) )  ) , ( (CONST_BV_S1_V1) ) , ( (CONST_BV_S1_V0) ) ))    ) == ONE1
PS_ZF = (((((Extract (31, 0, ((SignExt( 64 - (Extract (15, 0, ((R1)))).size(), (Extract (15, 0, ((R1))))))))) | (Extract (31, 0, ((SignExt( 64 - (Extract (15, 0, ((R2)))).size(), (Extract (15, 0, ((R2)))))))))) ^ (Extract (31, 0, ((SignExt( 64 - (Extract (15, 0, ((R2)))).size(), (Extract (15, 0, ((R2)))))))))) ^ (Extract (31, 0, ((SignExt( 64 - (Extract (15, 0, ((R1)))).size(), (Extract (15, 0, ((R1)))))))))) == (CONST_BV_S32_V0))
