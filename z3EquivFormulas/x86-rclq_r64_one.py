...
print('[6;30;44m' + 'Opcode:rclq_r64_one' + '[0m')
...
PK_CF = (Extract( ( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ) + Concat((CONST_BV_S64_V0), CF) ).size() - 0 - 1, ( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ) + Concat((CONST_BV_S64_V0), CF) ).size() - 1, ( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ) + Concat((CONST_BV_S64_V0), CF) )  )  ) == ONE1
PS_CF = ((Extract (64, 64, (((If( (cf),((Concat((CONST_BV_S1_V0), (R2))) + (CONST_BV_S65_V1)),(Concat((CONST_BV_S1_V0), (R2))))) + (Concat((CONST_BV_S1_V0), (R2))))))) == (CONST_BV_S1_V1))
proverUtils.prove( PK_CF == PS_CF )

PK_OF = ((If (( (And( ( Extract( R2.size() - 0 - 1, R2.size() - 1, R2  ) == Extract( R2.size() - 0 - 1, R2.size() - 1, R2  ) ) ,  (Not  ( ( Extract( R2.size() - 0 - 1, R2.size() - 1, R2  ) == Extract( ( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ) + Concat((CONST_BV_S64_V0), CF) ).size() - 1 - 1, ( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ) + Concat((CONST_BV_S64_V0), CF) ).size() - 2, ( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ) + Concat((CONST_BV_S64_V0), CF) )  ) )  ))  ))  ) , ( (CONST_BV_S1_V1) ) , ( (CONST_BV_S1_V0) ) ))  ) == ONE1
PS_OF = (And((((Extract (63, 63, ((R2)))) == (CONST_BV_S1_V1)) == ((Extract (63, 63, ((R2)))) == (CONST_BV_S1_V1))), (Not((((Extract (63, 63, ((R2)))) == (CONST_BV_S1_V1)) == ((Extract (63, 63, (((If( (cf),((Concat((CONST_BV_S1_V0), (R2))) + (CONST_BV_S65_V1)),(Concat((CONST_BV_S1_V0), (R2))))) + (Concat((CONST_BV_S1_V0), (R2))))))) == (CONST_BV_S1_V1)))))))
proverUtils.prove( PK_OF == PS_OF )

PK_R2 = (Extract( ( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ) + Concat((CONST_BV_S64_V0), CF) ).size() - 1 - 1, ( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ) + Concat((CONST_BV_S64_V0), CF) ).size() - 65, ( ( Concat((CONST_BV_S1_V0), R2) + Concat((CONST_BV_S1_V0), R2) ) + Concat((CONST_BV_S64_V0), CF) )  )  )
PS_R2 = (Extract (63, 0, (((If( (cf),((Concat((CONST_BV_S1_V0), (R2))) + (CONST_BV_S65_V1)),(Concat((CONST_BV_S1_V0), (R2))))) + (Concat((CONST_BV_S1_V0), (R2)))))))
