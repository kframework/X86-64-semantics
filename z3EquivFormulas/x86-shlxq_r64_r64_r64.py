...
print('[6;30;44m' + 'Opcode:shlxq_r64_r64_r64' + '[0m')
...
PK_R3 = ((If ((ULT( ( Extract( R1.size() - 56 - 1, R1.size() - 64, R1  ) & (CONST_BV_S8_V63) ), (CONST_BV_S8_V64) )  ) , ( ( R2 << Concat( BitVecVal(0, R2.size() - (( Extract( R1.size() - 56 - 1, R1.size() - 64, R1  ) & (CONST_BV_S8_V63) ) ).size()), (( Extract( R1.size() - 56 - 1, R1.size() - 64, R1  ) & (CONST_BV_S8_V63) ) )) )  ) , ( (CONST_BV_S64_V0) ) ))  )
PS_R3 = (Extract (63, 0, (((Concat((CONST_BV_S1_V0), (R2))) << (Concat((CONST_BV_S57_V0), ((Extract (7, 0, ((R1)))) & (CONST_BV_S8_V3f))))))))
