...
print('[6;30;44m' + 'Opcode:setns_r8' + '[0m')
...
PK_R1 = ((If ((( Concat((CONST_BV_S63_V0), SF) == (CONST_BV_S64_V0) )  ) , ( Concat(Extract( R1.size() - 0 - 1, R1.size() - 56, R1  ) , (CONST_BV_S8_V1)) ) , ( Concat(Extract( R1.size() - 0 - 1, R1.size() - 56, R1  ) , (CONST_BV_S8_V0)) ) ))  )
PS_R1 = (Concat((Extract (63, 8, ((R1)))), (If( ((If( (sf),(CONST_BV_S64_V1),(CONST_BV_S64_V0))) == (CONST_BV_S64_V0)),(CONST_BV_S8_V1),(CONST_BV_S8_V0)))))
