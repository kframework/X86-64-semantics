...
PK_R3 = (Concat(Concat( vfnmsub132_single ( Extract( R2.size() - 0 - 1, R2.size() - 32, R2  ) , Extract( R3.size() - 0 - 1, R3.size() - 32, R3  ) , Extract( R1.size() - 0 - 1, R1.size() - 32, R1  )  ) , Concat( vfnmsub132_single ( Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) , Extract( R3.size() - 32 - 1, R3.size() - 64, R3  ) , Extract( R1.size() - 32 - 1, R1.size() - 64, R1  )  ) , Concat( vfnmsub132_single ( Extract( R2.size() - 64 - 1, R2.size() - 96, R2  ) , Extract( R3.size() - 64 - 1, R3.size() - 96, R3  ) , Extract( R1.size() - 64 - 1, R1.size() - 96, R1  )  ) ,  vfnmsub132_single ( Extract( R2.size() - 96 - 1, R2.size() - 128, R2  ) , Extract( R3.size() - 96 - 1, R3.size() - 128, R3  ) , Extract( R1.size() - 96 - 1, R1.size() - 128, R1  )  ) ))), Concat( vfnmsub132_single ( Extract( R2.size() - 128 - 1, R2.size() - 160, R2  ) , Extract( R3.size() - 128 - 1, R3.size() - 160, R3  ) , Extract( R1.size() - 128 - 1, R1.size() - 160, R1  )  ) , Concat( vfnmsub132_single ( Extract( R2.size() - 160 - 1, R2.size() - 192, R2  ) , Extract( R3.size() - 160 - 1, R3.size() - 192, R3  ) , Extract( R1.size() - 160 - 1, R1.size() - 192, R1  )  ) , Concat( vfnmsub132_single ( Extract( R2.size() - 192 - 1, R2.size() - 224, R2  ) , Extract( R3.size() - 192 - 1, R3.size() - 224, R3  ) , Extract( R1.size() - 192 - 1, R1.size() - 224, R1  )  ) ,  vfnmsub132_single ( Extract( R2.size() - 224 - 1, R2.size() - 256, R2  ) , Extract( R3.size() - 224 - 1, R3.size() - 256, R3  ) , Extract( R1.size() - 224 - 1, R1.size() - 256, R1  )  ) )))) )
