...
print('[6;30;44m' + 'Opcode:vminss_xmm_xmm_xmm' + '[0m')
...
PK_R3 = (Concat(Concat((CONST_BV_S128_V0), Extract( R2.size() - 128 - 1, R2.size() - 224, R2  ) ),  (If( mincmp_single ( Extract( R2.size() - 224 - 1, R2.size() - 256, R2  ) , Extract( R1.size() - 224 - 1, R1.size() - 256, R1  )  ) == ONE1, Extract( R2.size() - 224 - 1, R2.size() - 256, R2  ) , Extract( R1.size() - 224 - 1, R1.size() - 256, R1  ) ))) )
PS_R3 = (Concat((CONST_BV_S128_V0), (Concat((Extract (127, 32, ((R2)))), (If( (( mincmp_single ( (Extract (31, 0, ((R2)))), (Extract (31, 0, ((R1)))))) == (CONST_BV_S1_V1)),(Extract (31, 0, ((R2)))),(Extract (31, 0, ((R1))))))))))
