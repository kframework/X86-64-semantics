...
PK_R2 = (Concat(Extract( R2.size() - 0 - 1, R2.size() - 192, R2  ) ,  cvt_single_to_double ( Extract( R1.size() - 224 - 1, R1.size() - 256, R1  )  ) ) )
PS_R2 = (Concat((Extract (255, 128, ((R2)))), (Concat((Extract (127, 64, ((R2)))), ( cvt_single_to_double ( (Extract (31, 0, ((R1))))))))))
