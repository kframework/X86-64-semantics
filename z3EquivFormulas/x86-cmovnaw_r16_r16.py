...
print('[6;30;44m' + 'Opcode:cmovnaw_r16_r16' + '[0m')
...
PK_R2 = ((If ((( Concat((CONST_BV_S7_V0), CF) == (CONST_BV_S8_V0) )  ) , ( (If ((( ZF == (CONST_BV_S1_V0) )  ) , ( R2 ) , ( Concat(Extract( R2.size() - 0 - 1, R2.size() - 48, R2  ) , Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ) ) ) )) ) , ( Concat(Extract( R2.size() - 0 - 1, R2.size() - 48, R2  ) , Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ) ) ) ))  )
PS_R2 = (Concat((Extract (63, 16, ((R2)))), (If( ((If( (cf),(CONST_BV_S8_V1),(CONST_BV_S8_V0))) == (CONST_BV_S8_V0)),(If( (zf),(Extract (15, 0, ((R1)))),(Extract (15, 0, ((R2)))))),(Extract (15, 0, ((R1))))))))
