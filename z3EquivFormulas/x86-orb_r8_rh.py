...
print('[6;30;44m' + 'Opcode:orb_r8_rh' + '[0m')
...
PK_R2 = (Concat(Extract( R2.size() - 0 - 1, R2.size() - 56, R2  ) , ( Extract( R2.size() - 56 - 1, R2.size() - 64, R2  )  | Extract( R1.size() - 48 - 1, R1.size() - 56, R1  )  ) ) )
PS_R2 = (Concat((Extract (63, 8, ((R2)))), ((Extract (15, 8, ((R1)))) | (Extract (7, 0, ((R2)))))))
proverUtils.prove( PK_R2 == PS_R2 )

PK_SF = (( Extract( SignExt(64 - ( Concat(Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) , Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) )).size(), ( Concat(Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) , Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) ))).size() - 0 - 1, SignExt(64 - ( Concat(Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) , Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) )).size(), ( Concat(Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) , Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) ))).size() - 1, SignExt(64 - ( Concat(Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) , Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) )).size(), ( Concat(Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) , Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) )))  )  | Extract( SignExt(64 - ( Concat(Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) , Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) )).size(), ( Concat(Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) , Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ))).size() - 0 - 1, SignExt(64 - ( Concat(Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) , Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) )).size(), ( Concat(Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) , Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ))).size() - 1, SignExt(64 - ( Concat(Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) , Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) )).size(), ( Concat(Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) , Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) )))  )  )  ) == ONE1
PS_SF = (((Extract (63, 63, ((SignExt( 64 - (Concat((Extract (15, 8, ((R1)))), (Extract (15, 8, ((R1)))))).size(), (Concat((Extract (15, 8, ((R1)))), (Extract (15, 8, ((R1))))))))))) | (Extract (63, 63, ((SignExt( 64 - (Concat((Extract (7, 0, ((R2)))), (Extract (7, 0, ((R2)))))).size(), (Concat((Extract (7, 0, ((R2)))), (Extract (7, 0, ((R2)))))))))))) == (CONST_BV_S1_V1))
proverUtils.prove( PK_SF == PS_SF )

PK_ZF = ((If ((( ( SignExt(64 - ( Concat(Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) , Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) )).size(), ( Concat(Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) , Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) ))) | SignExt(64 - ( Concat(Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) , Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) )).size(), ( Concat(Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) , Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ))) )  == (CONST_BV_S64_V0) )  ) , ( (CONST_BV_S1_V1) ) , ( (CONST_BV_S1_V0) ) ))    ) == ONE1
PS_ZF = (((SignExt( 64 - (Concat((Extract (15, 8, ((R1)))), (Extract (15, 8, ((R1)))))).size(), (Concat((Extract (15, 8, ((R1)))), (Extract (15, 8, ((R1)))))))) | (SignExt( 64 - (Concat((Extract (7, 0, ((R2)))), (Extract (7, 0, ((R2)))))).size(), (Concat((Extract (7, 0, ((R2)))), (Extract (7, 0, ((R2))))))))) == (CONST_BV_S64_V0))
