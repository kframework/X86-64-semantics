...
print('[6;30;44m' + 'Opcode:vmovd_xmm_r32' + '[0m')

R1 = BitVec('R1', 64)
R2 = BitVec('R2', 256)
CONST_BV_S224_V0 = BitVecVal(0, 224)

PK_R2 = (Concat((CONST_BV_S224_V0), Extract( R1.size() - 32 - 1, R1.size() - 64, R1  ) ) )
PS_R2 = (Concat((Concat((CONST_BV_S224_V0), (Extract (31, 24, ((R1)))))), (Extract (23, 0, ((R1))))))
