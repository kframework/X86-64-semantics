...
print('[6;30;44m' + 'Opcode:vunpckhps_xmm_xmm_xmm' + '[0m')
...
PS_R3 = (Concat((CONST_BV_S128_V0), (Concat((Concat((Concat((Extract (127, 96, ((R1)))), (Extract (127, 96, ((R2)))))), (Extract (95, 64, ((R1)))))), (Extract (95, 64, ((R2))))))))
