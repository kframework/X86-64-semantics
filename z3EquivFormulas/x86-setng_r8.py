...
print('[6;30;44m' + 'Opcode:setng_r8' + '[0m')
...
PK_R1 = ((If ((( Concat(( Concat((CONST_BV_S7_V0), SF) ^ Concat((CONST_BV_S7_V0), OF) ) , Concat((CONST_BV_S7_V0), ZF)) == (CONST_BV_S16_V0) )  ) , ( Concat(Extract( R1.size() - 0 - 1, R1.size() - 56, R1  ) , (CONST_BV_S8_V0)) ) , ( Concat(Extract( R1.size() - 0 - 1, R1.size() - 56, R1  ) , (CONST_BV_S8_V1)) ) ))  )
PS_R1 = (Concat((Extract (63, 8, ((R1)))), (If( ((Concat(((If( (of),(CONST_BV_S8_V1),(CONST_BV_S8_V0))) ^ (If( (sf),(CONST_BV_S8_V1),(CONST_BV_S8_V0)))), (If( (zf),(CONST_BV_S8_V1),(CONST_BV_S8_V0))))) == (CONST_BV_S16_V0)),(CONST_BV_S8_V0),(CONST_BV_S8_V1)))))
