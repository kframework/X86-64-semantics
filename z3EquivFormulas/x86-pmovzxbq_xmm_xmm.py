...
print('[6;30;44m' + 'Opcode:pmovzxbq_xmm_xmm' + '[0m')

R1 = BitVec('R1', 256)
R2 = BitVec('R2', 256)
CONST_BV_S56_V0 = BitVecVal(0, 56)

PK_R2 = (Concat(Extract( R2.size() - 0 - 1, R2.size() - 128, R2  ) , Concat(Concat((CONST_BV_S56_V0), Extract( R1.size() - 240 - 1, R1.size() - 248, R1  ) ), Concat((CONST_BV_S56_V0), Extract( R1.size() - 248 - 1, R1.size() - 256, R1  ) ))) )
PS_R2 = (Concat((Extract (255, 128, ((R2)))), (Concat((Concat((CONST_BV_S56_V0), (Extract (15, 8, ((R1)))))), (Concat((CONST_BV_S56_V0), (Extract (7, 0, ((R1))))))))))
