...
print('[6;30;44m' + 'Opcode:cqto' + '[0m')

CONST_BV_S1_V0 = BitVecVal(0x0, 1)
CONST_BV_S57_V0 = BitVecVal(0x0, 57)
CONST_BV_S8_V3f = BitVecVal(0x3f, 8)

PK_RDX = (( SignExt(64 - ( RAX).size(), ( RAX)) >> BitVecVal(63, SignExt(64 - ( RAX).size(), ( RAX)).size()) )    )
PS_RDX = (Extract (64, 1, (((Concat((RAX), (CONST_BV_S1_V0))) >> (Concat((CONST_BV_S57_V0), (CONST_BV_S8_V3f)))))))
