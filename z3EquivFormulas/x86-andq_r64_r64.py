...
print('[6;30;44m' + 'Opcode:andq_r64_r64' + '[0m')
...
PK_R2 = (( ( ( ( R2 ^ (CONST_BV_S64_V0) ) ^ ( R1 ^ (CONST_BV_S64_V0) ) ) | ( R1 ^ (CONST_BV_S64_V0) ) )  ^ ( ( R2 ^ (CONST_BV_S64_V0) ) ^ ( R1 ^ (CONST_BV_S64_V0) ) ) )  )
PS_R2 = ((((CONST_BV_S64_V0) ^ (R1)) ^ ((CONST_BV_S64_V0) ^ (R2))) ^ (((CONST_BV_S64_V0) ^ (R1)) | (((CONST_BV_S64_V0) ^ (R1)) ^ ((CONST_BV_S64_V0) ^ (R2)))))
proverUtils.prove( PK_R2 == PS_R2 )

PK_SF = (( ( ( ( Extract( R2.size() - 0 - 1, R2.size() - 1, R2  )  ^ (CONST_BV_S1_V0) ) ^ ( Extract( R1.size() - 0 - 1, R1.size() - 1, R1  )  ^ (CONST_BV_S1_V0) ) ) | ( Extract( R1.size() - 0 - 1, R1.size() - 1, R1  )  ^ (CONST_BV_S1_V0) ) )  ^ ( ( Extract( R2.size() - 0 - 1, R2.size() - 1, R2  )  ^ (CONST_BV_S1_V0) ) ^ ( Extract( R1.size() - 0 - 1, R1.size() - 1, R1  )  ^ (CONST_BV_S1_V0) ) ) )  ) == ONE1
PS_SF = (((((CONST_BV_S1_V0) ^ (Extract (63, 63, ((R1))))) ^ ((CONST_BV_S1_V0) ^ (Extract (63, 63, ((R2)))))) ^ (((CONST_BV_S1_V0) ^ (Extract (63, 63, ((R1))))) | (((CONST_BV_S1_V0) ^ (Extract (63, 63, ((R1))))) ^ ((CONST_BV_S1_V0) ^ (Extract (63, 63, ((R2)))))))) == (CONST_BV_S1_V1))
proverUtils.prove( PK_SF == PS_SF )

PK_ZF = ((If ((( ( ( ( ( R2 ^ (CONST_BV_S64_V0) ) ^ ( R1 ^ (CONST_BV_S64_V0) ) ) | ( R1 ^ (CONST_BV_S64_V0) ) )  ^ ( ( R2 ^ (CONST_BV_S64_V0) ) ^ ( R1 ^ (CONST_BV_S64_V0) ) ) ) == (CONST_BV_S64_V0) )  ) , ( (CONST_BV_S1_V1) ) , ( (CONST_BV_S1_V0) ) ))  ) == ONE1
PS_ZF = (((((CONST_BV_S64_V0) ^ (R1)) ^ ((CONST_BV_S64_V0) ^ (R2))) ^ (((CONST_BV_S64_V0) ^ (R1)) | (((CONST_BV_S64_V0) ^ (R1)) ^ ((CONST_BV_S64_V0) ^ (R2))))) == (CONST_BV_S64_V0))
