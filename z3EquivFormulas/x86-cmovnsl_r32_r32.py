...
print('[6;30;44m' + 'Opcode:cmovnsl_r32_r32' + '[0m')
...
PK_R2 = ((If ((( Extract( ( Concat((CONST_BV_S32_V0), SF) + (CONST_BV_S33_V4294967295) ).size() - 1 - 1, ( Concat((CONST_BV_S32_V0), SF) + (CONST_BV_S33_V4294967295) ).size() - 33, ( Concat((CONST_BV_S32_V0), SF) + (CONST_BV_S33_V4294967295) )  ) == (CONST_BV_S32_V0) )  ) , ( Concat((CONST_BV_S32_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) ) , ( Concat((CONST_BV_S32_V0), Extract( R1.size() - 32 - 1, R1.size() - 64, R1  ) ) ) ))  )
PS_R2 = (Concat((CONST_BV_S32_V0), (If( ((If( (sf),(CONST_BV_S32_V0),(CONST_BV_S32_Vffffffff))) == (CONST_BV_S32_V0)),(Extract (31, 0, ((R2)))),(Extract (31, 0, ((R1))))))))
