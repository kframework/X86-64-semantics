...
print('[6;30;44m' + 'Opcode:addb_rh_rh' + '[0m')
...
PK_CF = (Extract( ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) ).size() - 0 - 1, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) ).size() - 1, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) )  )  ) == ONE1
PS_CF = ((Extract (8, 8, (((Concat((CONST_BV_S1_V0), (Extract (15, 8, ((R2)))))) + (Concat((CONST_BV_S1_V0), (Extract (15, 8, ((R1)))))))))) == (CONST_BV_S1_V1))
proverUtils.prove( PK_CF == PS_CF )

PK_OF = ((If (( (And( ( Extract( R2.size() - 48 - 1, R2.size() - 49, R2  ) == Extract( R1.size() - 48 - 1, R1.size() - 49, R1  ) ) ,  (Not  ( ( Extract( R2.size() - 48 - 1, R2.size() - 49, R2  ) == Extract( ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) ).size() - 2, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) )  ) )  ))  ))  ) , ( (CONST_BV_S1_V1) ) , ( (CONST_BV_S1_V0) ) ))  ) == ONE1
PS_OF = (And((((Extract (15, 15, ((R2)))) == (CONST_BV_S1_V1)) == ((Extract (15, 15, ((R1)))) == (CONST_BV_S1_V1))), (Not((((Extract (15, 15, ((R2)))) == (CONST_BV_S1_V1)) == ((Extract (7, 7, (((Concat((CONST_BV_S1_V0), (Extract (15, 8, ((R2)))))) + (Concat((CONST_BV_S1_V0), (Extract (15, 8, ((R1)))))))))) == (CONST_BV_S1_V1)))))))
proverUtils.prove( PK_OF == PS_OF )

PK_R2 = (Concat(Extract( R2.size() - 0 - 1, R2.size() - 48, R2  ) , Concat(Extract( ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) ).size() - 9, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) )  ) , Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) )) )
PS_R2 = (Concat((Concat((Extract (63, 16, ((R2)))), (Extract (7, 0, (((Concat((CONST_BV_S1_V0), (Extract (15, 8, ((R2)))))) + (Concat((CONST_BV_S1_V0), (Extract (15, 8, ((R1)))))))))))), (Extract (7, 0, ((R2))))))
proverUtils.prove( PK_R2 == PS_R2 )

PK_SF = (Extract( ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) ).size() - 2, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) )  )  ) == ONE1
PS_SF = ((Extract (7, 7, (((Concat((CONST_BV_S1_V0), (Extract (15, 8, ((R2)))))) + (Concat((CONST_BV_S1_V0), (Extract (15, 8, ((R1)))))))))) == (CONST_BV_S1_V1))
proverUtils.prove( PK_SF == PS_SF )

PK_ZF = ((If ((( Extract( ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) ).size() - 9, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 48 - 1, R2.size() - 56, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R1.size() - 48 - 1, R1.size() - 56, R1  ) ) )  ) == (CONST_BV_S8_V0) )  ) , ( (CONST_BV_S1_V1) ) , ( (CONST_BV_S1_V0) ) ))    ) == ONE1
PS_ZF = ((Extract (7, 0, (((Concat((CONST_BV_S1_V0), (Extract (15, 8, ((R2)))))) + (Concat((CONST_BV_S1_V0), (Extract (15, 8, ((R1)))))))))) == (CONST_BV_S8_V0))
