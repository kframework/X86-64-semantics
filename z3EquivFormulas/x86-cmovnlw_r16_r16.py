...
print('[6;30;44m' + 'Opcode:cmovnlw_r16_r16' + '[0m')
...
PK_R2 = ((If ((( ( SF ^ OF ) == (CONST_BV_S1_V0) )  ) , ( Concat(Extract( R2.size() - 0 - 1, R2.size() - 48, R2  ) , Extract( R1.size() - 48 - 1, R1.size() - 64, R1  ) ) ) , ( R2 ) ))    )
PS_R2 = (Concat((Extract (63, 16, ((R2)))), (If( (((If( (of),(CONST_BV_S1_V1),(CONST_BV_S1_V0))) ^ (If( (sf),(CONST_BV_S1_V1),(CONST_BV_S1_V0)))) == (CONST_BV_S1_V1)),(Extract (15, 0, ((R2)))),(Extract (15, 0, ((R1))))))))
