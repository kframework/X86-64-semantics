...
print('[6;30;44m' + 'Opcode:setno_rh' + '[0m')

R1 = BitVec('R1', 64)
CONST_BV_S31_V0 = BitVecVal(0, 31)
CONST_BV_S32_V0 = BitVecVal(0, 32)
CONST_BV_S8_V1 = BitVecVal(1, 8)
CONST_BV_S8_V0 = BitVecVal(0, 8)
CONST_BV_S32_V1 = BitVecVal(0x1, 32)

PK_R1 = ((If ((( Concat((CONST_BV_S31_V0), OF) == (CONST_BV_S32_V0) )  ) , ( Concat(Extract( R1.size() - 0 - 1, R1.size() - 48, R1  ) , Concat((CONST_BV_S8_V1), Extract( R1.size() - 56 - 1, R1.size() - 64, R1  ) )) ) , ( Concat(Extract( R1.size() - 0 - 1, R1.size() - 48, R1  ) , Concat((CONST_BV_S8_V0), Extract( R1.size() - 56 - 1, R1.size() - 64, R1  ) )) ) ))  )
PS_R1 = (Concat((Concat((Extract (63, 16, ((R1)))), (If( ((If( (of),(CONST_BV_S32_V1),(CONST_BV_S32_V0))) == (CONST_BV_S32_V0)),(CONST_BV_S8_V1),(CONST_BV_S8_V0))))), (Extract (7, 0, ((R1))))))
