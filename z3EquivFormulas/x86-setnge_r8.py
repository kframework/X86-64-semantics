...
print('[6;30;44m' + 'Opcode:setnge_r8' + '[0m')
...
PK_R1 = (Concat(Extract( R1.size() - 0 - 1, R1.size() - 56, R1  ) , ( Concat((CONST_BV_S7_V0), OF) ^ Concat((CONST_BV_S7_V0), SF) ) ) )
PS_R1 = (Concat((Extract (63, 8, ((R1)))), ((If( (sf),(CONST_BV_S8_V1),(CONST_BV_S8_V0))) ^ (If( (of),(CONST_BV_S8_V1),(CONST_BV_S8_V0))))))
