...
print('[6;30;44m' + 'Opcode:setae_r8' + '[0m')
...
PK_R1 = ((If ((( Concat((CONST_BV_S7_V0), CF) == (CONST_BV_S8_V0) )  ) , ( Concat(Extract( R1.size() - 0 - 1, R1.size() - 56, R1  ) , (CONST_BV_S8_V1)) ) , ( Concat(Extract( R1.size() - 0 - 1, R1.size() - 56, R1  ) , (CONST_BV_S8_V0)) ) ))  )
PS_R1 = (Concat((Extract (63, 8, ((R1)))), (If( ((If( (cf),(CONST_BV_S8_V1),(CONST_BV_S8_V0))) == (CONST_BV_S8_V0)),(CONST_BV_S8_V1),(CONST_BV_S8_V0)))))
