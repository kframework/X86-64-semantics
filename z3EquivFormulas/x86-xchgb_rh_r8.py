...
print('[6;30;44m' + 'Opcode:xchgb_rh_r8' + '[0m')
...
PK_R2 = (Concat(Extract( R2.size() - 0 - 1, R2.size() - 48, R2  ) , Concat(Extract( R1.size() - 56 - 1, R1.size() - 64, R1  ) , Extract( R2.size() - 56 - 1, R2.size() - 64, R2  ) )) )
PS_R2 = (Concat((Concat((Extract (63, 16, ((R2)))), (Extract (7, 0, ((R1)))))), (Extract (7, 0, ((R2))))))
