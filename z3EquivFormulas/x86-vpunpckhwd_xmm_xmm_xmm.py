...
print('[6;30;44m' + 'Opcode:vpunpckhwd_xmm_xmm_xmm' + '[0m')
...
PK_R3 = (Concat((CONST_BV_S128_V0), Concat(( ( ( Concat(Concat((CONST_BV_S16_V0), Extract( R1.size() - 144 - 1, R1.size() - 160, R1  ) ), Concat((CONST_BV_S16_V0), Extract( R1.size() - 144 - 1, R1.size() - 160, R1  ) )) | Concat(Extract( R1.size() - 128 - 1, R1.size() - 160, R1  ) , Concat(Extract( R1.size() - 144 - 1, R1.size() - 160, R1  ) , Extract( R1.size() - 144 - 1, R1.size() - 160, R1  ) )) )  ^ Concat(Concat((CONST_BV_S16_V0), Extract( R1.size() - 144 - 1, R1.size() - 160, R1  ) ), Concat((CONST_BV_S16_V0), Extract( R1.size() - 144 - 1, R1.size() - 160, R1  ) )) ) ^ Concat(Concat((CONST_BV_S16_V0), Extract( R2.size() - 128 - 1, R2.size() - 144, R2  ) ), Concat((CONST_BV_S16_V0), Extract( R2.size() - 144 - 1, R2.size() - 160, R2  ) )) ) , ( ( ( Concat(Concat((CONST_BV_S16_V0), Extract( R1.size() - 176 - 1, R1.size() - 192, R1  ) ), Concat((CONST_BV_S16_V0), Extract( R1.size() - 176 - 1, R1.size() - 192, R1  ) )) | Concat(Extract( R1.size() - 160 - 1, R1.size() - 192, R1  ) , Concat(Extract( R1.size() - 176 - 1, R1.size() - 192, R1  ) , Extract( R1.size() - 176 - 1, R1.size() - 192, R1  ) )) )  ^ Concat(Concat((CONST_BV_S16_V0), Extract( R1.size() - 176 - 1, R1.size() - 192, R1  ) ), Concat((CONST_BV_S16_V0), Extract( R1.size() - 176 - 1, R1.size() - 192, R1  ) )) ) ^ Concat(Concat((CONST_BV_S16_V0), Extract( R2.size() - 160 - 1, R2.size() - 176, R2  ) ), Concat((CONST_BV_S16_V0), Extract( R2.size() - 176 - 1, R2.size() - 192, R2  ) )) ) )) )
PS_R3 = (Concat((CONST_BV_S128_V0), (Concat(((Concat((Concat((CONST_BV_S16_V0), (Extract (127, 112, ((R2)))))), (Concat((CONST_BV_S16_V0), (Extract (111, 96, ((R2)))))))) ^ ((Concat((Concat((CONST_BV_S16_V0), (Extract (111, 96, ((R1)))))), (Concat((CONST_BV_S16_V0), (Extract (111, 96, ((R1)))))))) ^ ((Concat((Extract (127, 96, ((R1)))), (Concat((Extract (111, 96, ((R1)))), (Extract (111, 96, ((R1)))))))) | (Concat((Concat((CONST_BV_S16_V0), (Extract (111, 96, ((R1)))))), (Concat((CONST_BV_S16_V0), (Extract (111, 96, ((R1))))))))))), ((Concat((Concat((CONST_BV_S16_V0), (Extract (95, 80, ((R2)))))), (Concat((CONST_BV_S16_V0), (Extract (79, 64, ((R2)))))))) ^ ((Concat((Concat((CONST_BV_S16_V0), (Extract (79, 64, ((R1)))))), (Concat((CONST_BV_S16_V0), (Extract (79, 64, ((R1)))))))) ^ ((Concat((Extract (95, 64, ((R1)))), (Concat((Extract (79, 64, ((R1)))), (Extract (79, 64, ((R1)))))))) | (Concat((Concat((CONST_BV_S16_V0), (Extract (79, 64, ((R1)))))), (Concat((CONST_BV_S16_V0), (Extract (79, 64, ((R1)))))))))))))))
