...
print('[6;30;44m' + 'Opcode:vmovq_xmm_r64' + '[0m')
...
PK_R2 = (Concat((CONST_BV_S192_V0), ( R1 ^ (CONST_BV_S64_V0) ) ) )
PS_R2 = (Concat((CONST_BV_S128_V0), (Concat((CONST_BV_S64_V0), ((CONST_BV_S64_V0) ^ (R1))))))
