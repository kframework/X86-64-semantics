### Nov 9
  ...
  - The local testsuite is tested on IDA cfgs. Enhanced the code to handle some of the constrcts generated by McSema from IDA cfg. Jenkins is grean again.
