...
union_size:
	pushq	%rbp
	movq	%rsp, %rbp
	movabsq	$4611686018427387648, %rax
	popq	%rbp
	ret
	.size	union_size, .-union_size
	.globl	struct_size
	.type	struct_size, @function
struct_size:
	pushq	%rbp
	movq	%rsp, %rbp
	movabsq	$9223372036854775312, %rax
	popq	%rbp
	ret
	.size	struct_size, .-struct_size
...
struct_a_offset:
	...
	popq	%rbp
	ret
	.size	struct_a_offset, .-struct_a_offset
	.globl	main
	.type	main, @function
main:
	pushq	%rbp
