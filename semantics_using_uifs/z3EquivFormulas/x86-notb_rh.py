...
print('[6;30;44m' + 'Opcode:notb_rh' + '[0m')

R1 = BitVec('R1', 64)
CONST_BV_S8_V255 = BitVecVal(255, 8)
CONST_BV_S8_Vff = BitVecVal(0xff, 8)

PK_R1 = (Concat(Extract( R1.size() - 0 - 1, R1.size() - 48, R1  ) , Concat(( Extract( R1.size() - 48 - 1, R1.size() - 56, R1  )  ^ (CONST_BV_S8_V255) ) , Extract( R1.size() - 56 - 1, R1.size() - 64, R1  ) )) )
PS_R1 = (Concat((Concat((Extract (63, 16, ((R1)))), ((CONST_BV_S8_Vff) ^ (Extract (15, 8, ((R1))))))), (Extract (7, 0, ((R1))))))
