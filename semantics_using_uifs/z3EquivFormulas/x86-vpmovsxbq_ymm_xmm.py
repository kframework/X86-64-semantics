...
print('[6;30;44m' + 'Opcode:vpmovsxbq_ymm_xmm' + '[0m')
...
PK_R2 = (Concat(Concat(SignExt(64 - ( ( (CONST_BV_S32_VNEG128) ^ Extract( ( Concat((CONST_BV_S57_V0), Extract( R1.size() - 224 - 1, R1.size() - 232, R1  ) ) + (CONST_BV_S65_V4294967168) ).size() - 33 - 1, ( Concat((CONST_BV_S57_V0), Extract( R1.size() - 224 - 1, R1.size() - 232, R1  ) ) + (CONST_BV_S65_V4294967168) ).size() - 65, ( Concat((CONST_BV_S57_V0), Extract( R1.size() - 224 - 1, R1.size() - 232, R1  ) ) + (CONST_BV_S65_V4294967168) )  )  )).size(), ( ( (CONST_BV_S32_VNEG128) ^ Extract( ( Concat((CONST_BV_S57_V0), Extract( R1.size() - 224 - 1, R1.size() - 232, R1  ) ) + (CONST_BV_S65_V4294967168) ).size() - 33 - 1, ( Concat((CONST_BV_S57_V0), Extract( R1.size() - 224 - 1, R1.size() - 232, R1  ) ) + (CONST_BV_S65_V4294967168) ).size() - 65, ( Concat((CONST_BV_S57_V0), Extract( R1.size() - 224 - 1, R1.size() - 232, R1  ) ) + (CONST_BV_S65_V4294967168) )  )  ))), SignExt(64 - ( ( (CONST_BV_S32_VNEG128) ^ Extract( ( Concat((CONST_BV_S1_V0), Concat(Concat((CONST_BV_S24_V0), Extract( R1.size() - 232 - 1, R1.size() - 240, R1  ) ), (CONST_BV_S32_VNEG128))) + Concat((CONST_BV_S57_V0), Extract( R1.size() - 232 - 1, R1.size() - 240, R1  ) ) ).size() - 33 - 1, ( Concat((CONST_BV_S1_V0), Concat(Concat((CONST_BV_S24_V0), Extract( R1.size() - 232 - 1, R1.size() - 240, R1  ) ), (CONST_BV_S32_VNEG128))) + Concat((CONST_BV_S57_V0), Extract( R1.size() - 232 - 1, R1.size() - 240, R1  ) ) ).size() - 65, ( Concat((CONST_BV_S1_V0), Concat(Concat((CONST_BV_S24_V0), Extract( R1.size() - 232 - 1, R1.size() - 240, R1  ) ), (CONST_BV_S32_VNEG128))) + Concat((CONST_BV_S57_V0), Extract( R1.size() - 232 - 1, R1.size() - 240, R1  ) ) )  )  )).size(), ( ( (CONST_BV_S32_VNEG128) ^ Extract( ( Concat((CONST_BV_S1_V0), Concat(Concat((CONST_BV_S24_V0), Extract( R1.size() - 232 - 1, R1.size() - 240, R1  ) ), (CONST_BV_S32_VNEG128))) + Concat((CONST_BV_S57_V0), Extract( R1.size() - 232 - 1, R1.size() - 240, R1  ) ) ).size() - 33 - 1, ( Concat((CONST_BV_S1_V0), Concat(Concat((CONST_BV_S24_V0), Extract( R1.size() - 232 - 1, R1.size() - 240, R1  ) ), (CONST_BV_S32_VNEG128))) + Concat((CONST_BV_S57_V0), Extract( R1.size() - 232 - 1, R1.size() - 240, R1  ) ) ).size() - 65, ( Concat((CONST_BV_S1_V0), Concat(Concat((CONST_BV_S24_V0), Extract( R1.size() - 232 - 1, R1.size() - 240, R1  ) ), (CONST_BV_S32_VNEG128))) + Concat((CONST_BV_S57_V0), Extract( R1.size() - 232 - 1, R1.size() - 240, R1  ) ) )  )  )))), Concat(SignExt(64 - ( ( (CONST_BV_S32_VNEG128) ^ Extract( ( (CONST_BV_S65_V18446743528248704896) + Concat((CONST_BV_S1_V0), Concat((CONST_BV_S32_VNEG128), Concat((CONST_BV_S24_V0), Extract( R1.size() - 240 - 1, R1.size() - 248, R1  ) ))) ).size() - 33 - 1, ( (CONST_BV_S65_V18446743528248704896) + Concat((CONST_BV_S1_V0), Concat((CONST_BV_S32_VNEG128), Concat((CONST_BV_S24_V0), Extract( R1.size() - 240 - 1, R1.size() - 248, R1  ) ))) ).size() - 65, ( (CONST_BV_S65_V18446743528248704896) + Concat((CONST_BV_S1_V0), Concat((CONST_BV_S32_VNEG128), Concat((CONST_BV_S24_V0), Extract( R1.size() - 240 - 1, R1.size() - 248, R1  ) ))) )  )  )).size(), ( ( (CONST_BV_S32_VNEG128) ^ Extract( ( (CONST_BV_S65_V18446743528248704896) + Concat((CONST_BV_S1_V0), Concat((CONST_BV_S32_VNEG128), Concat((CONST_BV_S24_V0), Extract( R1.size() - 240 - 1, R1.size() - 248, R1  ) ))) ).size() - 33 - 1, ( (CONST_BV_S65_V18446743528248704896) + Concat((CONST_BV_S1_V0), Concat((CONST_BV_S32_VNEG128), Concat((CONST_BV_S24_V0), Extract( R1.size() - 240 - 1, R1.size() - 248, R1  ) ))) ).size() - 65, ( (CONST_BV_S65_V18446743528248704896) + Concat((CONST_BV_S1_V0), Concat((CONST_BV_S32_VNEG128), Concat((CONST_BV_S24_V0), Extract( R1.size() - 240 - 1, R1.size() - 248, R1  ) ))) )  )  ))), SignExt(64 - ( ( (CONST_BV_S32_VNEG128) ^ Extract( ( (CONST_BV_S65_V18446743528248704896) + Concat((CONST_BV_S1_V0), Concat((CONST_BV_S32_VNEG128), Concat((CONST_BV_S24_V0), Extract( R1.size() - 248 - 1, R1.size() - 256, R1  ) ))) ).size() - 33 - 1, ( (CONST_BV_S65_V18446743528248704896) + Concat((CONST_BV_S1_V0), Concat((CONST_BV_S32_VNEG128), Concat((CONST_BV_S24_V0), Extract( R1.size() - 248 - 1, R1.size() - 256, R1  ) ))) ).size() - 65, ( (CONST_BV_S65_V18446743528248704896) + Concat((CONST_BV_S1_V0), Concat((CONST_BV_S32_VNEG128), Concat((CONST_BV_S24_V0), Extract( R1.size() - 248 - 1, R1.size() - 256, R1  ) ))) )  )  )).size(), ( ( (CONST_BV_S32_VNEG128) ^ Extract( ( (CONST_BV_S65_V18446743528248704896) + Concat((CONST_BV_S1_V0), Concat((CONST_BV_S32_VNEG128), Concat((CONST_BV_S24_V0), Extract( R1.size() - 248 - 1, R1.size() - 256, R1  ) ))) ).size() - 33 - 1, ( (CONST_BV_S65_V18446743528248704896) + Concat((CONST_BV_S1_V0), Concat((CONST_BV_S32_VNEG128), Concat((CONST_BV_S24_V0), Extract( R1.size() - 248 - 1, R1.size() - 256, R1  ) ))) ).size() - 65, ( (CONST_BV_S65_V18446743528248704896) + Concat((CONST_BV_S1_V0), Concat((CONST_BV_S32_VNEG128), Concat((CONST_BV_S24_V0), Extract( R1.size() - 248 - 1, R1.size() - 256, R1  ) ))) )  )  ))))) )
PS_R2 = (Concat((Concat((Concat((Concat((SignExt( 64 - ((Extract (31, 0, (((Concat((CONST_BV_S1_V0), (Concat((CONST_BV_S32_V0), (Concat((CONST_BV_S24_V0), (Extract (31, 24, ((R1)))))))))) + (Concat((CONST_BV_S1_V0), (CONST_BV_S64_Vffffff80))))))) ^ (CONST_BV_S32_Vffffff80)).size(), ((Extract (31, 0, (((Concat((CONST_BV_S1_V0), (Concat((CONST_BV_S32_V0), (Concat((CONST_BV_S24_V0), (Extract (31, 24, ((R1)))))))))) + (Concat((CONST_BV_S1_V0), (CONST_BV_S64_Vffffff80))))))) ^ (CONST_BV_S32_Vffffff80)))), (SignExt( 64 - ((Extract (31, 0, (((Concat((CONST_BV_S1_V0), (Concat((Concat((CONST_BV_S24_V0), (Extract (23, 16, ((R1)))))), (CONST_BV_S32_Vffffff80))))) + (Concat((CONST_BV_S1_V0), (Concat((CONST_BV_S32_V0), (Concat((CONST_BV_S24_V0), (Extract (23, 16, ((R1)))))))))))))) ^ (CONST_BV_S32_Vffffff80)).size(), ((Extract (31, 0, (((Concat((CONST_BV_S1_V0), (Concat((Concat((CONST_BV_S24_V0), (Extract (23, 16, ((R1)))))), (CONST_BV_S32_Vffffff80))))) + (Concat((CONST_BV_S1_V0), (Concat((CONST_BV_S32_V0), (Concat((CONST_BV_S24_V0), (Extract (23, 16, ((R1)))))))))))))) ^ (CONST_BV_S32_Vffffff80)))))), (Extract (63, 40, ((SignExt( 64 - ((Extract (31, 0, (((Concat((CONST_BV_S1_V0), (CONST_BV_S64_Vffffff80ffffff80))) + (Concat((CONST_BV_S1_V0), (Concat((CONST_BV_S32_Vffffff80), (Concat((CONST_BV_S24_V0), (Extract (15, 8, ((R1)))))))))))))) ^ (CONST_BV_S32_Vffffff80)).size(), ((Extract (31, 0, (((Concat((CONST_BV_S1_V0), (CONST_BV_S64_Vffffff80ffffff80))) + (Concat((CONST_BV_S1_V0), (Concat((CONST_BV_S32_Vffffff80), (Concat((CONST_BV_S24_V0), (Extract (15, 8, ((R1)))))))))))))) ^ (CONST_BV_S32_Vffffff80))))))))), (Extract (39, 32, ((SignExt( 64 - ((Extract (31, 0, (((Concat((CONST_BV_S1_V0), (CONST_BV_S64_Vffffff80ffffff80))) + (Concat((CONST_BV_S1_V0), (Concat((CONST_BV_S32_Vffffff80), (Concat((CONST_BV_S24_V0), (Extract (15, 8, ((R1)))))))))))))) ^ (CONST_BV_S32_Vffffff80)).size(), ((Extract (31, 0, (((Concat((CONST_BV_S1_V0), (CONST_BV_S64_Vffffff80ffffff80))) + (Concat((CONST_BV_S1_V0), (Concat((CONST_BV_S32_Vffffff80), (Concat((CONST_BV_S24_V0), (Extract (15, 8, ((R1)))))))))))))) ^ (CONST_BV_S32_Vffffff80))))))))), (Concat(((Extract (31, 0, (((Concat((CONST_BV_S1_V0), (CONST_BV_S64_Vffffff80ffffff80))) + (Concat((CONST_BV_S1_V0), (Concat((CONST_BV_S32_Vffffff80), (Concat((CONST_BV_S24_V0), (Extract (15, 8, ((R1)))))))))))))) ^ (CONST_BV_S32_Vffffff80)), (SignExt( 64 - ((Extract (31, 0, (((Concat((CONST_BV_S1_V0), (CONST_BV_S64_Vffffff80ffffff80))) + (Concat((CONST_BV_S1_V0), (Concat((CONST_BV_S32_Vffffff80), (Concat((CONST_BV_S24_V0), (Extract (7, 0, ((R1)))))))))))))) ^ (CONST_BV_S32_Vffffff80)).size(), ((Extract (31, 0, (((Concat((CONST_BV_S1_V0), (CONST_BV_S64_Vffffff80ffffff80))) + (Concat((CONST_BV_S1_V0), (Concat((CONST_BV_S32_Vffffff80), (Concat((CONST_BV_S24_V0), (Extract (7, 0, ((R1)))))))))))))) ^ (CONST_BV_S32_Vffffff80))))))))
