...
print('[6;30;44m' + 'Opcode:shll_r32_one' + '[0m')
...
PK_CF = (Extract( ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) ).size() - 0 - 1, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) ).size() - 1, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) )  )  ) == ONE1
PS_CF = ((Extract (32, 32, (((Concat((CONST_BV_S1_V0), (Extract (31, 0, ((R2)))))) + (Concat((CONST_BV_S1_V0), (Extract (31, 0, ((R2)))))))))) == (CONST_BV_S1_V1))
proverUtils.prove( PK_CF == PS_CF )

PK_OF = ((If (( (And( ( Extract( R2.size() - 32 - 1, R2.size() - 33, R2  )  == Extract( R2.size() - 32 - 1, R2.size() - 33, R2  )  ) ,  (Not  ( ( Extract( R2.size() - 32 - 1, R2.size() - 33, R2  )  == Extract( ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) ).size() - 2, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) )  )  )  ))  ))  ) , ( (CONST_BV_S1_V1) ) , ( (CONST_BV_S1_V0) ) ))  ) == ONE1
PS_OF = (And((((Extract (31, 31, ((R2)))) == (CONST_BV_S1_V1)) == ((Extract (31, 31, ((R2)))) == (CONST_BV_S1_V1))), (Not((((Extract (31, 31, ((R2)))) == (CONST_BV_S1_V1)) == ((Extract (31, 31, (((Concat((CONST_BV_S1_V0), (Extract (31, 0, ((R2)))))) + (Concat((CONST_BV_S1_V0), (Extract (31, 0, ((R2)))))))))) == (CONST_BV_S1_V1)))))))
proverUtils.prove( PK_OF == PS_OF )

PK_R2 = (Concat((CONST_BV_S32_V0), Extract( ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) ).size() - 33, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) )  ) ) )
PS_R2 = (Concat((CONST_BV_S32_V0), (Extract (31, 0, (((Concat((CONST_BV_S1_V0), (Extract (31, 0, ((R2)))))) + (Concat((CONST_BV_S1_V0), (Extract (31, 0, ((R2))))))))))))
proverUtils.prove( PK_R2 == PS_R2 )

PK_SF = (Extract( ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) ).size() - 2, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) )  )  ) == ONE1
PS_SF = ((Extract (31, 31, (((Concat((CONST_BV_S1_V0), (Extract (31, 0, ((R2)))))) + (Concat((CONST_BV_S1_V0), (Extract (31, 0, ((R2)))))))))) == (CONST_BV_S1_V1))
proverUtils.prove( PK_SF == PS_SF )

PK_ZF = ((If ((( Extract( ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) ).size() - 1 - 1, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) ).size() - 33, ( Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) + Concat((CONST_BV_S1_V0), Extract( R2.size() - 32 - 1, R2.size() - 64, R2  ) ) )  )  == (CONST_BV_S32_V0) )  ) , ( (CONST_BV_S1_V1) ) , ( (CONST_BV_S1_V0) ) ))    ) == ONE1
PS_ZF = ((Extract (31, 0, (((Concat((CONST_BV_S1_V0), (Extract (31, 0, ((R2)))))) + (Concat((CONST_BV_S1_V0), (Extract (31, 0, ((R2)))))))))) == (CONST_BV_S32_V0))
