...
print('[6;30;44m' + 'Opcode:vfmadd213ps_xmm_xmm_xmm' + '[0m')
...
PK_R3 = (Concat(Concat(Concat( vfmsub132_single ( (CONST_BV_S32_V0), (CONST_BV_S32_V0), (CONST_BV_S32_V0) ) ,  vfmsub132_single ( (CONST_BV_S32_V0), (CONST_BV_S32_V0), (CONST_BV_S32_V0) ) ), Concat( vfmsub132_single ( (CONST_BV_S32_V0), (CONST_BV_S32_V0), (CONST_BV_S32_V0) ) ,  vfmsub132_single ( (CONST_BV_S32_V0), (CONST_BV_S32_V0), (CONST_BV_S32_V0) ) )), Concat(Concat( vfmsub132_single ( Extract( R2.size() - 128 - 1, R2.size() - 160, R2  ) , vfnmsub132_single ( (CONST_BV_S32_V0), Extract( R1.size() - 128 - 1, R1.size() - 160, R1  ) , Extract( R1.size() - 128 - 1, R1.size() - 160, R1  )  ), Extract( R3.size() - 128 - 1, R3.size() - 160, R3  )  ) ,  vfmsub132_single ( Extract( R2.size() - 160 - 1, R2.size() - 192, R2  ) , vfnmsub132_single ( (CONST_BV_S32_V0), Extract( R1.size() - 160 - 1, R1.size() - 192, R1  ) , Extract( R1.size() - 160 - 1, R1.size() - 192, R1  )  ), Extract( R3.size() - 160 - 1, R3.size() - 192, R3  )  ) ), Concat( vfmsub132_single ( Extract( R2.size() - 192 - 1, R2.size() - 224, R2  ) , vfnmsub132_single ( (CONST_BV_S32_V0), Extract( R1.size() - 192 - 1, R1.size() - 224, R1  ) , Extract( R1.size() - 192 - 1, R1.size() - 224, R1  )  ), Extract( R3.size() - 192 - 1, R3.size() - 224, R3  )  ) ,  vfmsub132_single ( Extract( R2.size() - 224 - 1, R2.size() - 256, R2  ) , vfnmsub132_single ( (CONST_BV_S32_V0), Extract( R1.size() - 224 - 1, R1.size() - 256, R1  ) , Extract( R1.size() - 224 - 1, R1.size() - 256, R1  )  ), Extract( R3.size() - 224 - 1, R3.size() - 256, R3  )  ) ))) )
PS_R3 = (Concat((Concat(((Concat(( vfmsub132_single ( (CONST_BV_S32_V0), (CONST_BV_S32_V0), (CONST_BV_S32_V0))), ( vfmsub132_single ( (CONST_BV_S32_V0), (CONST_BV_S32_V0), (CONST_BV_S32_V0))))) | (CONST_BV_S64_V0)), ((Concat(( vfmsub132_single ( (CONST_BV_S32_V0), (CONST_BV_S32_V0), (CONST_BV_S32_V0))), ( vfmsub132_single ( (CONST_BV_S32_V0), (CONST_BV_S32_V0), (CONST_BV_S32_V0))))) | (CONST_BV_S64_V0)))), (Concat(((Concat(( vfmsub132_single ( (Extract (127, 96, ((R2)))), ( vfnmsub132_single ( (((CONST_BV_S32_V0) ^ (Extract (127, 96, ((R1))))) ^ ((CONST_BV_S32_V0) | ((CONST_BV_S32_V0) ^ (Extract (127, 96, ((R1))))))), (Extract (127, 96, ((R1)))), (Extract (127, 96, ((R1)))))), (Extract (127, 96, ((R3)))))), ( vfmsub132_single ( (Extract (95, 64, ((R2)))), ( vfnmsub132_single ( (((CONST_BV_S32_V0) ^ (Extract (95, 64, ((R1))))) ^ ((CONST_BV_S32_V0) | ((CONST_BV_S32_V0) ^ (Extract (95, 64, ((R1))))))), (Extract (95, 64, ((R1)))), (Extract (95, 64, ((R1)))))), (Extract (95, 64, ((R3)))))))) | (((CONST_BV_S64_V0) ^ (Extract (127, 64, ((R1))))) ^ ((CONST_BV_S64_V0) | ((CONST_BV_S64_V0) ^ (Extract (127, 64, ((R1)))))))), ((Concat(( vfmsub132_single ( (Extract (63, 32, ((R2)))), ( vfnmsub132_single ( (((CONST_BV_S32_V0) ^ (Extract (63, 32, ((R1))))) ^ ((CONST_BV_S32_V0) | ((CONST_BV_S32_V0) ^ (Extract (63, 32, ((R1))))))), (Extract (63, 32, ((R1)))), (Extract (63, 32, ((R1)))))), (Extract (63, 32, ((R3)))))), ( vfmsub132_single ( (Extract (31, 0, ((R2)))), ( vfnmsub132_single ( (((CONST_BV_S32_V0) ^ (Extract (31, 0, ((R1))))) ^ ((CONST_BV_S32_V0) | ((CONST_BV_S32_V0) ^ (Extract (31, 0, ((R1))))))), (Extract (31, 0, ((R1)))), (Extract (31, 0, ((R1)))))), (Extract (31, 0, ((R3)))))))) | (((CONST_BV_S64_V0) ^ (Extract (63, 0, ((R1))))) ^ ((CONST_BV_S64_V0) | ((CONST_BV_S64_V0) ^ (Extract (63, 0, ((R1))))))))))))
