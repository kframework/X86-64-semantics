...
print('[6;30;44m' + 'Opcode:movd_xmm_r32' + '[0m')

R1 = BitVec('R1', 64)
R2 = BitVec('R2', 256)
CONST_BV_S96_V0 = BitVecVal(0, 96)

PK_R2 = (Concat(Extract( R2.size() - 0 - 1, R2.size() - 128, R2  ) , Concat((CONST_BV_S96_V0), Extract( R1.size() - 32 - 1, R1.size() - 64, R1  ) )) )
PS_R2 = (Concat((Extract (255, 128, ((R2)))), (Concat((CONST_BV_S96_V0), (Extract (31, 0, ((R1))))))))
