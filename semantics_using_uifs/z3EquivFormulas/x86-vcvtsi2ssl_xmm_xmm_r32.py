...
print('[6;30;44m' + 'Opcode:vcvtsi2ssl_xmm_xmm_r32' + '[0m')
...
PK_R3 = (Concat((CONST_BV_S128_V0), Concat(Extract( R2.size() - 128 - 1, R2.size() - 224, R2  ) ,  cvt_int32_to_single ( Extract( R1.size() - 32 - 1, R1.size() - 64, R1  )  ) )) )
PS_R3 = (Concat((CONST_BV_S128_V0), (Concat((Extract (127, 32, ((R2)))), ( cvt_int32_to_single ( (Extract (31, 0, ((R1))))))))))
