...
print('[6;30;44m' + 'Opcode:setae_rh' + '[0m')
...
PK_R1 = (Concat(Extract( R1.size() - 0 - 1, R1.size() - 48, R1  ) , Concat(Extract( ( Concat((CONST_BV_S9_V0), Extract( ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) ).size() - 1 - 1, ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) ).size() - 9, ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) )  ) ) + (CONST_BV_S17_V4) ).size() - 1 - 1, ( Concat((CONST_BV_S9_V0), Extract( ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) ).size() - 1 - 1, ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) ).size() - 9, ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) )  ) ) + (CONST_BV_S17_V4) ).size() - 9, ( Concat((CONST_BV_S9_V0), Extract( ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) ).size() - 1 - 1, ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) ).size() - 9, ( (CONST_BV_S9_V255) + Concat((CONST_BV_S8_V0), CF) )  ) ) + (CONST_BV_S17_V4) )  ) , Extract( R1.size() - 56 - 1, R1.size() - 64, R1  ) )) )
PS_R1 = (Concat((Concat((Extract (63, 16, ((R1)))), (If( (cf),(CONST_BV_S8_V0),(CONST_BV_S8_V1))))), (Extract (7, 0, ((R1))))))
