...
print('[6;30;44m' + 'Opcode:vpunpckhdq_xmm_xmm_xmm' + '[0m')
...
PK_R3 = (Concat((CONST_BV_S128_V0), Concat(Concat(Extract( R1.size() - 128 - 1, R1.size() - 160, R1  ) , Extract( R2.size() - 128 - 1, R2.size() - 160, R2  ) ), Concat(Extract( R1.size() - 160 - 1, R1.size() - 192, R1  ) , Extract( R2.size() - 160 - 1, R2.size() - 192, R2  ) ))) )
PS_R3 = (Concat((CONST_BV_S128_V0), (Concat((Concat((Extract (127, 96, ((R1)))), (Extract (127, 96, ((R2)))))), (Concat((Extract (95, 64, ((R1)))), (Extract (95, 64, ((R2))))))))))
