...
block_0x6a:                                       ; preds = %block_0x6a.loopexit, %entry
  ...
  %123 = ptrtoint i64* %122 to i64, !mcsema_real_eip !10
  ...
  store i64 %129, i64* %128, !mcsema_real_eip !14
  ...
  %135 = load i64, i64* %134, !mcsema_real_eip !18
  ...
  store i64 %135, i64* %137, !mcsema_real_eip !19
  %138 = load i64, i64* %RSP_val, !mcsema_real_eip !20
  %139 = add i64 %138, -8
  %140 = inttoptr i64 %139 to i64*, !mcsema_real_eip !20
  store i64 -4981261766360305936, i64* %140, !mcsema_real_eip !20
  ...
  store i64 %147, i64* %RSP, !mcsema_real_eip !20
  %148 = load i64, i64* %RBP_val, !mcsema_real_eip !20
  store i64 %148, i64* %RBP, !mcsema_real_eip !20
  ...
  store i64 %305, i64* %RSP, !mcsema_real_eip !23
  %306 = load i64, i64* %RBP_val, !mcsema_real_eip !23
  store i64 %306, i64* %RBP, !mcsema_real_eip !23
