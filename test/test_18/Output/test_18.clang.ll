...
block_0x35:                                       ; preds = %block_0x1f
  store i64 ptrtoint (%1* @data_0x3d6 to i64), i64* %RDI_val, !mcsema_real_eip !16
...
!7 = metadata !{i64 19, [17 x i8] c"\09cmpq\09$104, %rax\00"}
