...
driverBlockRaw:
  ...
  %15 = bitcast i64* %R15.i to <2 x i64>*
  ...
  %71 = xor i32 %69, %70, !mcsema_real_eip !3
  %72 = trunc i32 %70 to i8, !mcsema_real_eip !3
  %73 = tail call i8 @llvm.ctpop.i8(i8 %72) #0, !mcsema_real_eip !3
  %74 = icmp eq i32 %69, 0
  %75 = and i32 %69, %70, !mcsema_real_eip !3
  br i1 %74, label %sub_1.exit, label %block_0xd.i.preheader, !mcsema_real_eip !4

block_0xd.i.preheader:                            ; preds = %driverBlockRaw
  br label %block_0xd.i

block_0x13.loopexit.i:                            ; preds = %block_0xd.i
  %.lcssa = phi i32 [ %79, %block_0xd.i ]
  %76 = zext i32 %.lcssa to i64, !mcsema_real_eip !5
  br label %sub_1.exit

block_0xd.i:                                      ; preds = %block_0xd.i, %block_0xd.i.preheader
  %77 = phi i32 [ %80, %block_0xd.i ], [ 0, %block_0xd.i.preheader ]
  %78 = phi i32 [ %79, %block_0xd.i ], [ 1, %block_0xd.i.preheader ]
  %79 = shl i32 %78, 1
  %80 = add i32 %77, 1, !mcsema_real_eip !6
  %81 = icmp eq i32 %80, %69
  br i1 %81, label %block_0x13.loopexit.i, label %block_0xd.i, !mcsema_real_eip !4

sub_1.exit:                                       ; preds = %block_0x13.loopexit.i, %driverBlockRaw
  %PF_val.0.in.in.i = phi i8 [ %73, %driverBlockRaw ], [ 0, %block_0x13.loopexit.i ]
  %AF_val.0.in.in.i = phi i32 [ %71, %driverBlockRaw ], [ 0, %block_0x13.loopexit.i ]
  %SF_val.0.in.i = phi i32 [ %70, %driverBlockRaw ], [ 0, %block_0x13.loopexit.i ]
  %OF_val.0.in.i = phi i32 [ %75, %driverBlockRaw ], [ 0, %block_0x13.loopexit.i ]
  %RBX_val.0.i = phi i64 [ 0, %driverBlockRaw ], [ %68, %block_0x13.loopexit.i ]
  %RAX_val.0.i = phi i64 [ 1, %driverBlockRaw ], [ %76, %block_0x13.loopexit.i ]
  ...
  %83 = bitcast i64* %R15.i to <2 x i64>*
  store <2 x i64> %16, <2 x i64>* %83, align 8
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %19, i8* %1, i32 128, i32 8, i1 false) #0, !mcsema_real_eip !7
...
!3 = metadata !{i64 9, [17 x i8] c"\09cmpl\09%ecx, %ebx\00"}
!4 = metadata !{i64 11, [6 x i8] c"\09je\096\00"}
!5 = metadata !{i64 13, [17 x i8] c"\09addl\09%eax, %eax\00"}
!6 = metadata !{i64 15, [11 x i8] c"\09incl\09%ebx\00"}
