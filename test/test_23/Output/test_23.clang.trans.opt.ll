...
driverBlockRaw:
  %_local_stack_alloc_273.i = alloca [144 x i64], align 8
  %STi_val.i = alloca [8 x x86_fp80], align 16, !mcsema_real_eip !2
  %1 = bitcast [144 x i64]* %_local_stack_alloc_273.i to i8*
  call void @llvm.lifetime.start(i64 1152, i8* %1)
  %STi_val.i.0..sroa_cast = bitcast [8 x x86_fp80]* %STi_val.i to i8*
  call void @llvm.lifetime.start(i64 128, i8* %STi_val.i.0..sroa_cast)
  %_local_stack_start_.i = ptrtoint [144 x i64]* %_local_stack_alloc_273.i to i64
...
block_0x1f8.i:                                    ; preds = %block_0x17c.i, %block_0x1a4.i
  %149 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 5), i64 %67), !mcsema_real_eip !51
  ...
  %153 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 45), i64 %67), !mcsema_real_eip !53
...
block_0x256.i:                                    ; preds = %block_0x1f8.i, %block_0x22a.i
  %180 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 56), i64 35), !mcsema_real_eip !61
  ...
  %184 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 66), i64 %67), !mcsema_real_eip !63
...
block_0x317.i:                                    ; preds = %block_0x2fe.i, %block_0x256.i, %block_0x28c.i
  ...
  %RSI_val.3.i = phi i64 [ %199, %block_0x256.i ], [ %222, %block_0x2fe.i ], [ %178, %block_0x28c.i ]
...
block_0x2b8.i:                                    ; preds = %block_0x256.i, %block_0x28c.i
  ...
  %RSI_val.4.i = phi i64 [ %199, %block_0x256.i ], [ %178, %block_0x28c.i ]
...
block_0x30b.i:                                    ; preds = %block_0x2fe.i, %block_0x2c5.i, %block_0x2b8.i
  %RSI_val.5.i = phi i64 [ %222, %block_0x2fe.i ], [ %222, %block_0x2c5.i ], [ %RSI_val.4.i, %block_0x2b8.i ]
...
block_0x34d.i:                                    ; preds = %block_0x323.i, %block_0x30b.i, %block_0x317.i
  ...
  store i64 %RSI_val.6.i, i64* %RSI.i, align 8, !mcsema_real_eip !88
...
block_0x32f.i:                                    ; preds = %block_0x323.i
  %253 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 85), i64 %RSI_val.7.i), !mcsema_real_eip !91
  ...
  store i64 %RSI_val.7.i, i64* %RSI.i, align 8, !mcsema_real_eip !88
...
sub_c0.exit:                                      ; preds = %driverBlockRaw
  %288 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%1* @data_0x3ff to i64), i64 85), i64 %67), !mcsema_real_eip !95
