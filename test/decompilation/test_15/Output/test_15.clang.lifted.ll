...
@g_j = dllexport global %g_j_type <{ [4 x i8] c"\01\00\00\00" }>
...
@4 = internal constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_4004f0_doOp
...
block_400520:
  ...
  store i64 2, i64* %6, align 8, !tbaa !844
  %45 = add i64 %14, -12
  ...
  store i64 %51, i64* %52
  store i64 2, i64* %10, align 8, !tbaa !844
  ...
  %57 = tail call %struct.Memory* @sub_4004f0_doOp(%struct.State* nonnull %state2, i64 %53, %struct.Memory* %memory1)
  ...
  %68 = tail call %struct.Memory* @sub_4004f0_doOp(%struct.State* nonnull %state2, i64 %63, %struct.Memory* %57)
  ...
  store i8 1, i8* %35, align 1, !tbaa !862
  store i8 0, i8* %38, align 1, !tbaa !863
  store i8 0, i8* %44, align 1, !tbaa !864
  store i8 0, i8* %32, align 1, !tbaa !861
  ...
  %79 = tail call %struct.Memory* @sub_4004f0_doOp(%struct.State* nonnull %state2, i64 %74, %struct.Memory* %68)
  %80 = load i64, i64* %0, align 8
  store i64 add (i64 ptrtoint (%seg_400610__rodata_type* @seg_400610__rodata to i64), i64 4), i64* %10, align 8, !tbaa !844
  ...
  store i64 %92, i64* %8, align 8, !tbaa !844
  %93 = inttoptr i64 %82 to i32*
  %94 = load i32, i32* %93
  %95 = zext i32 %94 to i64
  store i64 %95, i64* %7, align 8, !tbaa !844
  store i8 0, i8* %2, align 1, !tbaa !865
  %96 = add i64 %80, -383
  %97 = add i64 %80, 29
  %98 = load i64, i64* %11, align 8, !tbaa !844
  %99 = add i64 %98, -8
  %100 = inttoptr i64 %99 to i64*
  store i64 %97, i64* %100
  store i64 %99, i64* %11, align 8, !tbaa !844
  store i64 %96, i64* %0, align 8, !tbaa !844
  %101 = tail call fastcc %struct.Memory* @ext_601048_printf(%struct.State* nonnull %state2, %struct.Memory* %79) #6
  ...
  store i8 %109, i8* %20, align 1, !tbaa !848
  ...
  %114 = and i8 %113, 1
  %115 = xor i8 %114, 1
  store i8 %115, i8* %27, align 1, !tbaa !860
  %116 = xor i64 %107, %106
  %117 = lshr i64 %116, 4
...
; Function Attrs: noinline nounwind
define internal %struct.Memory* @sub_4004f0_doOp(%struct.State* nocapture dereferenceable(2688) %state2, i64 %pc, %struct.Memory* %memory1) #3 {
block_4004f0:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i32 %12, i32* %13
  %14 = load i32, i32* bitcast (%g_j_type* @g_j to i32*)
  %15 = add i64 %8, -16
  ...
  %19 = load i32, i32* %18
  %20 = load i32, i32* bitcast (%g_j_type* @g_j to i32*)
  %21 = add i32 %20, %19
  %22 = zext i32 %21 to i64
  store i64 %22, i64* %4, align 8, !tbaa !844
  %23 = icmp ult i32 %21, %19
  %24 = icmp ult i32 %21, %20
  %25 = or i1 %23, %24
  %26 = zext i1 %25 to i8
  %27 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 2, i32 1
  store i8 %26, i8* %27, align 1, !tbaa !848
  %28 = and i32 %21, 255
  %29 = tail call i32 @llvm.ctpop.i32(i32 %28) #6
  %30 = trunc i32 %29 to i8
  %31 = and i8 %30, 1
  ...
  %38 = and i8 %37, 1
  %39 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 2, i32 5
  store i8 %38, i8* %39, align 1, !tbaa !861
  %40 = icmp eq i32 %21, 0
  %41 = zext i1 %40 to i8
  %42 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 2, i32 7
  store i8 %41, i8* %42, align 1, !tbaa !862
  %43 = lshr i32 %21, 31
  %44 = trunc i32 %43 to i8
  %45 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 2, i32 9
  ...
  %51 = icmp eq i32 %50, 2
  %52 = zext i1 %51 to i8
  %53 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 2, i32 13
  store i8 %52, i8* %53, align 1, !tbaa !864
  store i32 %21, i32* bitcast (%g_j_type* @g_j to i32*)
  %54 = inttoptr i64 %15 to i32*
  %55 = load i32, i32* %54
  %56 = zext i32 %55 to i64
  store i64 %56, i64* %3, align 8, !tbaa !844
  %57 = inttoptr i64 %9 to i64*
  %58 = load i64, i64* %57
  store i64 %58, i64* %6, align 8, !tbaa !844
  %59 = inttoptr i64 %8 to i64*
  %60 = load i64, i64* %59
  store i64 %60, i64* %0, align 8, !tbaa !844
  %61 = add i64 %8, 8
  store i64 %61, i64* %5, align 8, !tbaa !844
  ret %struct.Memory* %memory1
}
...
; Function Attrs: naked nobuiltin noinline nounwind
define dllexport void @doOp() local_unnamed_addr #5 {
