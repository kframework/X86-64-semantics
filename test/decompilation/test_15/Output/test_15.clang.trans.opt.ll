...
driverBlockRaw:
  ...
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_13.i4 = load i8*, i8** %69, align 8
  ...
  %73 = load i32, i32* bitcast (%0* @data_0x3c to i32*), align 64, !mcsema_real_eip !4
  %74 = bitcast i64* %_RBP_ptr_.sroa.0.i to i8**
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_314.i5 = load i8*, i8** %74, align 8
  ...
  %75 = bitcast i8* %_new_gep_4.i to i32*
  store i32 %73, i32* %75, align 4, !mcsema_real_eip !5
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_615.i6 = load i8*, i8** %74, align 8
  ...
  %76 = bitcast i8* %_new_gep_7.i to i32*
  ...
  %96 = bitcast i8* %_new_gep_10.i to i32*
  %97 = load i32, i32* %96, align 4, !mcsema_real_eip !10
  %98 = zext i32 %97 to i64, !mcsema_real_eip !10
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_1217.i7 = load i8*, i8** %69, align 8
  ...
  %99 = load i64, i64* %_allin_new_bt_13.i, align 8
  ...
  %100 = ptrtoint i8* %_new_gep_14.i to i64
  store volatile i64 %100, i64* %_RSP_ptr_.sroa.0.i, align 8
  store i64 %98, i64* %RAX.i, align 8, !mcsema_real_eip !11
  %101 = bitcast i64* %RBX.i to <2 x i64>*
  store <2 x i64> %4, <2 x i64>* %101, align 8
  %102 = bitcast i64* %RDX.i to <2 x i64>*
  store <2 x i64> %6, <2 x i64>* %102, align 8
  store i64 %78, i64* %RDI.i, align 8, !mcsema_real_eip !11
  store volatile i64 %100, i64* %RSP.i, align 8
  store volatile i64 %99, i64* %RBP.i, align 8
  %103 = bitcast i64* %R8.i to <2 x i64>*
  store <2 x i64> %9, <2 x i64>* %103, align 8
  %104 = bitcast i64* %R10.i to <2 x i64>*
  store <2 x i64> %11, <2 x i64>* %104, align 8
  %105 = bitcast i64* %R12.i to <2 x i64>*
  store <2 x i64> %13, <2 x i64>* %105, align 8
  %106 = bitcast i64* %R14.i to <2 x i64>*
  store <2 x i64> %15, <2 x i64>* %106, align 8
  store i64 %16, i64* %RIP.i, align 8, !mcsema_real_eip !11
  store i1 %95, i1* %CF.i, align 1, !mcsema_real_eip !11
  store i1 %94, i1* %PF.i, align 1, !mcsema_real_eip !11
  store i1 %84, i1* %AF.i, align 1, !mcsema_real_eip !11
  store i1 %86, i1* %ZF.i, align 1, !mcsema_real_eip !11
  store i1 %85, i1* %SF.i, align 1, !mcsema_real_eip !11
  store i1 %90, i1* %OF.i, align 1, !mcsema_real_eip !11
  ...
  store <2 x i64> %68, <2 x i64>* %107, align 1
