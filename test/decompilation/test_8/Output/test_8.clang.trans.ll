...
block_0x1:                                        ; preds = %entry
  ...
  %22 = load i64, i64* %_allin_new_bt_, !mcsema_real_eip !3
  store i64 %22, i64* %XIP, !mcsema_real_eip !3
...
; <label>:22:                                     ; preds = %block_0x1
  %_address_in_parent_stack_bt_ = bitcast i8* %_parent_stack_start_ptr_ to i64*
  br label %23

; <label>:23:                                     ; preds = %block_0x1, %22
  %24 = phi i64* [ %_allin_new_bt_, %block_0x1 ], [ %_address_in_parent_stack_bt_, %22 ]
  %_new_load_ = load i64, i64* %24
  store i64 %_new_load_, i64* %XIP, !mcsema_real_eip !3
  store volatile i8* %_new_gep_, i8** %_RSP_ptr_
  store i64 %21, i64* %XSP, !mcsema_real_eip !3
  ret void, !mcsema_real_eip !3
}
