...
driverBlockRaw:
  ...
  store i8 %70, i8* %1, align 1, !mcsema_real_eip !8
  %71 = bitcast i64* %_RBP_ptr_.sroa.0.i to i8**
  br label %block_0x25.i, !mcsema_real_eip !9

block_0x25.i:                                     ; preds = %block_0x58.i, %driverBlockRaw
  %_RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_226.i = phi i8* [ %_new_gep_.i, %driverBlockRaw ], [ %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_226.pre.i7, %block_0x58.i ]
  %RCX_val.0.i = phi i64 [ %3, %driverBlockRaw ], [ %85, %block_0x58.i ]
  %_new_gep_23.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_226.i, i64 -33
  %72 = load i8, i8* %_new_gep_23.i, align 1, !mcsema_real_eip !9
...
block_0x43.i:                                     ; preds = %block_0x25.i
  %_new_gep_36.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_226.i, i64 -32
  %_allin_new_bt_37.i = bitcast i8* %_new_gep_36.i to i64*
  %73 = load i64, i64* %_allin_new_bt_37.i, align 8, !mcsema_real_eip !10
  br label %block_0x58.i, !mcsema_real_eip !11

block_0x4f.i:                                     ; preds = %block_0x25.i
  %_new_gep_41.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_226.i, i64 -32
  %_allin_new_bt_42.i = bitcast i8* %_new_gep_41.i to i64*
  %74 = load i64, i64* %_allin_new_bt_42.i, align 8, !mcsema_real_eip !12
...
block_0x58.i:                                     ; preds = %block_0x4f.i, %block_0x43.i
  ...
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_437.i4 = load i8*, i8** %71, align 8
  %_new_gep_44.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_437.i4, i64 -24
  %_allin_new_bt_45.i = bitcast i8* %_new_gep_44.i to i64*
  %76 = load i64, i64* %_allin_new_bt_45.i, align 8, !mcsema_real_eip !13
  %77 = add i64 %76, 1
  store i64 %77, i64* %_allin_new_bt_45.i, align 8, !mcsema_real_eip !14
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_498.i5 = load i8*, i8** %71, align 8
  %_new_gep_50.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_498.i5, i64 -32
  %_allin_new_bt_51.i = bitcast i8* %_new_gep_50.i to i64*
  %78 = load i64, i64* %_allin_new_bt_51.i, align 8, !mcsema_real_eip !15
  %79 = add i64 %78, 1
  store i64 %79, i64* %_allin_new_bt_51.i, align 8, !mcsema_real_eip !16
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_559.i6 = load i8*, i8** %71, align 8
  %_new_gep_56.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_559.i6, i64 -24
  %80 = bitcast i8* %_new_gep_56.i to i8**
  %81 = load i8*, i8** %80, align 8
  %82 = load i8, i8* %81, align 1, !mcsema_real_eip !17
  %83 = zext i8 %82 to i64, !mcsema_real_eip !17
  %84 = and i64 %RCX_val.1.i, -256, !mcsema_real_eip !17
  %85 = or i64 %83, %84
  %_new_gep_59.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_559.i6, i64 -33
  store i8 %82, i8* %_new_gep_59.i, align 1, !mcsema_real_eip !18
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_226.pre.i7 = load i8*, i8** %71, align 8
  br label %block_0x25.i, !mcsema_real_eip !19
...
sub_0.exit:                                       ; preds = %block_0x25.i
  ...
  store i64 %4, i64* %RDX.i, align 8, !mcsema_real_eip !20
  store i64 %6, i64* %RSI.i, align 8, !mcsema_real_eip !20
  store i64 %6, i64* %RDI.i, align 8, !mcsema_real_eip !20
  ...
  store i1 true, i1* %PF.i, align 1, !mcsema_real_eip !20
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %18, i8* nonnull %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false) #1, !mcsema_real_eip !20
