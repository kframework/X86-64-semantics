...
block_0x5f:                                       ; preds = %block_0x56, %block_0x48
  %storemerge.in = phi i32 [ %176, %block_0x48 ], [ %192, %block_0x56 ]
  %storemerge = zext i32 %storemerge.in to i64
  store i64 %storemerge, i64* %XAX, align 8
  %.sink1 = add i64 %RBP_val.87, -40
  %207 = inttoptr i64 %.sink1 to i32*
  store i32 %storemerge.in, i32* %207, align 4
  %RBP_val.102 = load i64, i64* %XBP, align 8, !mcsema_real_eip !50
  %208 = add i64 %RBP_val.102, -40, !mcsema_real_eip !50
  %209 = inttoptr i64 %208 to i32*, !mcsema_real_eip !50
  %210 = load i32, i32* %209, align 4, !mcsema_real_eip !50
  %211 = zext i32 %210 to i64, !mcsema_real_eip !50
  store i64 %211, i64* %XAX, align 8, !mcsema_real_eip !50
  %RSP_val.103 = load i64, i64* %XSP, align 8, !mcsema_real_eip !51
  %212 = inttoptr i64 %RSP_val.103 to i64*, !mcsema_real_eip !51
  %213 = load i64, i64* %212, align 8, !mcsema_real_eip !51
  store i64 %213, i64* %XBP, align 8, !mcsema_real_eip !51
  %214 = add i64 %RSP_val.103, 8, !mcsema_real_eip !51
  store i64 %214, i64* %XSP, align 8, !mcsema_real_eip !51
  %215 = add i64 %RSP_val.103, 16, !mcsema_real_eip !52
  %216 = inttoptr i64 %214 to i64*, !mcsema_real_eip !52
  %217 = load i64, i64* %216, align 8, !mcsema_real_eip !52
  store i64 %217, i64* %XIP, align 8, !mcsema_real_eip !52
  store i64 %215, i64* %XSP, align 8, !mcsema_real_eip !52
...
entry:
  ...
  %.v11 = select i1 %_cond1_n_cond2_cond3_277, i8* %_pot_address_in_parent_stack_270, i8* %_new_gep_72
  %58 = bitcast i8* %.v11 to i32*
...
block_0x5f:                                       ; preds = %block_0x56, %block_0x48
  ...
  %.v10 = select i1 %_cond1_n_cond2_cond3_307, i8* %_pot_address_in_parent_stack_300, i8* %_RSP_ptr_.0._RSP_ptr_.0._load_rsp_ptr_80
  %94 = bitcast i8* %.v10 to i64*
