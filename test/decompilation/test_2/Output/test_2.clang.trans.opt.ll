...
driverBlockRaw:
  ...
  %_local_stack_start_ptr_86.i = alloca [48 x i8], align 1
  ...
  %1 = getelementptr inbounds [48 x i8], [48 x i8]* %_local_stack_start_ptr_86.i, i64 0, i64 0
  call void @llvm.lifetime.start(i64 48, i8* nonnull %1)
  %STi_val.i.0..sroa_cast = bitcast [8 x x86_fp80]* %STi_val.i to i8*
  call void @llvm.lifetime.start(i64 128, i8* nonnull %STi_val.i.0..sroa_cast)
  %_local_stack_end_ptr_.i = getelementptr inbounds [48 x i8], [48 x i8]* %_local_stack_start_ptr_86.i, i64 0, i64 48
  ...
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_87.i = load i64, i64* %_RBP_ptr_.sroa.0.i, align 8
  %62 = bitcast i64* %_RSP_ptr_.sroa.0.i to i8**
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_95.i1 = load i8*, i8** %62, align 8
  %_new_gep_.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_95.i1, i64 -8
  %_allin_new_bt_.i = bitcast i8* %_new_gep_.i to i64*
  store volatile i64 %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_87.i, i64* %_allin_new_bt_.i, align 8
  %63 = ptrtoint i8* %_new_gep_.i to i64
  store volatile i64 %63, i64* %_RBP_ptr_.sroa.0.i, align 8
  %_new_gep_1.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_95.i1, i64 -40
  ...
  %66 = tail call i8 @llvm.ctpop.i8(i8 %_trans_trunc_.i) #3, !mcsema_real_eip !3
  %67 = and i8 %66, 1
  %68 = icmp eq i8 %67, 0
  ...
  %_new_gep_11.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_95.i1, i64 -12
  %70 = bitcast i8* %_new_gep_11.i to i32*
  store i32 0, i32* %70, align 4, !mcsema_real_eip !4
  %71 = bitcast i64* %_RSP_ptr_.sroa.0.i to i32**
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_13888997.i2 = load i32*, i32** %71, align 8
  store i32 70, i32* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_13888997.i2, align 4, !mcsema_real_eip !5
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_1598.i3 = load i8*, i8** %62, align 8
  %_new_gep_16.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_1598.i3, i64 8
  %72 = bitcast i8* %_new_gep_16.i to i32*
  store i32 80, i32* %72, align 4, !mcsema_real_eip !6
  %73 = bitcast i64* %_RBP_ptr_.sroa.0.i to i8**
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1899.i4 = load i8*, i8** %73, align 8
  %_new_gep_19.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1899.i4, i64 -12
  %74 = bitcast i8* %_new_gep_19.i to i32*
  store i32 80, i32* %74, align 4, !mcsema_real_eip !7
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_21100.i5 = load i8*, i8** %73, align 8
  %_new_gep_22.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_21100.i5, i64 -16
  %75 = bitcast i8* %_new_gep_22.i to i32*
  store i32 70, i32* %75, align 4, !mcsema_real_eip !8
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_24101.i6 = load i8*, i8** %62, align 8
  %_new_gep_25.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_24101.i6, i64 -8
  ...
  %76 = ptrtoint i8* %_new_gep_25.i to i64
  ...
  store <2 x i64> <i64 40, i64 30>, <2 x i64>* %77, align 8
  %78 = bitcast i64* %RSI.i to <2 x i64>*
  store <2 x i64> <i64 20, i64 10>, <2 x i64>* %78, align 8
  store volatile i64 %76, i64* %RSP.i, align 8
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_2991.i = load i64, i64* %_RBP_ptr_.sroa.0.i, align 8
  store volatile i64 %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_2991.i, i64* %RBP.i, align 8
  %79 = bitcast i64* %R8.i to <2 x i64>*
  store <2 x i64> <i64 50, i64 60>, <2 x i64>* %79, align 8
  store i64 80, i64* %R10.i, align 8, !mcsema_real_eip !9
  %80 = bitcast i64* %R11.i to <2 x i64>*
  store <2 x i64> %5, <2 x i64>* %80, align 8
  %81 = bitcast i64* %R13.i to <2 x i64>*
  store <2 x i64> %7, <2 x i64>* %81, align 8
  %82 = bitcast i64* %R15.i to <2 x i64>*
  store <2 x i64> %9, <2 x i64>* %82, align 8
  store i1 %_trans_icmp_ne_7.i, i1* %CF.i, align 1, !mcsema_real_eip !9
  store i1 %68, i1* %PF.i, align 1, !mcsema_real_eip !9
  store i1 %65, i1* %AF.i, align 1, !mcsema_real_eip !9
  store i1 %_trans_icmp_eq_.i, i1* %ZF.i, align 1, !mcsema_real_eip !9
  store i1 %_trans_icmp_ne_.i, i1* %SF.i, align 1, !mcsema_real_eip !9
  store i1 %69, i1* %OF.i, align 1, !mcsema_real_eip !9
  ...
  store i11 %43, i11* %FPU_FOPCODE.i, align 1, !mcsema_real_eip !9
