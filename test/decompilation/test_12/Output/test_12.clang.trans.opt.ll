...
driverBlockRaw:
  ...
  %_local_stack_start_ptr_17.i = alloca [40 x i8], align 1
  ...
  %1 = getelementptr inbounds [40 x i8], [40 x i8]* %_local_stack_start_ptr_17.i, i64 0, i64 0
  call void @llvm.lifetime.start(i64 40, i8* nonnull %1)
  %STi_val.i.0..sroa_cast = bitcast [8 x x86_fp80]* %STi_val.i to i8*
  call void @llvm.lifetime.start(i64 128, i8* nonnull %STi_val.i.0..sroa_cast)
  %_local_stack_end_ptr_.i = getelementptr inbounds [40 x i8], [40 x i8]* %_local_stack_start_ptr_17.i, i64 0, i64 40
  ...
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_22.i4 = load i8*, i8** %68, align 8
  ...
  %_new_gep_1.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_22.i4, i64 -40
  %70 = ptrtoint i8* %_new_gep_1.i to i64
  store volatile i64 %70, i64* %_RSP_ptr_.sroa.0.i, align 8
  %_new_gep_11.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_22.i4, i64 -24
  ...
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1323.i5 = load i8*, i8** %71, align 8
  %_new_gep_14.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1323.i5, i64 -16
  %_allin_new_bt_15.i = bitcast i8* %_new_gep_14.i to i64*
  %72 = load i64, i64* %_allin_new_bt_15.i, align 8, !mcsema_real_eip !4
  %73 = tail call x86_64_sysvcc i64 @open(i64 %72, i64 0), !mcsema_real_eip !5
  %_new_gep_17.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1323.i5, i64 -20
  %74 = trunc i64 %73 to i32, !mcsema_real_eip !6
  %75 = bitcast i8* %_new_gep_17.i to i32*
  store i32 %74, i32* %75, align 4, !mcsema_real_eip !6
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1924.i6 = load i8*, i8** %71, align 8
  %_new_gep_20.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1924.i6, i64 -20
  %76 = bitcast i8* %_new_gep_20.i to i32*
  %77 = load i32, i32* %76, align 4, !mcsema_real_eip !7
  %78 = icmp eq i32 %77, -1
  br i1 %78, label %block_0x53.i, label %block_0x3c.i, !mcsema_real_eip !8

block_0x3c.i:                                     ; preds = %driverBlockRaw
  %79 = zext i32 %77 to i64, !mcsema_real_eip !9
  %80 = tail call x86_64_sysvcc i64 @close(i64 %79), !mcsema_real_eip !10
  %_new_gep_26.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1924.i6, i64 -4
  %81 = bitcast i8* %_new_gep_26.i to i32*
  store i32 0, i32* %81, align 4, !mcsema_real_eip !11
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_2826.i7 = load i8*, i8** %71, align 8
  %_new_gep_29.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_2826.i7, i64 -24
  %82 = trunc i64 %80 to i32, !mcsema_real_eip !12
  br label %sub_10.exit, !mcsema_real_eip !13

block_0x53.i:                                     ; preds = %driverBlockRaw
  %_new_gep_31.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1924.i6, i64 -4
  br label %sub_10.exit, !mcsema_real_eip !9

sub_10.exit:                                      ; preds = %block_0x3c.i, %block_0x53.i
  %RDI_val.0.i = phi i64 [ %72, %block_0x53.i ], [ %79, %block_0x3c.i ]
  %_allin_new_bt_32.sink.in.i = phi i8* [ %_new_gep_31.i, %block_0x53.i ], [ %_new_gep_29.i, %block_0x3c.i ]
  %.sink.i = phi i32 [ -1, %block_0x53.i ], [ %82, %block_0x3c.i ]
  %83 = bitcast i8* %_allin_new_bt_32.sink.in.i to i32*
  store i32 %.sink.i, i32* %83, align 4
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_3327.i8 = load i8*, i8** %71, align 8
  %_new_gep_34.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_3327.i8, i64 -4
  %84 = bitcast i8* %_new_gep_34.i to i32*
  %85 = load i32, i32* %84, align 4, !mcsema_real_eip !14
  %86 = zext i32 %85 to i64, !mcsema_real_eip !14
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_3619.i = load i64, i64* %_RSP_ptr_.sroa.0.i, align 8
  %uadd.i = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_3619.i, i64 32)
  %87 = extractvalue { i64, i1 } %uadd.i, 0
  %88 = xor i64 %87, %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_3619.i, !mcsema_real_eip !15
  %89 = and i64 %88, 16, !mcsema_real_eip !15
  %90 = icmp ne i64 %89, 0, !mcsema_real_eip !15
  %91 = icmp slt i64 %87, 0
  %92 = icmp eq i64 %87, 0, !mcsema_real_eip !15
  %93 = xor i64 %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_3619.i, -9223372036854775808, !mcsema_real_eip !15
  %94 = and i64 %88, %93, !mcsema_real_eip !15
  %95 = icmp slt i64 %94, 0
  %96 = trunc i64 %87 to i8, !mcsema_real_eip !15
  %97 = tail call i8 @llvm.ctpop.i8(i8 %96), !mcsema_real_eip !15
  %98 = and i8 %97, 1
  %99 = icmp eq i8 %98, 0
  %100 = extractvalue { i64, i1 } %uadd.i, 1
  store volatile i64 %87, i64* %_RSP_ptr_.sroa.0.i, align 8
  %101 = inttoptr i64 %87 to i64*, !mcsema_real_eip !16
  %102 = load i64, i64* %101, align 8
  store volatile i64 %102, i64* %_RBP_ptr_.sroa.0.i, align 8
  %103 = add i64 %87, 16
  store volatile i64 %103, i64* %_RSP_ptr_.sroa.0.i, align 8
  store i64 %86, i64* %RAX.i, align 8, !mcsema_real_eip !17
  %104 = bitcast i64* %RBX.i to <2 x i64>*
  store <2 x i64> %4, <2 x i64>* %104, align 8
  store i64 %5, i64* %RDX.i, align 8, !mcsema_real_eip !17
  store i64 0, i64* %RSI.i, align 8, !mcsema_real_eip !17
  store i64 %RDI_val.0.i, i64* %RDI.i, align 8, !mcsema_real_eip !17
  ...
  store i1 %100, i1* %CF.i, align 1, !mcsema_real_eip !17
  store i1 %99, i1* %PF.i, align 1, !mcsema_real_eip !17
  store i1 %90, i1* %AF.i, align 1, !mcsema_real_eip !17
  store i1 %92, i1* %ZF.i, align 1, !mcsema_real_eip !17
  store i1 %91, i1* %SF.i, align 1, !mcsema_real_eip !17
  store i1 %95, i1* %OF.i, align 1, !mcsema_real_eip !17
  store i1 %16, i1* %DF.i, align 1, !mcsema_real_eip !17
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %18, i8* nonnull %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false), !mcsema_real_eip !17
