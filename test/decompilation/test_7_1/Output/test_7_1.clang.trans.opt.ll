...
driverBlockRaw:
  ...
  %_local_stack_start_ptr_91.i = alloca [96 x i8], align 1
  ...
  %1 = getelementptr inbounds [96 x i8], [96 x i8]* %_local_stack_start_ptr_91.i, i64 0, i64 0
  call void @llvm.lifetime.start(i64 96, i8* nonnull %1)
  %STi_val.i.0..sroa_cast = bitcast [8 x x86_fp80]* %STi_val.i to i8*
  call void @llvm.lifetime.start(i64 128, i8* nonnull %STi_val.i.0..sroa_cast)
  %_local_stack_end_ptr_.i = getelementptr inbounds [96 x i8], [96 x i8]* %_local_stack_start_ptr_91.i, i64 0, i64 96
  ...
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_92.i = load i64, i64* %_RBP_ptr_.sroa.0.i, align 8
  %62 = bitcast i64* %_RSP_ptr_.sroa.0.i to i8**
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_99.i1 = load i8*, i8** %62, align 8
  %_new_gep_.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_99.i1, i64 -8
  %_allin_new_bt_.i = bitcast i8* %_new_gep_.i to i64*
  store volatile i64 %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_92.i, i64* %_allin_new_bt_.i, align 8
  %63 = ptrtoint i8* %_new_gep_.i to i64
  store volatile i64 %63, i64* %_RBP_ptr_.sroa.0.i, align 8
  %_new_gep_1.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_99.i1, i64 -88
  %64 = ptrtoint i8* %_new_gep_1.i to i64
  store volatile i64 %64, i64* %_RSP_ptr_.sroa.0.i, align 8
  %_new_gep_11.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_99.i1, i64 -12
  %65 = bitcast i8* %_new_gep_11.i to i32*
  store i32 0, i32* %65, align 4, !mcsema_real_eip !3
  %66 = bitcast i64* %_RBP_ptr_.sroa.0.i to i8**
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_13100.i2 = load i8*, i8** %66, align 8
  %_new_gep_14.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_13100.i2, i64 -52
  %67 = bitcast i8* %_new_gep_14.i to i32*
  store i32 0, i32* %67, align 4
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_16101110.i3 = load i8*, i8** %66, align 8
  %_new_gep_17111.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_16101110.i3, i64 -52
  %68 = bitcast i8* %_new_gep_17111.i to i32*
  %69 = load i32, i32* %68, align 4, !mcsema_real_eip !4
  %70 = add i32 %69, -10
  %71 = xor i32 %70, %69, !mcsema_real_eip !4
  %72 = icmp slt i32 %70, 0
  %73 = and i32 %71, %69, !mcsema_real_eip !4
  %74 = icmp slt i32 %73, 0
  %tmp112.i = xor i1 %72, %74
  br i1 %tmp112.i, label %block_0x53.i.preheader, label %block_0x6f.i, !mcsema_real_eip !5

block_0x53.i.preheader:                           ; preds = %driverBlockRaw
  br label %block_0x53.i

block_0x53.i:                                     ; preds = %block_0x53.i.preheader, %block_0x53.i
  %75 = phi i32 [ %83, %block_0x53.i ], [ %69, %block_0x53.i.preheader ]
  %_RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_16101113.i = phi i8* [ %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_16101.i8, %block_0x53.i ], [ %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_16101110.i3, %block_0x53.i.preheader ]
  %76 = sext i32 %75 to i64, !mcsema_real_eip !6
  %_new_gep_23.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_16101113.i, i64 -48
  %77 = shl nsw i64 %76, 2
  %_new_gep_24.i = getelementptr i8, i8* %_new_gep_23.i, i64 %77
  %78 = bitcast i8* %_new_gep_24.i to i32*
  store i32 21, i32* %78, align 4, !mcsema_real_eip !7
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_26105.i7 = load i8*, i8** %66, align 8
  %_new_gep_27.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_26105.i7, i64 -52
  %79 = bitcast i8* %_new_gep_27.i to i32*
  %80 = load i32, i32* %79, align 4, !mcsema_real_eip !8
  %81 = add i32 %80, 1
  store i32 %81, i32* %79, align 4
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_16101.i8 = load i8*, i8** %66, align 8
  %_new_gep_17.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_16101.i8, i64 -52
  %82 = bitcast i8* %_new_gep_17.i to i32*
  %83 = load i32, i32* %82, align 4, !mcsema_real_eip !4
  %84 = add i32 %83, -10
  %85 = xor i32 %84, %83, !mcsema_real_eip !4
  %86 = icmp slt i32 %84, 0
  %87 = and i32 %85, %83, !mcsema_real_eip !4
  %88 = icmp slt i32 %87, 0
  %tmp.i = xor i1 %86, %88
  br i1 %tmp.i, label %block_0x53.i, label %block_0x6f.i.loopexit, !mcsema_real_eip !5

block_0x6f.i.loopexit:                            ; preds = %block_0x53.i
  br label %block_0x6f.i

block_0x6f.i:                                     ; preds = %block_0x6f.i.loopexit, %driverBlockRaw
  %_RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_16101.lcssa.i = phi i8* [ %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_16101110.i3, %driverBlockRaw ], [ %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_16101.i8, %block_0x6f.i.loopexit ]
  %.lcssa109.i = phi i32 [ %69, %driverBlockRaw ], [ %83, %block_0x6f.i.loopexit ]
  %.lcssa108.i = phi i32 [ %70, %driverBlockRaw ], [ %84, %block_0x6f.i.loopexit ]
  %.lcssa107.i = phi i32 [ %71, %driverBlockRaw ], [ %85, %block_0x6f.i.loopexit ]
  %.lcssa106.i = phi i1 [ %72, %driverBlockRaw ], [ %86, %block_0x6f.i.loopexit ]
  %.lcssa.i = phi i1 [ %74, %driverBlockRaw ], [ %88, %block_0x6f.i.loopexit ]
  %89 = icmp ult i32 %.lcssa109.i, 10, !mcsema_real_eip !4
  %90 = icmp eq i32 %.lcssa108.i, 0, !mcsema_real_eip !4
  %91 = trunc i32 %.lcssa108.i to i8, !mcsema_real_eip !4
  %92 = tail call i8 @llvm.ctpop.i8(i8 %91) #3, !mcsema_real_eip !4
  %93 = and i8 %92, 1
  %94 = icmp eq i8 %93, 0
  %95 = and i32 %.lcssa107.i, 16, !mcsema_real_eip !4
  %96 = icmp ne i32 %95, 0, !mcsema_real_eip !4
  %_new_gep_33.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_16101.lcssa.i, i64 -48
  %97 = ptrtoint i8* %_new_gep_33.i to i64
  %_new_gep_36.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_16101.lcssa.i, i64 -64
  %_allin_new_bt_37.i = bitcast i8* %_new_gep_36.i to i64*
  store i64 %97, i64* %_allin_new_bt_37.i, align 8, !mcsema_real_eip !9
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_38102.i4 = load i8*, i8** %66, align 8
  %_new_gep_39.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_38102.i4, i64 -64
  %_allin_new_bt_40.i = bitcast i8* %_new_gep_39.i to i64*
  %98 = load i64, i64* %_allin_new_bt_40.i, align 8, !mcsema_real_eip !10
  %99 = bitcast i64* %_RSP_ptr_.sroa.0.i to i64**
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_4193103.i5 = load i64*, i64** %99, align 8
  store i64 %98, i64* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_4193103.i5, align 8, !mcsema_real_eip !11
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_43104.i6 = load i8*, i8** %62, align 8
  %_new_gep_44.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_43104.i6, i64 -8
  ...
  %100 = ptrtoint i8* %_new_gep_44.i to i64
  store volatile i64 %100, i64* %_RSP_ptr_.sroa.0.i, align 8
  store i64 10, i64* %RAX.i, align 8, !mcsema_real_eip !12
  store i64 %3, i64* %RBX.i, align 8, !mcsema_real_eip !12
  %101 = bitcast i64* %RCX.i to <2 x i64>*
  store <2 x i64> <i64 10, i64 10>, <2 x i64>* %101, align 8
  %102 = bitcast i64* %RSI.i to <2 x i64>*
  store <2 x i64> <i64 10, i64 10>, <2 x i64>* %102, align 8
  store volatile i64 %100, i64* %RSP.i, align 8
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_4895.i = load i64, i64* %_RBP_ptr_.sroa.0.i, align 8
  store volatile i64 %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_4895.i, i64* %RBP.i, align 8
  %103 = bitcast i64* %R8.i to <2 x i64>*
  store <2 x i64> <i64 10, i64 10>, <2 x i64>* %103, align 8
  store i64 %98, i64* %R10.i, align 8, !mcsema_real_eip !12
  %104 = bitcast i64* %R11.i to <2 x i64>*
  store <2 x i64> %5, <2 x i64>* %104, align 8
  %105 = bitcast i64* %R13.i to <2 x i64>*
  store <2 x i64> %7, <2 x i64>* %105, align 8
  %106 = bitcast i64* %R15.i to <2 x i64>*
  store <2 x i64> %9, <2 x i64>* %106, align 8
  store i1 %89, i1* %CF.i, align 1, !mcsema_real_eip !12
  store i1 %94, i1* %PF.i, align 1, !mcsema_real_eip !12
  store i1 %96, i1* %AF.i, align 1, !mcsema_real_eip !12
  store i1 %90, i1* %ZF.i, align 1, !mcsema_real_eip !12
  store i1 %.lcssa106.i, i1* %SF.i, align 1, !mcsema_real_eip !12
  store i1 %.lcssa.i, i1* %OF.i, align 1, !mcsema_real_eip !12
  ...
  %107 = bitcast i64* %STACK_BASE.i to <2 x i64>*
  store <2 x i64> %61, <2 x i64>* %107, align 1
