...
block_0x10:                                       ; preds = %entry
  ...
  store i32 2, i32* %15, !mcsema_real_eip !5
  ...
  %16 = sub i64 %RSP_val.5, 8, !mcsema_real_eip !6
  %_allin_new_bt_18 = bitcast i8* %_new_gep_17 to i64*
  store i64 -4981261766360305936, i64* %_allin_new_bt_18, !mcsema_real_eip !6
  store volatile i8* %_new_gep_17, i8** %_RSP_ptr_
  store i64 %16, i64* %XSP, !mcsema_real_eip !6
  %_load_rbp_ptr_44 = load i8*, i8** %_RBP_ptr_
  call x86_64_sysvcc void @checkFn.2(%RegState* %0, i8* %_new_gep_17, i8* %_local_stack_end_ptr_, i8* %_load_rbp_ptr_44)
  ...
  %17 = ptrtoint i64* %_allin_new_bt_21 to i64, !mcsema_real_eip !7
  %18 = inttoptr i64 %17 to i32*, !mcsema_real_eip !7
  %19 = load i32, i32* %18, !mcsema_real_eip !7
  %20 = zext i32 %19 to i64, !mcsema_real_eip !7
  store i64 %20, i64* %XAX, !mcsema_real_eip !7
  %RSP_val.7 = load i64, i64* %XSP, !mcsema_real_eip !8
  %_new_gep_23 = getelementptr i8, i8* %_gep_fix_, i64 16
  %21 = add i64 16, %RSP_val.7, !mcsema_real_eip !8
  ...
  %22 = xor i64 %_trans_xor_26, 16, !mcsema_real_eip !8
  %23 = and i64 %22, 16, !mcsema_real_eip !8
  %24 = icmp ne i64 %23, 0, !mcsema_real_eip !8
  store i1 %24, i1* %AF, !mcsema_real_eip !8
  %25 = lshr i64 %21, 63, !mcsema_real_eip !8
  %26 = trunc i64 %25 to i1, !mcsema_real_eip !8
  store i1 %26, i1* %SF, !mcsema_real_eip !8
  %_trans_icmp_eq_28 = icmp eq i64 %_trans_p2i_24, 0
  store i1 %_trans_icmp_eq_28, i1* %ZF, !mcsema_real_eip !8
  %_trans_xor_30 = xor i64 %_trans_p2i_25, 16
  %27 = xor i64 %_trans_xor_30, -1, !mcsema_real_eip !8
  %28 = and i64 %27, %_trans_xor_26, !mcsema_real_eip !8
  %29 = lshr i64 %28, 63, !mcsema_real_eip !8
  %30 = and i64 %29, 1, !mcsema_real_eip !8
  %31 = trunc i64 %30 to i1, !mcsema_real_eip !8
  store i1 %31, i1* %OF, !mcsema_real_eip !8
  %_trans_trunc_35 = trunc i64 %_trans_p2i_24 to i8
  %32 = call i8 @llvm.ctpop.i8(i8 %_trans_trunc_35), !mcsema_real_eip !8
  ...
  store i1 %_trans_icmp_ne_37, i1* %CF, !mcsema_real_eip !8
  store volatile i8* %_new_gep_23, i8** %_RSP_ptr_
  store i64 %21, i64* %XSP, !mcsema_real_eip !8
  %_allin_new_bt_39 = bitcast i8* %_new_gep_23 to i64*
  %35 = load i64, i64* %_allin_new_bt_39, !mcsema_real_eip !9
  %_new_int2ptr_ = inttoptr i64 %35 to i8*
  store volatile i8* %_new_int2ptr_, i8** %_RBP_ptr_
  store i64 %35, i64* %XBP, !mcsema_real_eip !9
  %_new_gep_40 = getelementptr i8, i8* %_new_gep_23, i64 8
  %36 = add i64 %21, 8, !mcsema_real_eip !9
  ...
  %37 = add i64 %36, 8, !mcsema_real_eip !10
  %_allin_new_bt_43 = bitcast i8* %_new_gep_40 to i64*
  %38 = load i64, i64* %_allin_new_bt_43, !mcsema_real_eip !10
  store i64 %38, i64* %XIP, !mcsema_real_eip !10
...
; <label>:20:                                     ; preds = %block_0x10, %19
  ...
  %22 = zext i32 %_new_load_ to i64, !mcsema_real_eip !7
  store i64 %22, i64* %XAX, !mcsema_real_eip !7
  %RSP_val.7 = load i64, i64* %XSP, !mcsema_real_eip !8
  %_new_gep_23 = getelementptr i8, i8* %_gep_fix_, i64 16
  %23 = add i64 16, %RSP_val.7, !mcsema_real_eip !8
  %_trans_p2i_24 = ptrtoint i8* %_new_gep_23 to i64
  %_trans_p2i_25 = ptrtoint i8* %_gep_fix_ to i64
  %_trans_xor_26 = xor i64 %_trans_p2i_24, %_trans_p2i_25
  %24 = xor i64 %_trans_xor_26, 16, !mcsema_real_eip !8
  %25 = and i64 %24, 16, !mcsema_real_eip !8
  %26 = icmp ne i64 %25, 0, !mcsema_real_eip !8
  store i1 %26, i1* %AF, !mcsema_real_eip !8
  %27 = lshr i64 %23, 63, !mcsema_real_eip !8
  %28 = trunc i64 %27 to i1, !mcsema_real_eip !8
  store i1 %28, i1* %SF, !mcsema_real_eip !8
  %_trans_icmp_eq_28 = icmp eq i64 %_trans_p2i_24, 0
  store i1 %_trans_icmp_eq_28, i1* %ZF, !mcsema_real_eip !8
  %_trans_xor_30 = xor i64 %_trans_p2i_25, 16
  %29 = xor i64 %_trans_xor_30, -1, !mcsema_real_eip !8
  %30 = and i64 %29, %_trans_xor_26, !mcsema_real_eip !8
  %31 = lshr i64 %30, 63, !mcsema_real_eip !8
  %32 = and i64 %31, 1, !mcsema_real_eip !8
  %33 = trunc i64 %32 to i1, !mcsema_real_eip !8
  store i1 %33, i1* %OF, !mcsema_real_eip !8
  %_trans_trunc_35 = trunc i64 %_trans_p2i_24 to i8
  %34 = call i8 @llvm.ctpop.i8(i8 %_trans_trunc_35), !mcsema_real_eip !8
...
; <label>:38:                                     ; preds = %20, %37
  ...
  store volatile i8* %_new_int2ptr_, i8** %_RBP_ptr_
  store i64 %_new_load_60, i64* %XBP, !mcsema_real_eip !9
  %_new_gep_40 = getelementptr i8, i8* %_new_gep_23, i64 8
  %40 = add i64 %23, 8, !mcsema_real_eip !9
  store volatile i8* %_new_gep_40, i8** %_RSP_ptr_
  store i64 %40, i64* %XSP, !mcsema_real_eip !9
  %_new_gep_42 = getelementptr i8, i8* %_new_gep_40, i64 8
  %41 = add i64 %40, 8, !mcsema_real_eip !10
  %_allin_new_bt_43 = bitcast i8* %_new_gep_40 to i64*
...
; <label>:43:                                     ; preds = %38, %42
  ...
  store i64 %_new_load_75, i64* %XIP, !mcsema_real_eip !10
  store volatile i8* %_new_gep_42, i8** %_RSP_ptr_
  store i64 %41, i64* %XSP, !mcsema_real_eip !10
  ret void, !mcsema_real_eip !10
}

; Function Attrs: noinline
define internal x86_64_sysvcc void @checkFn.2(%RegState*, i8* %_parent_stack_start_ptr_, i8* %_parent_stack_end_ptr_, i8* %_parent_stack_rbp_ptr_) #1 {
entry:
  %_RSP_ptr_ = alloca i8*
  %_RBP_ptr_ = alloca i8*
...
; <label>:3:                                      ; preds = %block_0x0, %2
  ...
  store volatile i8* %_new_int2ptr_, i8** %_RBP_ptr_
  store i64 %_new_load_, i64* %XBP, !mcsema_real_eip !13
  ...
  %6 = add i64 %5, 8, !mcsema_real_eip !14
...
; <label>:8:                                      ; preds = %3, %7
  ...
  store i64 %_new_load_22, i64* %XIP, !mcsema_real_eip !14
