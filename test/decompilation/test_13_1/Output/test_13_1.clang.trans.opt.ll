...
driverBlockRaw:
  ...
  %_local_stack_start_ptr_80.i = alloca [32 x i8], align 1
  ...
  %1 = getelementptr inbounds [32 x i8], [32 x i8]* %_local_stack_start_ptr_80.i, i64 0, i64 0
  call void @llvm.lifetime.start(i64 32, i8* nonnull %1)
  %STi_val.i.0..sroa_cast = bitcast [8 x x86_fp80]* %STi_val.i to i8*
  call void @llvm.lifetime.start(i64 128, i8* nonnull %STi_val.i.0..sroa_cast)
  %_local_stack_end_ptr_.i = getelementptr inbounds [32 x i8], [32 x i8]* %_local_stack_start_ptr_80.i, i64 0, i64 32
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull %STi_val.i.0..sroa_cast, i8* %20, i32 128, i32 4, i1 false) #2, !mcsema_real_eip !2
  ...
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_87.i4 = load i8*, i8** %69, align 8
  %_new_gep_.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_87.i4, i64 -8
  ...
  %_new_gep_1.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_87.i4, i64 -24
  %71 = ptrtoint i8* %_new_gep_1.i to i64
  store volatile i64 %71, i64* %_RSP_ptr_.sroa.0.i, align 8
  %_new_gep_3.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_87.i4, i64 -12
  %72 = bitcast i8* %_new_gep_3.i to i32*
  store i32 0, i32* %72, align 4, !mcsema_real_eip !3
  %73 = bitcast i64* %_RBP_ptr_.sroa.0.i to i8**
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_588.i5 = load i8*, i8** %73, align 8
  %_new_gep_6.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_588.i5, i64 -4
  %74 = bitcast i8* %_new_gep_6.i to i32*
  %75 = load i32, i32* %74, align 4, !mcsema_real_eip !4
  %76 = add i32 %75, -2
  %77 = xor i32 %76, %75, !mcsema_real_eip !4
  %78 = icmp slt i32 %76, 0
  %79 = and i32 %77, %75, !mcsema_real_eip !4
  %80 = icmp slt i32 %79, 0
  %tmp.i = xor i1 %78, %80
  br i1 %tmp.i, label %block_0x29.i, label %sub_10.exit, !mcsema_real_eip !5

block_0x29.i:                                     ; preds = %driverBlockRaw
  %81 = trunc i32 %76 to i8, !mcsema_real_eip !4
  %82 = tail call i8 @llvm.ctpop.i8(i8 %81) #2, !mcsema_real_eip !4
  %PF_val.0.in.i = and i8 %82, 1
  %AF_val.0.in.i = and i32 %77, 16
  %ZF_val.0.i = icmp eq i32 %76, 0
  %PF_val.0.i = icmp eq i8 %PF_val.0.in.i, 0
  %AF_val.0.i = icmp ne i32 %AF_val.0.in.i, 0
  %CF_val.0.i = icmp ult i32 %75, 2
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_1689.i6 = load i8*, i8** %69, align 8
  %_new_gep_17.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_1689.i6, i64 -8
  %_allin_new_bt_18.i = bitcast i8* %_new_gep_17.i to i64*
  store i64 -4981261766360305936, i64* %_allin_new_bt_18.i, align 8, !mcsema_real_eip !6
  %83 = ptrtoint i8* %_new_gep_17.i to i64
  store volatile i64 %83, i64* %_RSP_ptr_.sroa.0.i, align 8
  store i64 %3, i64* %RAX.i, align 8, !mcsema_real_eip !6
  store i64 %4, i64* %RBX.i, align 8, !mcsema_real_eip !6
  store i64 %5, i64* %RCX.i, align 8, !mcsema_real_eip !6
  store i64 %6, i64* %RDX.i, align 8, !mcsema_real_eip !6
  store i64 %7, i64* %RSI.i, align 8, !mcsema_real_eip !6
  store i64 %8, i64* %RDI.i, align 8, !mcsema_real_eip !6
  store volatile i64 %83, i64* %RSP.i, align 8
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_2186.i = load i64, i64* %_RBP_ptr_.sroa.0.i, align 8
  store volatile i64 %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_2186.i, i64* %RBP.i, align 8
  ...
  store i1 %80, i1* %OF.i, align 1, !mcsema_real_eip !6
  store i1 %18, i1* %DF.i, align 1, !mcsema_real_eip !6
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %20, i8* nonnull %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false) #2, !mcsema_real_eip !6
...
sub_10.exit:                                      ; preds = %driverBlockRaw
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_882.i = load i64, i64* %_RSP_ptr_.sroa.0.i, align 8
  %uadd210.i = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_882.i, i64 16) #2
  %84 = extractvalue { i64, i1 } %uadd210.i, 0
  %85 = xor i64 %84, %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_882.i, !mcsema_real_eip !7
  %86 = and i64 %85, 16
  %87 = icmp eq i64 %86, 0
  %88 = icmp slt i64 %84, 0
  %89 = icmp eq i64 %84, 0, !mcsema_real_eip !7
  %90 = xor i64 %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_882.i, -9223372036854775808, !mcsema_real_eip !7
  %91 = and i64 %85, %90, !mcsema_real_eip !7
  %92 = icmp slt i64 %91, 0
  %93 = trunc i64 %84 to i8, !mcsema_real_eip !7
  %94 = tail call i8 @llvm.ctpop.i8(i8 %93) #2, !mcsema_real_eip !7
  %95 = and i8 %94, 1
  %96 = icmp eq i8 %95, 0
  %97 = extractvalue { i64, i1 } %uadd210.i, 1
  store volatile i64 %84, i64* %_RSP_ptr_.sroa.0.i, align 8
  %98 = inttoptr i64 %84 to i64*, !mcsema_real_eip !8
  %99 = load i64, i64* %98, align 8
  store volatile i64 %99, i64* %_RBP_ptr_.sroa.0.i, align 8
  %100 = add i64 %84, 16
  store volatile i64 %100, i64* %_RSP_ptr_.sroa.0.i, align 8
  store i64 %3, i64* %RAX.i, align 8, !mcsema_real_eip !9
  store i64 %4, i64* %RBX.i, align 8, !mcsema_real_eip !9
  store i64 %5, i64* %RCX.i, align 8, !mcsema_real_eip !9
  store i64 %6, i64* %RDX.i, align 8, !mcsema_real_eip !9
  store i64 %7, i64* %RSI.i, align 8, !mcsema_real_eip !9
  store i64 %8, i64* %RDI.i, align 8, !mcsema_real_eip !9
  store volatile i64 %100, i64* %RSP.i, align 8
  store volatile i64 %99, i64* %RBP.i, align 8
  store i64 %9, i64* %R8.i, align 8, !mcsema_real_eip !9
  store i64 %10, i64* %R9.i, align 8, !mcsema_real_eip !9
  store i64 %11, i64* %R10.i, align 8, !mcsema_real_eip !9
  store i64 %12, i64* %R11.i, align 8, !mcsema_real_eip !9
  store i64 %13, i64* %R12.i, align 8, !mcsema_real_eip !9
  store i64 %14, i64* %R13.i, align 8, !mcsema_real_eip !9
  store i64 %15, i64* %R14.i, align 8, !mcsema_real_eip !9
  store i64 %16, i64* %R15.i, align 8, !mcsema_real_eip !9
  store i64 %17, i64* %RIP.i, align 8, !mcsema_real_eip !9
  store i1 %97, i1* %CF.i, align 1, !mcsema_real_eip !9
  store i1 %96, i1* %PF.i, align 1, !mcsema_real_eip !9
  store i1 %87, i1* %AF.i, align 1, !mcsema_real_eip !9
  store i1 %89, i1* %ZF.i, align 1, !mcsema_real_eip !9
  store i1 %88, i1* %SF.i, align 1, !mcsema_real_eip !9
  store i1 %92, i1* %OF.i, align 1, !mcsema_real_eip !9
  store i1 %18, i1* %DF.i, align 1, !mcsema_real_eip !9
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %20, i8* nonnull %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false) #2, !mcsema_real_eip !9
  ...
  store i64 %67, i64* %STACK_BASE.i, align 1, !mcsema_real_eip !9
  store i64 %68, i64* %STACK_LIMIT.i, align 1, !mcsema_real_eip !9
...
!3 = !{i64 24, [19 x i8] c"\09movl\09$0, -4(%rbp)\00"}
!4 = !{i64 31, [19 x i8] c"\09cmpl\09$2, -4(%rbp)\00"}
!5 = !{i64 35, [8 x i8] c"\09jge\0919\00"}
!6 = !{i64 41, [11 x i8] c"\09callq\09-46\00"}
!7 = !{i64 60, [16 x i8] c"\09addq\09$16, %rsp\00"}
!8 = !{i64 64, [11 x i8] c"\09popq\09%rbp\00"}
!9 = !{i64 65, [6 x i8] c"\09retq\00"}
