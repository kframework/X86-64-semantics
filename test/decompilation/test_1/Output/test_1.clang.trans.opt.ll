...
driverBlockRaw:
  ...
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_87.i1 = load i8*, i8** %68, align 8
  %_new_gep_.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_87.i1, i64 -8
  ...
  %_new_gep_1.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_87.i1, i64 -24
  %_trans_p2i_.i = ptrtoint i8* %_new_gep_1.i to i64
  %_trans_xor_.i = xor i64 %_trans_p2i_.i, %69
  %70 = and i64 %_trans_xor_.i, 16
  %71 = icmp eq i64 %70, 0
  %_trans_trunc_.i = trunc i64 %_trans_p2i_.i to i8
  %72 = tail call i8 @llvm.ctpop.i8(i8 %_trans_trunc_.i) #3, !mcsema_real_eip !3
  %73 = and i8 %72, 1
  %74 = icmp eq i8 %73, 0
  ...
  %_trans_xor_9.i = and i64 %_trans_xor_.i, %69
  %75 = icmp slt i64 %_trans_xor_9.i, 0
  store volatile i64 %_trans_p2i_.i, i64* %_RSP_ptr_.sroa.0.i, align 8
  %_new_gep_11.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_87.i1, i64 -12
  %76 = bitcast i8* %_new_gep_11.i to i32*
  store i32 0, i32* %76, align 4, !mcsema_real_eip !4
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_1389.i2 = load i8*, i8** %68, align 8
  %_new_gep_14.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_1389.i2, i64 -8
  ...
  %77 = ptrtoint i8* %_new_gep_14.i to i64
  store volatile i64 %77, i64* %_RSP_ptr_.sroa.0.i, align 8
  %78 = bitcast %struct.regs* %0 to <2 x i64>*
  store <2 x i64> %4, <2 x i64>* %78, align 8
  %79 = bitcast i64* %RCX.i to <2 x i64>*
  store <2 x i64> %6, <2 x i64>* %79, align 8
  %80 = bitcast i64* %RSI.i to <2 x i64>*
  store <2 x i64> <i64 20, i64 10>, <2 x i64>* %80, align 8
  store volatile i64 %77, i64* %RSP.i, align 8
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1883.i = load i64, i64* %_RBP_ptr_.sroa.0.i, align 8
  store volatile i64 %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1883.i, i64* %RBP.i, align 8
  ...
  store i1 %74, i1* %PF.i, align 1, !mcsema_real_eip !5
  store i1 %71, i1* %AF.i, align 1, !mcsema_real_eip !5
  store i1 %_trans_icmp_eq_.i, i1* %ZF.i, align 1, !mcsema_real_eip !5
  store i1 %_trans_icmp_ne_.i, i1* %SF.i, align 1, !mcsema_real_eip !5
  store i1 %75, i1* %OF.i, align 1, !mcsema_real_eip !5
  ...
  store <2 x i64> %67, <2 x i64>* %85, align 1
