...
driverBlockRaw:
  ...
  %_local_stack_start_ptr_2.i = alloca [16 x i8], align 8
  ...
  %1 = getelementptr inbounds [16 x i8], [16 x i8]* %_local_stack_start_ptr_2.i, i64 0, i64 0
  call void @llvm.lifetime.start(i64 16, i8* nonnull %1)
  %STi_val.i.0..sroa_cast = bitcast [8 x x86_fp80]* %STi_val.i to i8*
  call void @llvm.lifetime.start(i64 128, i8* nonnull %STi_val.i.0..sroa_cast)
  %_local_stack_end_ptr_.i = getelementptr inbounds [16 x i8], [16 x i8]* %_local_stack_start_ptr_2.i, i64 0, i64 16
  ...
  %_new_gep_.i = getelementptr inbounds [16 x i8], [16 x i8]* %_local_stack_start_ptr_2.i, i64 0, i64 8
  %_allin_new_bt_.i = bitcast i8* %_new_gep_.i to i64*
  store i64 %3, i64* %_allin_new_bt_.i, align 8, !mcsema_real_eip !2
  store volatile i8* %_new_gep_.i, i8** %_RSP_ptr_.i, align 8
  %_allin_new_bt_3.i = bitcast [16 x i8]* %_local_stack_start_ptr_2.i to i64*
  store i64 -4981261766360305936, i64* %_allin_new_bt_3.i, align 8, !mcsema_real_eip !3
  store volatile i8* %1, i8** %_RSP_ptr_.i, align 8
  store i64 %2, i64* %RAX.i, align 8, !mcsema_real_eip !3
  store i64 0, i64* %RBX.i, align 8, !mcsema_real_eip !3
  %69 = bitcast i64* %RCX.i to <2 x i64>*
  store <2 x i64> %5, <2 x i64>* %69, align 8
  store i64 %6, i64* %RSI.i, align 8, !mcsema_real_eip !3
  store i64 0, i64* %RDI.i, align 8, !mcsema_real_eip !3
  %_new_ptr2int_.i = ptrtoint [16 x i8]* %_local_stack_start_ptr_2.i to i64
  store volatile i64 %_new_ptr2int_.i, i64* %RSP.i, align 8
  store volatile i64 undef, i64* %RBP.i, align 8
  %70 = bitcast i64* %R8.i to <2 x i64>*
  store <2 x i64> %8, <2 x i64>* %70, align 8
  %71 = bitcast i64* %R10.i to <2 x i64>*
  store <2 x i64> %10, <2 x i64>* %71, align 8
  %72 = bitcast i64* %R12.i to <2 x i64>*
  store <2 x i64> %12, <2 x i64>* %72, align 8
  %73 = bitcast i64* %R14.i to <2 x i64>*
  store <2 x i64> %14, <2 x i64>* %73, align 8
  store i64 %15, i64* %RIP.i, align 8, !mcsema_real_eip !3
  store i1 false, i1* %CF.i, align 1, !mcsema_real_eip !3
  store i1 true, i1* %PF.i, align 1, !mcsema_real_eip !3
  store i1 %16, i1* %AF.i, align 1, !mcsema_real_eip !3
  ...
  store <2 x i64> %68, <2 x i64>* %74, align 1
