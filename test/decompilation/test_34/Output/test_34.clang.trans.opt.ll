...
driverBlockRaw:
  ...
  %_new_gep_14.i = getelementptr inbounds [32 x i8], [32 x i8]* %_local_stack_start_ptr_2.i, i64 0, i64 16
  %70 = bitcast i8* %_new_gep_14.i to i32*
  store i32 0, i32* %70, align 8, !mcsema_real_eip !4
  ...
  %_allin_new_bt_24.i = bitcast [32 x i8]* %_local_stack_start_ptr_2.i to i64*
  store i64 -4981261766360305936, i64* %_allin_new_bt_24.i, align 8, !mcsema_real_eip !5
  ...
  store i64 0, i64* %RDI.i, align 8, !mcsema_real_eip !5
  %_new_ptr2int_26.i = ptrtoint [32 x i8]* %_local_stack_start_ptr_2.i to i64
  store volatile i64 %_new_ptr2int_26.i, i64* %RSP.i, align 8
  ...
  store i1 true, i1* %CF.i, align 1, !mcsema_real_eip !5
  store i1 true, i1* %PF.i, align 1, !mcsema_real_eip !5
  store i1 true, i1* %AF.i, align 1, !mcsema_real_eip !5
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %18, i8* nonnull %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false) #1, !mcsema_real_eip !5
  ...
  store <2 x i64> %67, <2 x i64>* %77, align 1
