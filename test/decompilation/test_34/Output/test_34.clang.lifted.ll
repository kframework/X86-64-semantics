...
@XYZ = dllexport global %XYZ_type <{ [4 x i8] c"\14\00\00\00" }>
...
@3 = internal constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_4005a4__term_proc
...
block_4004f0:
  ...
  store i64 add (i64 ptrtoint (%seg_4005b0__rodata_type* @seg_4005b0__rodata to i64), i64 4), i64* %6, align 8, !tbaa !844
  %42 = add i64 %10, -12
  %43 = inttoptr i64 %42 to i32*
  store i32 0, i32* %43
  store i32 10, i32* bitcast (%XYZ_type* @XYZ to i32*)
  %44 = load i32, i32* bitcast (%XYZ_type* @XYZ to i32*)
  ...
  store i64 %47, i64* %49
  store i64 %48, i64* %7, align 8, !tbaa !844
  ...
  %58 = zext i1 %57 to i8
  store i8 %58, i8* %16, align 1, !tbaa !848
  ...
  %63 = and i8 %62, 1
  %64 = xor i8 %63, 1
  store i8 %64, i8* %23, align 1, !tbaa !860
  %65 = xor i64 %55, 16
  %66 = xor i64 %65, %56
  %67 = lshr i64 %66, 4
  %68 = trunc i64 %67 to i8
  %69 = and i8 %68, 1
  store i8 %69, i8* %29, align 1, !tbaa !864
  %70 = icmp eq i64 %56, 0
  %71 = zext i1 %70 to i8
  store i8 %71, i8* %32, align 1, !tbaa !861
  %72 = lshr i64 %56, 63
  %73 = trunc i64 %72 to i8
  store i8 %73, i8* %35, align 1, !tbaa !862
  %74 = lshr i64 %55, 63
  %75 = xor i64 %72, %74
  %76 = add nuw nsw i64 %75, %72
  %77 = icmp eq i64 %76, 2
  %78 = zext i1 %77 to i8
  store i8 %78, i8* %41, align 1, !tbaa !863
  %79 = add i64 %55, 24
  %80 = inttoptr i64 %56 to i64*
  %81 = load i64, i64* %80
  store i64 %81, i64* %8, align 8, !tbaa !844
...
define dllexport void @.term_proc() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x4005a4;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @3, void ()** nonnull @0) #6
  ret void
}
