...
block_0xea.i:                                     ; preds = %block_0xea.i, %driverBlockRaw
  ...
  %82 = add i32 %81, 11
  %83 = load i64, i64* %73, align 8, !mcsema_real_eip !13
  %84 = sext i32 %81 to i64, !mcsema_real_eip !14
  %85 = shl nsw i64 %84, 2
  %86 = add i64 %85, %83, !mcsema_real_eip !15
...
block_0x51.i.i:                                   ; preds = %block_0x51.i.i.preheader, %block_0x51.i.i
  ...
  %160 = load i64, i64* %144, align 8, !mcsema_real_eip !47
  %161 = sext i32 %159 to i64, !mcsema_real_eip !48
  %162 = shl nsw i64 %161, 2
  %163 = add i64 %162, %160, !mcsema_real_eip !49
...
block_0x11d.i:                                    ; preds = %block_0x11d.i, %block_0x10c.i
  ...
  %183 = add i32 %182, 1
  %184 = load i64, i64* %76, align 8, !mcsema_real_eip !55
  %185 = sext i32 %182 to i64, !mcsema_real_eip !56
  %186 = shl nsw i64 %185, 2
  %187 = add i64 %186, %184, !mcsema_real_eip !57
...
!13 = !{i64 243, [22 x i8] c"\09movq\09-24(%rbp), %rcx\00"}
!14 = !{i64 247, [24 x i8] c"\09movslq\09-36(%rbp), %rdx\00"}
!15 = !{i64 251, [26 x i8] c"\09movl\09%eax, (%rcx,%rdx,4)\00"}
...
!47 = !{i64 81, [22 x i8] c"\09movq\09-48(%rbp), %rax\00"}
!48 = !{i64 85, [24 x i8] c"\09movslq\09-72(%rbp), %rcx\00"}
!49 = !{i64 89, [26 x i8] c"\09movl\09(%rax,%rcx,4), %edx\00"}
!50 = !{i64 92, [22 x i8] c"\09movq\09-64(%rbp), %rax\00"}
!51 = !{i64 100, [26 x i8] c"\09subl\09(%rax,%rcx,4), %edx\00"}
...
!55 = !{i64 291, [22 x i8] c"\09movq\09-32(%rbp), %rcx\00"}
!56 = !{i64 295, [24 x i8] c"\09movslq\09-40(%rbp), %rdx\00"}
!57 = !{i64 299, [26 x i8] c"\09movl\09%eax, (%rcx,%rdx,4)\00"}
