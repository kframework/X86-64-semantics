...
block_0x10:                                       ; preds = %entry
  ...
  store i64 %RAX_val.7, i64* %_allin_new_bt_18, !mcsema_real_eip !7
  %_load_rbp_ptr_19 = load i8*, i8** %_RBP_ptr_
  %_new_gep_20 = getelementptr i8, i8* %_load_rbp_ptr_19, i64 -8
  %_allin_new_bt_21 = bitcast i8* %_new_gep_20 to i64*
  %14 = load i64, i64* %_allin_new_bt_21, !mcsema_real_eip !8
  store i64 %14, i64* %XDI, !mcsema_real_eip !8
  %_new_gep_23 = getelementptr i8, i8* %_load_rbp_ptr_19, i64 -16
  %_allin_new_bt_24 = bitcast i8* %_new_gep_23 to i64*
  %15 = load i64, i64* %_allin_new_bt_24, !mcsema_real_eip !9
  store i64 %15, i64* %XSI, !mcsema_real_eip !9
  ...
  %16 = sub i64 %RSP_val.12, 8, !mcsema_real_eip !10
  ...
  %18 = add i64 16, %RSP_val.13, !mcsema_real_eip !11
  ...
  %19 = xor i64 %_trans_xor_32, 16, !mcsema_real_eip !11
  %20 = and i64 %19, 16, !mcsema_real_eip !11
  %21 = icmp ne i64 %20, 0, !mcsema_real_eip !11
  store i1 %21, i1* %AF, !mcsema_real_eip !11
  %22 = lshr i64 %18, 63, !mcsema_real_eip !11
  %23 = trunc i64 %22 to i1, !mcsema_real_eip !11
  store i1 %23, i1* %SF, !mcsema_real_eip !11
  %_trans_icmp_eq_34 = icmp eq i64 %_trans_p2i_30, 0
  store i1 %_trans_icmp_eq_34, i1* %ZF, !mcsema_real_eip !11
  %_trans_xor_36 = xor i64 %_trans_p2i_31, 16
  %24 = xor i64 %_trans_xor_36, -1, !mcsema_real_eip !11
  %25 = and i64 %24, %_trans_xor_32, !mcsema_real_eip !11
  %26 = lshr i64 %25, 63, !mcsema_real_eip !11
  %27 = and i64 %26, 1, !mcsema_real_eip !11
  %28 = trunc i64 %27 to i1, !mcsema_real_eip !11
  store i1 %28, i1* %OF, !mcsema_real_eip !11
  %_trans_trunc_41 = trunc i64 %_trans_p2i_30 to i8
  %29 = call i8 @llvm.ctpop.i8(i8 %_trans_trunc_41), !mcsema_real_eip !11
  %30 = trunc i8 %29 to i1, !mcsema_real_eip !11
  %31 = xor i1 %30, true, !mcsema_real_eip !11
  store i1 %31, i1* %PF, !mcsema_real_eip !11
  %_trans_icmp_ne_43 = icmp ne i64 %_trans_p2i_30, %RSP_val.13
  store i1 %_trans_icmp_ne_43, i1* %CF, !mcsema_real_eip !11
  store volatile i8* %_new_gep_29, i8** %_RSP_ptr_
  store i64 %18, i64* %XSP, !mcsema_real_eip !11
  %_allin_new_bt_45 = bitcast i8* %_new_gep_29 to i64*
  %32 = load i64, i64* %_allin_new_bt_45, !mcsema_real_eip !12
  %_new_int2ptr_ = inttoptr i64 %32 to i8*
  store volatile i8* %_new_int2ptr_, i8** %_RBP_ptr_
  store i64 %32, i64* %XBP, !mcsema_real_eip !12
  %_new_gep_46 = getelementptr i8, i8* %_new_gep_29, i64 8
  %33 = add i64 %18, 8, !mcsema_real_eip !12
  store volatile i8* %_new_gep_46, i8** %_RSP_ptr_
  store i64 %33, i64* %XSP, !mcsema_real_eip !12
  %_new_gep_48 = getelementptr i8, i8* %_new_gep_46, i64 8
  %34 = add i64 %33, 8, !mcsema_real_eip !13
  %_allin_new_bt_49 = bitcast i8* %_new_gep_46 to i64*
  %35 = load i64, i64* %_allin_new_bt_49, !mcsema_real_eip !13
  store i64 %35, i64* %XIP, !mcsema_real_eip !13
  store volatile i8* %_new_gep_48, i8** %_RSP_ptr_
  store i64 %34, i64* %XSP, !mcsema_real_eip !13
...
; Function Attrs: noinline
define x86_64_sysvcc void @sub_10.1(%RegState*, i8* %_parent_stack_start_ptr_, i8* %_parent_stack_end_ptr_, i8* %_parent_stack_rbp_ptr_) #1 {
entry:
  %_RSP_ptr_ = alloca i8*
  %_RBP_ptr_ = alloca i8*
  %_local_stack_start_ptr_ = alloca i8, i64 32
...
; <label>:15:                                     ; preds = %block_0x10, %14
  ...
  store i64 %_new_load_, i64* %XDI, !mcsema_real_eip !8
  %_new_gep_23 = getelementptr i8, i8* %_load_rbp_ptr_19, i64 -16
  %_allin_new_bt_24 = bitcast i8* %_new_gep_23 to i64*
...
; <label>:18:                                     ; preds = %15, %17
  ...
  store i64 %_new_load_64, i64* %XSI, !mcsema_real_eip !9
  %_load_rsp_ptr_25 = load i8*, i8** %_RSP_ptr_
  %RSP_val.12 = load i64, i64* %XSP, !mcsema_real_eip !10
  %_new_gep_26 = getelementptr i8, i8* %_load_rsp_ptr_25, i64 -8
  %20 = sub i64 %RSP_val.12, 8, !mcsema_real_eip !10
  %_allin_new_bt_27 = bitcast i8* %_new_gep_26 to i64*
  store i64 -2415393069852865332, i64* %_allin_new_bt_27, !mcsema_real_eip !10
  store volatile i8* %_new_gep_26, i8** %_RSP_ptr_
  ...
  %RSP_val.13 = load i64, i64* %XSP, !mcsema_real_eip !11
  %_new_gep_29 = getelementptr i8, i8* %_gep_fix_, i64 16
  %22 = add i64 16, %RSP_val.13, !mcsema_real_eip !11
  %_trans_p2i_30 = ptrtoint i8* %_new_gep_29 to i64
  %_trans_p2i_31 = ptrtoint i8* %_gep_fix_ to i64
  %_trans_xor_32 = xor i64 %_trans_p2i_30, %_trans_p2i_31
  %23 = xor i64 %_trans_xor_32, 16, !mcsema_real_eip !11
  %24 = and i64 %23, 16, !mcsema_real_eip !11
  %25 = icmp ne i64 %24, 0, !mcsema_real_eip !11
  store i1 %25, i1* %AF, !mcsema_real_eip !11
  %26 = lshr i64 %22, 63, !mcsema_real_eip !11
  %27 = trunc i64 %26 to i1, !mcsema_real_eip !11
  store i1 %27, i1* %SF, !mcsema_real_eip !11
  %_trans_icmp_eq_34 = icmp eq i64 %_trans_p2i_30, 0
  store i1 %_trans_icmp_eq_34, i1* %ZF, !mcsema_real_eip !11
  %_trans_xor_36 = xor i64 %_trans_p2i_31, 16
  %28 = xor i64 %_trans_xor_36, -1, !mcsema_real_eip !11
  %29 = and i64 %28, %_trans_xor_32, !mcsema_real_eip !11
  %30 = lshr i64 %29, 63, !mcsema_real_eip !11
  %31 = and i64 %30, 1, !mcsema_real_eip !11
  %32 = trunc i64 %31 to i1, !mcsema_real_eip !11
  store i1 %32, i1* %OF, !mcsema_real_eip !11
  %_trans_trunc_41 = trunc i64 %_trans_p2i_30 to i8
  %33 = call i8 @llvm.ctpop.i8(i8 %_trans_trunc_41), !mcsema_real_eip !11
  %34 = trunc i8 %33 to i1, !mcsema_real_eip !11
  %35 = xor i1 %34, true, !mcsema_real_eip !11
  store i1 %35, i1* %PF, !mcsema_real_eip !11
  %_trans_icmp_ne_43 = icmp ne i64 %_trans_p2i_30, %RSP_val.13
  store i1 %_trans_icmp_ne_43, i1* %CF, !mcsema_real_eip !11
  store volatile i8* %_new_gep_29, i8** %_RSP_ptr_
  store i64 %22, i64* %XSP, !mcsema_real_eip !11
  %_allin_new_bt_45 = bitcast i8* %_new_gep_29 to i64*
...
; <label>:37:                                     ; preds = %18, %36
  ...
  store volatile i8* %_new_int2ptr_, i8** %_RBP_ptr_
  store i64 %_new_load_79, i64* %XBP, !mcsema_real_eip !12
  %_new_gep_46 = getelementptr i8, i8* %_new_gep_29, i64 8
  %39 = add i64 %22, 8, !mcsema_real_eip !12
  store volatile i8* %_new_gep_46, i8** %_RSP_ptr_
  store i64 %39, i64* %XSP, !mcsema_real_eip !12
  %_new_gep_48 = getelementptr i8, i8* %_new_gep_46, i64 8
  %40 = add i64 %39, 8, !mcsema_real_eip !13
  %_allin_new_bt_49 = bitcast i8* %_new_gep_46 to i64*
...
; <label>:42:                                     ; preds = %37, %41
  ...
  store i64 %_new_load_94, i64* %XIP, !mcsema_real_eip !13
  store volatile i8* %_new_gep_48, i8** %_RSP_ptr_
...
; <label>:3:                                      ; preds = %block_0x0, %2
  ...
  store volatile i8* %_new_int2ptr_, i8** %_RBP_ptr_
  store i64 %_new_load_, i64* %XBP, !mcsema_real_eip !16
  %_new_gep_4 = getelementptr i8, i8* %_load_rsp_ptr_2, i64 8
  %5 = add i64 %RSP_val.19, 8, !mcsema_real_eip !16
  store volatile i8* %_new_gep_4, i8** %_RSP_ptr_
  store i64 %5, i64* %XSP, !mcsema_real_eip !16
  %_new_gep_6 = getelementptr i8, i8* %_new_gep_4, i64 8
  %6 = add i64 %5, 8, !mcsema_real_eip !17
...
; <label>:8:                                      ; preds = %3, %7
  ...
  store i64 %_new_load_22, i64* %XIP, !mcsema_real_eip !17
  store volatile i8* %_new_gep_6, i8** %_RSP_ptr_
  store i64 %6, i64* %XSP, !mcsema_real_eip !17
  ret void, !mcsema_real_eip !17
}
