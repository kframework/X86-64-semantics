...
driverBlockRaw:
  ...
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_11.i = load i64, i64* %_RBP_ptr_.sroa.0.i, align 8
  %68 = bitcast i64* %_RSP_ptr_.sroa.0.i to i8**
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_15.i4 = load i8*, i8** %68, align 8
  %_new_gep_.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_15.i4, i64 -8
  %_allin_new_bt_.i = bitcast i8* %_new_gep_.i to i64*
  store volatile i64 %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_11.i, i64* %_allin_new_bt_.i, align 8
  %69 = ptrtoint i8* %_new_gep_.i to i64
  store volatile i64 %69, i64* %_RBP_ptr_.sroa.0.i, align 8
  %_new_gep_1.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_15.i4, i64 -24
  %70 = ptrtoint i8* %_new_gep_1.i to i64
  store volatile i64 %70, i64* %_RSP_ptr_.sroa.0.i, align 8
  %_new_gep_11.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_15.i4, i64 -16
  ...
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1316.i5 = load i8*, i8** %71, align 8
  %_new_gep_14.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1316.i5, i64 -16
  ...
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1617.i6 = load i8*, i8** %71, align 8
  %_new_gep_17.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1617.i6, i64 -8
  %_allin_new_bt_18.i = bitcast i8* %_new_gep_17.i to i64*
  %72 = load i64, i64* %_allin_new_bt_18.i, align 8, !mcsema_real_eip !5
  %_new_gep_19.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1617.i6, i64 -16
  %_allin_new_bt_20.i = bitcast i8* %_new_gep_19.i to i64*
  %73 = load i64, i64* %_allin_new_bt_20.i, align 8, !mcsema_real_eip !6
  %74 = tail call x86_64_sysvcc i64 @strcmp(i64 %72, i64 %73), !mcsema_real_eip !7
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_2112.i = load i64, i64* %_RSP_ptr_.sroa.0.i, align 8
  %uadd.i = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_2112.i, i64 16)
  %75 = extractvalue { i64, i1 } %uadd.i, 0
  %76 = xor i64 %75, %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_2112.i, !mcsema_real_eip !8
  %77 = and i64 %76, 16
  %78 = icmp eq i64 %77, 0
  %79 = icmp slt i64 %75, 0
  %80 = icmp eq i64 %75, 0, !mcsema_real_eip !8
  %81 = xor i64 %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_2112.i, -9223372036854775808, !mcsema_real_eip !8
  %82 = and i64 %76, %81, !mcsema_real_eip !8
  %83 = icmp slt i64 %82, 0
  %84 = trunc i64 %75 to i8, !mcsema_real_eip !8
  %85 = tail call i8 @llvm.ctpop.i8(i8 %84), !mcsema_real_eip !8
  %86 = and i8 %85, 1
  %87 = icmp eq i8 %86, 0
  %88 = extractvalue { i64, i1 } %uadd.i, 1
  store volatile i64 %75, i64* %_RSP_ptr_.sroa.0.i, align 8
  %89 = inttoptr i64 %75 to i64*, !mcsema_real_eip !9
  %90 = load i64, i64* %89, align 8
  store volatile i64 %90, i64* %_RBP_ptr_.sroa.0.i, align 8
  %91 = add i64 %75, 16
  store volatile i64 %91, i64* %_RSP_ptr_.sroa.0.i, align 8
  store i64 %74, i64* %RAX.i, align 8, !mcsema_real_eip !10
  %92 = bitcast i64* %RBX.i to <2 x i64>*
  store <2 x i64> %4, <2 x i64>* %92, align 8
  store i64 %5, i64* %RDX.i, align 8, !mcsema_real_eip !10
  store i64 %73, i64* %RSI.i, align 8, !mcsema_real_eip !10
  store i64 %72, i64* %RDI.i, align 8, !mcsema_real_eip !10
  ...
  store i1 %88, i1* %CF.i, align 1, !mcsema_real_eip !10
  store i1 %87, i1* %PF.i, align 1, !mcsema_real_eip !10
  store i1 %78, i1* %AF.i, align 1, !mcsema_real_eip !10
  store i1 %80, i1* %ZF.i, align 1, !mcsema_real_eip !10
  store i1 %79, i1* %SF.i, align 1, !mcsema_real_eip !10
  store i1 %83, i1* %OF.i, align 1, !mcsema_real_eip !10
  ...
  store i11 %49, i11* %FPU_FOPCODE.i, align 1, !mcsema_real_eip !10
