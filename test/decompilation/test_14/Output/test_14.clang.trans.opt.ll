...
entry:
  ...
  store i64 %RDI_val.5, i64* %_allin_new_bt_15, align 16, !mcsema_real_eip !6
  store i64 ptrtoint (%0* @data_0x3d to i64), i64* %XSI, align 8, !mcsema_real_eip !7
  ...
  %14 = call x86_64_sysvcc i64 @_strcmp(i64 %RDI_val.5, i64 ptrtoint (%0* @data_0x3d to i64))
  ...
  %RSP_val.13 = load i64, i64* %XSP, align 8, !mcsema_real_eip !9
  %_new_gep_29 = getelementptr i8, i8* %_RSP_ptr_.0._RSP_ptr_.0._rsp_fix_, i64 24
  %15 = add i64 %RSP_val.13, 16, !mcsema_real_eip !9
  ...
  %17 = icmp eq i64 %16, 0
  store i1 %17, i1* %AF, align 1, !mcsema_real_eip !9
  %18 = icmp slt i64 %15, 0
  store i1 %18, i1* %SF, align 1, !mcsema_real_eip !9
  %_trans_icmp_eq_34 = icmp eq i8* %_new_gep_29, null
  store i1 %_trans_icmp_eq_34, i1* %ZF, align 1, !mcsema_real_eip !9
  %19 = xor i64 %_trans_p2i_31, -9223372036854775808, !mcsema_real_eip !9
  %20 = and i64 %19, %_trans_xor_32, !mcsema_real_eip !9
  %21 = icmp slt i64 %20, 0
  store i1 %21, i1* %OF, align 1, !mcsema_real_eip !9
  %_trans_trunc_41 = trunc i64 %_trans_p2i_30 to i8
  %22 = call i8 @llvm.ctpop.i8(i8 %_trans_trunc_41), !mcsema_real_eip !9
  %23 = and i8 %22, 1
  %24 = icmp eq i8 %23, 0
  store i1 %24, i1* %PF, align 1, !mcsema_real_eip !9
  %_trans_icmp_ne_43 = icmp ne i64 %_trans_p2i_30, %RSP_val.13
  store i1 %_trans_icmp_ne_43, i1* %CF, align 1, !mcsema_real_eip !9
  ...
  %25 = load i64, i64* %_allin_new_bt_45, align 8, !mcsema_real_eip !10
  store volatile i64 %25, i64* %_RBP_ptr_.sroa.0, align 8
  store i64 %25, i64* %XBP, align 8, !mcsema_real_eip !10
  %_new_gep_46 = getelementptr i8, i8* %_RSP_ptr_.0._RSP_ptr_.0._rsp_fix_, i64 32
  %26 = add i64 %RSP_val.13, 24, !mcsema_real_eip !10
  ...
  %27 = add i64 %RSP_val.13, 32, !mcsema_real_eip !11
  %_allin_new_bt_49 = bitcast i8* %_new_gep_46 to i64*
  %28 = load i64, i64* %_allin_new_bt_49, align 8, !mcsema_real_eip !11
  store i64 %28, i64* %XIP, align 8, !mcsema_real_eip !11
  store volatile i8* %_new_gep_48, i8** %_RSP_ptr_, align 8
  store i64 %27, i64* %XSP, align 8, !mcsema_real_eip !11
...
entry:
  ...
  store i64 %RBP_val.16, i64* %2, align 8, !mcsema_real_eip !12
  store i64 %1, i64* %XSP, align 8, !mcsema_real_eip !12
  store i64 %1, i64* %XBP, align 8, !mcsema_real_eip !13
  %3 = load i64, i64* %2, align 8, !mcsema_real_eip !14
  store i64 %3, i64* %XBP, align 8, !mcsema_real_eip !14
  store i64 %RSP_val.17, i64* %XSP, align 8, !mcsema_real_eip !14
  %4 = add i64 %RSP_val.17, 8, !mcsema_real_eip !15
  %5 = inttoptr i64 %RSP_val.17 to i64*, !mcsema_real_eip !15
  %6 = load i64, i64* %5, align 8, !mcsema_real_eip !15
  store i64 %6, i64* %XIP, align 8, !mcsema_real_eip !15
  store i64 %4, i64* %XSP, align 8, !mcsema_real_eip !15
...
entry:
  ...
  store volatile i8* %_new_gep_26, i8** %_RSP_ptr_, align 8
  store i64 %11, i64* %XSP, align 8, !mcsema_real_eip !8
  %13 = call x86_64_sysvcc i64 @_strcmp(i64 %RDI_val.5, i64 ptrtoint (%0* @data_0x3d to i64))
  %_RSP_ptr_.0._RSP_ptr_.0._rsp_fix_ = load i8*, i8** %_RSP_ptr_, align 8
  %_gep_fix_ = getelementptr i8, i8* %_RSP_ptr_.0._RSP_ptr_.0._rsp_fix_, i64 8
  store i8* %_gep_fix_, i8** %_RSP_ptr_, align 8
  ...
  %RSP_val.13 = load i64, i64* %XSP, align 8, !mcsema_real_eip !9
  %_new_gep_29 = getelementptr i8, i8* %_RSP_ptr_.0._RSP_ptr_.0._rsp_fix_, i64 24
  %14 = add i64 %RSP_val.13, 16, !mcsema_real_eip !9
  %_trans_p2i_30 = ptrtoint i8* %_new_gep_29 to i64
  %_trans_p2i_31 = ptrtoint i8* %_gep_fix_ to i64
  %_trans_xor_32 = xor i64 %_trans_p2i_30, %_trans_p2i_31
  ...
  %_trans_icmp_eq_34 = icmp eq i8* %_new_gep_29, null
  store i1 %_trans_icmp_eq_34, i1* %ZF, align 1, !mcsema_real_eip !9
  %18 = xor i64 %_trans_p2i_31, -9223372036854775808, !mcsema_real_eip !9
  %19 = and i64 %18, %_trans_xor_32, !mcsema_real_eip !9
  %20 = icmp slt i64 %19, 0
  store i1 %20, i1* %OF, align 1, !mcsema_real_eip !9
  %_trans_trunc_41 = trunc i64 %_trans_p2i_30 to i8
  %21 = call i8 @llvm.ctpop.i8(i8 %_trans_trunc_41), !mcsema_real_eip !9
  %22 = and i8 %21, 1
  %23 = icmp eq i8 %22, 0
  ...
  store i64 %_new_load_79, i64* %XBP, align 8, !mcsema_real_eip !10
  %_new_gep_46 = getelementptr i8, i8* %_RSP_ptr_.0._RSP_ptr_.0._rsp_fix_, i64 32
  %25 = add i64 %RSP_val.13, 24, !mcsema_real_eip !10
  store volatile i8* %_new_gep_46, i8** %_RSP_ptr_, align 8
  store i64 %25, i64* %XSP, align 8, !mcsema_real_eip !10
  %_new_gep_48 = getelementptr i8, i8* %_RSP_ptr_.0._RSP_ptr_.0._rsp_fix_, i64 40
  %26 = add i64 %RSP_val.13, 32, !mcsema_real_eip !11
  ...
  store i64 %_new_load_94, i64* %XIP, align 8, !mcsema_real_eip !11
  store volatile i8* %_new_gep_48, i8** %_RSP_ptr_, align 8
...
; Function Attrs: noinline norecurse nounwind
define x86_64_sysvcc void @sub_0.2(%RegState* nocapture, i8* nocapture readnone %_parent_stack_start_ptr_, i8* nocapture readnone %_parent_stack_end_ptr_, i8* %_parent_stack_rbp_ptr_) local_unnamed_addr #1 {
entry:
  %_RSP_ptr_ = alloca i8*, align 8
  %_RBP_ptr_ = alloca i8*, align 8
  ...
  store i64 %_new_ptr2int_, i64* %XBP, align 8, !mcsema_real_eip !14
  ...
  %3 = add i64 %RSP_val.17, 8, !mcsema_real_eip !15
  store volatile i8* %_new_gep_6, i8** %_RSP_ptr_, align 8
  store i64 %3, i64* %XSP, align 8, !mcsema_real_eip !15
  ret void, !mcsema_real_eip !15
}
