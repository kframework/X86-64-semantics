...
driverBlockRaw:
  ...
  %72 = add i32 %70, -2
  %73 = xor i32 %72, %70, !mcsema_real_eip !6
  %74 = and i32 %73, 16, !mcsema_real_eip !6
  %75 = icmp ne i32 %74, 0, !mcsema_real_eip !6
  %76 = trunc i32 %72 to i8, !mcsema_real_eip !6
  %77 = tail call i8 @llvm.ctpop.i8(i8 %76), !mcsema_real_eip !6
  %78 = and i8 %77, 1
  %79 = icmp eq i8 %78, 0
  %80 = icmp eq i32 %72, 0, !mcsema_real_eip !6
  %81 = icmp slt i32 %72, 0
  %82 = icmp ult i32 %70, 2, !mcsema_real_eip !6
  %83 = and i32 %73, %70, !mcsema_real_eip !6
  %84 = icmp slt i32 %83, 0
  br i1 %80, label %block_0xa0.i, label %block_0xc2.i, !mcsema_real_eip !7

block_0xa0.i:                                     ; preds = %driverBlockRaw
  %85 = add i64 %5, 8, !mcsema_real_eip !8
  %86 = inttoptr i64 %85 to i64*, !mcsema_real_eip !8
  %87 = load i64, i64* %86, align 8, !mcsema_real_eip !8
  %88 = tail call x86_64_sysvcc i64 @atoi(i64 %87), !mcsema_real_eip !9
  %89 = trunc i64 %88 to i32, !mcsema_real_eip !10
  br label %block_0xc2.i, !mcsema_real_eip !11

block_0xc2.i:                                     ; preds = %block_0xa0.i, %driverBlockRaw
  %.sink.i = phi i32 [ %89, %block_0xa0.i ], [ 8, %driverBlockRaw ]
  %_allin_new_bt_30.sink.in.i = getelementptr inbounds [48 x i8], [48 x i8]* %_local_stack_start_ptr_3.i, i64 0, i64 16
  %90 = bitcast i8* %_allin_new_bt_30.sink.in.i to i32*
  store i32 %.sink.i, i32* %90, align 8
  %_new_gep_35.i = getelementptr inbounds [48 x i8], [48 x i8]* %_local_stack_start_ptr_3.i, i64 0, i64 20
  %91 = bitcast i8* %_new_gep_35.i to i32*
  store i32 %.sink.i, i32* %91, align 4, !mcsema_real_eip !12
  %92 = zext i32 %.sink.i to i64, !mcsema_real_eip !13
  %_new_gep_44.i = getelementptr inbounds [48 x i8], [48 x i8]* %_local_stack_start_ptr_3.i, i64 0, i64 12
  %93 = bitcast i8* %_new_gep_44.i to i32*
  store i32 %.sink.i, i32* %93, align 4, !mcsema_real_eip !14
  %_allin_new_bt_48.i = bitcast [48 x i8]* %_local_stack_start_ptr_3.i to i64*
  store i64 -4981261766360305936, i64* %_allin_new_bt_48.i, align 8, !mcsema_real_eip !15
  ...
  store i64 %4, i64* %RDX.i, align 8, !mcsema_real_eip !15
  store i64 %92, i64* %RSI.i, align 8, !mcsema_real_eip !15
  store i64 3, i64* %RDI.i, align 8, !mcsema_real_eip !15
  %_new_ptr2int_50.i = ptrtoint [48 x i8]* %_local_stack_start_ptr_3.i to i64
  store volatile i64 %_new_ptr2int_50.i, i64* %RSP.i, align 8
  ...
  store i1 %82, i1* %CF.i, align 1, !mcsema_real_eip !15
  store i1 %79, i1* %PF.i, align 1, !mcsema_real_eip !15
  store i1 %75, i1* %AF.i, align 1, !mcsema_real_eip !15
  store i1 %80, i1* %ZF.i, align 1, !mcsema_real_eip !15
  store i1 %81, i1* %SF.i, align 1, !mcsema_real_eip !15
  store i1 %84, i1* %OF.i, align 1, !mcsema_real_eip !15
  ...
  store <2 x i64> %67, <2 x i64>* %99, align 1
  call void @llvm.trap()
  unreachable
}
