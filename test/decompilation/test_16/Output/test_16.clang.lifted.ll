...
%seg_400580__rodata_type = type <{ [8 x i8] }>
...
@seg_400580__rodata = internal constant %seg_400580__rodata_type <{ [8 x i8] c"\01\00\02\00abc\00" }>
...
@1 = internal constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_4004c0_main
@2 = internal constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400574__term_proc
@3 = internal constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400380__init_proc
@4 = internal constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_4004a0_printit
...
define internal %struct.Memory* @sub_4004c0_main(%struct.State* dereferenceable(2688) %state2, i64 %pc, %struct.Memory* %memory1) #3 {
block_4004c0:
  ...
  %44 = add i64 %13, -28
  store i64 %44, i64* %6, align 8, !tbaa !844
  %45 = add i64 %13, -12
  ...
  store i64 %51, i64* %52
  %53 = load i32, i32* inttoptr (i64 add (i64 ptrtoint (%seg_400580__rodata_type* @seg_400580__rodata to i64), i64 4) to i32*)
  %54 = inttoptr i64 %44 to i32*
  store i32 %53, i32* %54
  store i64 %44, i64* %9, align 8, !tbaa !844
  ...
  store i64 %56, i64* %58
  store i64 %57, i64* %10, align 8, !tbaa !844
  store i64 %55, i64* %0, align 8, !tbaa !844
  %59 = tail call %struct.Memory* @sub_4004a0_printit(%struct.State* nonnull %state2, i64 %55, %struct.Memory* %memory1)
  ...
  %67 = zext i1 %66 to i8
  store i8 %67, i8* %19, align 1, !tbaa !848
  %68 = trunc i64 %65 to i32
  %69 = and i32 %68, 255
  %70 = tail call i32 @llvm.ctpop.i32(i32 %69) #5
  %71 = trunc i32 %70 to i8
  %72 = and i8 %71, 1
  %73 = xor i8 %72, 1
  store i8 %73, i8* %26, align 1, !tbaa !860
  %74 = xor i64 %65, %64
  %75 = lshr i64 %74, 4
  %76 = trunc i64 %75 to i8
  %77 = and i8 %76, 1
  store i8 %77, i8* %31, align 1, !tbaa !861
  %78 = icmp eq i64 %65, 0
  %79 = zext i1 %78 to i8
  store i8 %79, i8* %34, align 1, !tbaa !862
  %80 = lshr i64 %65, 63
  %81 = trunc i64 %80 to i8
  store i8 %81, i8* %37, align 1, !tbaa !863
  %82 = lshr i64 %64, 63
  %83 = xor i64 %80, %82
  %84 = add nuw nsw i64 %83, %80
  %85 = icmp eq i64 %84, 2
  %86 = zext i1 %85 to i8
  store i8 %86, i8* %43, align 1, !tbaa !864
  %87 = add i64 %64, 40
  %88 = inttoptr i64 %65 to i64*
  %89 = load i64, i64* %88
  store i64 %89, i64* %11, align 8, !tbaa !844
  %90 = inttoptr i64 %87 to i64*
  %91 = load i64, i64* %90
  store i64 %91, i64* %0, align 8, !tbaa !844
  %92 = add i64 %64, 48
  store i64 %92, i64* %10, align 8, !tbaa !844
  ret %struct.Memory* %59
}

; Function Attrs: noinline nounwind
define internal %struct.Memory* @sub_4004a0_printit(%struct.State* nocapture dereferenceable(2688) %state2, i64 %pc, %struct.Memory* %memory1) #3 {
block_4004a0:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  store i64 %16, i64* %1, align 8, !tbaa !844
  %17 = inttoptr i64 %7 to i64*
  %18 = load i64, i64* %17
  store i64 %18, i64* %4, align 8, !tbaa !844
  %19 = inttoptr i64 %6 to i64*
  %20 = load i64, i64* %19
  store i64 %20, i64* %0, align 8, !tbaa !844
  %21 = add i64 %6, 8
  store i64 %21, i64* %3, align 8, !tbaa !844
...
; Function Attrs: noinline nounwind
define internal %struct.Memory* @sub_400574__term_proc(%struct.State* nocapture dereferenceable(2688) %state2, i64 %pc, %struct.Memory* returned %memory1) #3 {
block_400574:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
...
define dllexport void @main() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x4004c0;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @1, void ()** nonnull @0) #5
  ret void
}

; Function Attrs: naked nobuiltin noinline nounwind
define dllexport void @.term_proc() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x400574;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @2, void ()** nonnull @0) #5
  ret void
}
...
; Function Attrs: naked nobuiltin noinline nounwind
define dllexport void @printit() local_unnamed_addr #4 {
