...
@3 = internal constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400594__term_proc
...
; Function Attrs: noinline nounwind
define internal %struct.Memory* @sub_400594__term_proc(%struct.State* nocapture dereferenceable(2688) %state2, i64 %pc, %struct.Memory* returned %memory1) #3 {
block_400594:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
...
block_4004f0:
  ...
  store i64 add (i64 ptrtoint (%seg_4005a0__rodata_type* @seg_4005a0__rodata to i64), i64 4), i64* %6, align 8, !tbaa !844
  %42 = add i64 %10, -12
  ...
  %48 = tail call fastcc %struct.Memory* @ext_601048_printf(%struct.State* nonnull %state2, %struct.Memory* %memory1) #6
  ...
  %56 = zext i1 %55 to i8
  store i8 %56, i8* %16, align 1, !tbaa !848
  ...
  %61 = and i8 %60, 1
  %62 = xor i8 %61, 1
  store i8 %62, i8* %23, align 1, !tbaa !860
  %63 = xor i64 %53, 16
  %64 = xor i64 %63, %54
  %65 = lshr i64 %64, 4
  %66 = trunc i64 %65 to i8
  %67 = and i8 %66, 1
  store i8 %67, i8* %29, align 1, !tbaa !864
  %68 = icmp eq i64 %54, 0
  %69 = zext i1 %68 to i8
  store i8 %69, i8* %32, align 1, !tbaa !861
  %70 = lshr i64 %54, 63
  %71 = trunc i64 %70 to i8
  store i8 %71, i8* %35, align 1, !tbaa !862
  %72 = lshr i64 %53, 63
  %73 = xor i64 %70, %72
  %74 = add nuw nsw i64 %73, %70
  %75 = icmp eq i64 %74, 2
  %76 = zext i1 %75 to i8
  store i8 %76, i8* %41, align 1, !tbaa !863
  %77 = add i64 %53, 24
...
define dllexport void @.term_proc() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x400594;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @3, void ()** nonnull @0) #6
  ret void
}
