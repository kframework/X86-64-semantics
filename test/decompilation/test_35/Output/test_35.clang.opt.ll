; ModuleID = 'Output/test_35.clang.opt.bc'
...
driverBlockRaw:
  ...
  %72 = add i64 %6, -12, !mcsema_real_eip !3
  %73 = inttoptr i64 %72 to i32*
  store i32 0, i32* %73, align 4, !mcsema_real_eip !3
  store i32 10, i32* bitcast (%0* @data_0x58 to i32*), align 64, !mcsema_real_eip !4
  %74 = load i64, i64* %71, align 8, !mcsema_real_eip !5
  %75 = add i64 %6, 8, !mcsema_real_eip !6
  store i64 0, i64* %RAX.i, align 8, !mcsema_real_eip !6
  %76 = bitcast i64* %RBX.i to <2 x i64>*
  store <2 x i64> %2, <2 x i64>* %76, align 8
  %77 = bitcast i64* %RDX.i to <2 x i64>*
  store <2 x i64> %4, <2 x i64>* %77, align 8
  store i64 %5, i64* %RDI.i, align 8, !mcsema_real_eip !6
  store i64 %75, i64* %RSP.i, align 8, !mcsema_real_eip !6
  store i64 %74, i64* %RBP.i, align 8, !mcsema_real_eip !6
