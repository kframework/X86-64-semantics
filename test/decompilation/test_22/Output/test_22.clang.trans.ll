...
entry:
  ...
  %84 = bitcast i64* %_allin_new_bt_2 to x86_fp80*, !mcsema_real_eip !4
...
fpu_read_continue:                                ; preds = %fpu_read_normal, %fpu_write
  ...
  %102 = bitcast i64* %_allin_new_bt_5 to x86_fp80*, !mcsema_real_eip !5
...
fpu_read_continue14:                              ; preds = %fpu_read_normal12, %fpu_write8
  ...
  store i1 false, i1* %FPU_C1_val
  %136 = bitcast i64* %_allin_new_bt_8 to x86_fp80*, !mcsema_real_eip !8
  ...
  %145 = bitcast i64* %_allin_new_bt_11 to x86_fp80*, !mcsema_real_eip !9
...
fpu_write28:                                      ; preds = %fpu_exception29, %fpu_read_continue26
  ...
  %180 = load i64, i64* %_allin_new_bt_13, !mcsema_real_eip !11
