...
block_0xd:                                        ; preds = %block_0xd.preheader, %block_0xd
  %EBX_val.1713 = phi i32 [ %6, %block_0xd ], [ 0, %block_0xd.preheader ]
  %EAX_val.2212 = phi i32 [ %4, %block_0xd ], [ 1, %block_0xd.preheader ]
  %4 = shl i32 %EAX_val.2212, 1
  %5 = zext i32 %4 to i64, !mcsema_real_eip !7
  %6 = add i32 %EBX_val.1713, 1, !mcsema_real_eip !8
...
block_0x13:                                       ; preds = %block_0x9.block_0x13_crit_edge, %entry
  ...
  %19 = inttoptr i64 %RSP_val.20 to i64*, !mcsema_real_eip !9
  %20 = load i64, i64* %19, align 8, !mcsema_real_eip !9
  store i64 %20, i64* %XIP, align 8, !mcsema_real_eip !9
