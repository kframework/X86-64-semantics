...
block_0x189:                                      ; preds = %block_0x163
  ...
  %133 = zext i32 %EAX_val.13 to i64, !mcsema_real_eip !21
  store i64 %133, i64* %XDI, !mcsema_real_eip !21
  %RBP_val.14 = load i64, i64* %XBP, !mcsema_real_eip !22
  %134 = add i64 %RBP_val.14, -24, !mcsema_real_eip !22
  %135 = inttoptr i64 %134 to i64*, !mcsema_real_eip !22
  %136 = ptrtoint i64* %135 to i64, !mcsema_real_eip !22
  store i64 %136, i64* %XCX, !mcsema_real_eip !22
  %RBP_val.15 = load i64, i64* %XBP, !mcsema_real_eip !23
  %137 = add i64 %RBP_val.15, -80, !mcsema_real_eip !23
  %138 = inttoptr i64 %137 to i64*, !mcsema_real_eip !23
  %RCX_val.16 = load i64, i64* %XCX, !mcsema_real_eip !23
  store i64 %RCX_val.16, i64* %138, !mcsema_real_eip !23
  %RDI_val.17 = load i64, i64* %XDI, !mcsema_real_eip !24
  %RSP_val.18 = load i64, i64* %XSP, !mcsema_real_eip !24
  %139 = sub i64 %RSP_val.18, 8, !mcsema_real_eip !24
  %140 = inttoptr i64 %139 to i64*, !mcsema_real_eip !24
  store i64 -2415393069852865332, i64* %140, !mcsema_real_eip !24
  store i64 %139, i64* %XSP, !mcsema_real_eip !24
  %141 = call x86_64_sysvcc i64 @_malloc(i64 %RDI_val.17), !mcsema_real_eip !24
  store i64 %141, i64* %XAX, !mcsema_real_eip !24
  %RBP_val.19 = load i64, i64* %XBP, !mcsema_real_eip !25
  %142 = add i64 %RBP_val.19, -88, !mcsema_real_eip !25
  %143 = inttoptr i64 %142 to i64*, !mcsema_real_eip !25
  %RAX_val.20 = load i64, i64* %XAX, !mcsema_real_eip !25
  store i64 %RAX_val.20, i64* %143, !mcsema_real_eip !25
  %RBP_val.21 = load i64, i64* %XBP, !mcsema_real_eip !26
  %144 = add i64 %RBP_val.21, -92, !mcsema_real_eip !26
  %145 = inttoptr i64 %144 to i64*, !mcsema_real_eip !26
  %146 = ptrtoint i64* %145 to i64, !mcsema_real_eip !26
  %147 = inttoptr i64 %146 to i32*, !mcsema_real_eip !26
  store i32 0, i32* %147, !mcsema_real_eip !26
...
block_0x1a8:                                      ; preds = %block_0x1b2, %block_0x189
  ...
  %148 = add i64 %RBP_val.36, -92, !mcsema_real_eip !27
  %149 = inttoptr i64 %148 to i64*, !mcsema_real_eip !27
  %150 = ptrtoint i64* %149 to i64, !mcsema_real_eip !27
  %151 = inttoptr i64 %150 to i32*, !mcsema_real_eip !27
  %152 = load i32, i32* %151, !mcsema_real_eip !27
  %153 = sub i32 %152, 10, !mcsema_real_eip !27
  %154 = xor i32 %153, %152, !mcsema_real_eip !27
  %155 = xor i32 %154, 10, !mcsema_real_eip !27
  %156 = and i32 %155, 16, !mcsema_real_eip !27
  %157 = icmp ne i32 %156, 0, !mcsema_real_eip !27
  store i1 %157, i1* %AF, !mcsema_real_eip !27
  %158 = trunc i32 %153 to i8, !mcsema_real_eip !27
  %159 = call i8 @llvm.ctpop.i8(i8 %158), !mcsema_real_eip !27
  %160 = trunc i8 %159 to i1, !mcsema_real_eip !27
  %161 = xor i1 %160, true, !mcsema_real_eip !27
  store i1 %161, i1* %PF, !mcsema_real_eip !27
  %162 = icmp eq i32 %153, 0, !mcsema_real_eip !27
  store i1 %162, i1* %ZF, !mcsema_real_eip !27
  %163 = lshr i32 %153, 31, !mcsema_real_eip !27
  %164 = trunc i32 %163 to i1, !mcsema_real_eip !27
  store i1 %164, i1* %SF, !mcsema_real_eip !27
  %165 = icmp ult i32 %152, 10, !mcsema_real_eip !27
  store i1 %165, i1* %CF, !mcsema_real_eip !27
  %166 = xor i32 %152, 10, !mcsema_real_eip !27
  %167 = xor i32 %152, %153, !mcsema_real_eip !27
  %168 = and i32 %166, %167, !mcsema_real_eip !27
  %169 = lshr i32 %168, 31, !mcsema_real_eip !27
  %170 = trunc i32 %169 to i1, !mcsema_real_eip !27
  store i1 %170, i1* %OF, !mcsema_real_eip !27
  %171 = load i1, i1* %OF, !mcsema_real_eip !28
  %172 = load i1, i1* %SF, !mcsema_real_eip !28
  %173 = icmp eq i1 %172, %171, !mcsema_real_eip !28
  br i1 %173, label %block_0x1d1, label %block_0x1b2, !mcsema_real_eip !28

block_0x1b2:                                      ; preds = %block_0x1a8
  %RBP_val.97 = load i64, i64* %XBP, !mcsema_real_eip !29
  %174 = add i64 %RBP_val.97, -92, !mcsema_real_eip !29
  %175 = inttoptr i64 %174 to i64*, !mcsema_real_eip !29
  %176 = ptrtoint i64* %175 to i64, !mcsema_real_eip !29
  %177 = inttoptr i64 %176 to i32*, !mcsema_real_eip !29
  %178 = load i32, i32* %177, !mcsema_real_eip !29
  %179 = zext i32 %178 to i64, !mcsema_real_eip !29
  store i64 %179, i64* %XAX, !mcsema_real_eip !29
  %EAX.98 = bitcast i64* %XAX to i32*, !mcsema_real_eip !30
  %EAX_val.99 = load i32, i32* %EAX.98, !mcsema_real_eip !30
  %180 = add i32 1, %EAX_val.99, !mcsema_real_eip !30
  %181 = xor i32 %180, %EAX_val.99, !mcsema_real_eip !30
  %182 = xor i32 %181, 1, !mcsema_real_eip !30
  %183 = and i32 %182, 16, !mcsema_real_eip !30
  %184 = icmp ne i32 %183, 0, !mcsema_real_eip !30
  store i1 %184, i1* %AF, !mcsema_real_eip !30
  %185 = lshr i32 %180, 31, !mcsema_real_eip !30
  %186 = trunc i32 %185 to i1, !mcsema_real_eip !30
  store i1 %186, i1* %SF, !mcsema_real_eip !30
  %187 = icmp eq i32 %180, 0, !mcsema_real_eip !30
  store i1 %187, i1* %ZF, !mcsema_real_eip !30
  %188 = xor i32 %EAX_val.99, 1, !mcsema_real_eip !30
  %189 = xor i32 %188, -1, !mcsema_real_eip !30
  %190 = xor i32 %EAX_val.99, %180, !mcsema_real_eip !30
  %191 = and i32 %189, %190, !mcsema_real_eip !30
  %192 = lshr i32 %191, 31, !mcsema_real_eip !30
  %193 = and i32 %192, 1, !mcsema_real_eip !30
  %194 = trunc i32 %193 to i1, !mcsema_real_eip !30
  store i1 %194, i1* %OF, !mcsema_real_eip !30
  %195 = trunc i32 %180 to i8, !mcsema_real_eip !30
  %196 = call i8 @llvm.ctpop.i8(i8 %195), !mcsema_real_eip !30
  %197 = trunc i8 %196 to i1, !mcsema_real_eip !30
  %198 = xor i1 %197, true, !mcsema_real_eip !30
  store i1 %198, i1* %PF, !mcsema_real_eip !30
  %199 = icmp ult i32 %180, %EAX_val.99, !mcsema_real_eip !30
  store i1 %199, i1* %CF, !mcsema_real_eip !30
  %200 = zext i32 %180 to i64, !mcsema_real_eip !30
  store i64 %200, i64* %XAX, !mcsema_real_eip !30
  %RBP_val.100 = load i64, i64* %XBP, !mcsema_real_eip !31
  %201 = add i64 %RBP_val.100, -88, !mcsema_real_eip !31
  %202 = inttoptr i64 %201 to i64*, !mcsema_real_eip !31
  %203 = load i64, i64* %202, !mcsema_real_eip !31
  store i64 %203, i64* %XCX, !mcsema_real_eip !31
  %RBP_val.101 = load i64, i64* %XBP, !mcsema_real_eip !32
  %204 = add i64 %RBP_val.101, -92, !mcsema_real_eip !32
  %205 = inttoptr i64 %204 to i64*, !mcsema_real_eip !32
  %206 = ptrtoint i64* %205 to i64, !mcsema_real_eip !32
  %207 = inttoptr i64 %206 to i32*, !mcsema_real_eip !32
  %208 = load i32, i32* %207, !mcsema_real_eip !32
  %209 = sext i32 %208 to i64, !mcsema_real_eip !32
  store i64 %209, i64* %XDX, !mcsema_real_eip !32
  %RCX_val.102 = load i64, i64* %XCX, !mcsema_real_eip !33
  %210 = add i64 %RCX_val.102, 0, !mcsema_real_eip !33
  %RDX_val.103 = load i64, i64* %XDX, !mcsema_real_eip !33
  %211 = mul i64 %RDX_val.103, 4, !mcsema_real_eip !33
  %212 = add i64 %210, %211, !mcsema_real_eip !33
  %213 = inttoptr i64 %212 to i64*, !mcsema_real_eip !33
  %EAX.104 = bitcast i64* %XAX to i32*, !mcsema_real_eip !33
  %EAX_val.105 = load i32, i32* %EAX.104, !mcsema_real_eip !33
  %214 = ptrtoint i64* %213 to i64, !mcsema_real_eip !33
  %215 = inttoptr i64 %214 to i32*, !mcsema_real_eip !33
  store i32 %EAX_val.105, i32* %215, !mcsema_real_eip !33
  %RBP_val.106 = load i64, i64* %XBP, !mcsema_real_eip !34
  %216 = add i64 %RBP_val.106, -92, !mcsema_real_eip !34
  %217 = inttoptr i64 %216 to i64*, !mcsema_real_eip !34
  %218 = ptrtoint i64* %217 to i64, !mcsema_real_eip !34
  %219 = inttoptr i64 %218 to i32*, !mcsema_real_eip !34
  %220 = load i32, i32* %219, !mcsema_real_eip !34
  %221 = zext i32 %220 to i64, !mcsema_real_eip !34
  store i64 %221, i64* %XAX, !mcsema_real_eip !34
  %EAX.107 = bitcast i64* %XAX to i32*, !mcsema_real_eip !35
  %EAX_val.108 = load i32, i32* %EAX.107, !mcsema_real_eip !35
  %222 = add i32 1, %EAX_val.108, !mcsema_real_eip !35
  %223 = xor i32 %222, %EAX_val.108, !mcsema_real_eip !35
  %224 = xor i32 %223, 1, !mcsema_real_eip !35
  %225 = and i32 %224, 16, !mcsema_real_eip !35
  %226 = icmp ne i32 %225, 0, !mcsema_real_eip !35
  store i1 %226, i1* %AF, !mcsema_real_eip !35
  %227 = lshr i32 %222, 31, !mcsema_real_eip !35
  %228 = trunc i32 %227 to i1, !mcsema_real_eip !35
  store i1 %228, i1* %SF, !mcsema_real_eip !35
  %229 = icmp eq i32 %222, 0, !mcsema_real_eip !35
  store i1 %229, i1* %ZF, !mcsema_real_eip !35
  %230 = xor i32 %EAX_val.108, 1, !mcsema_real_eip !35
  %231 = xor i32 %230, -1, !mcsema_real_eip !35
  %232 = xor i32 %EAX_val.108, %222, !mcsema_real_eip !35
  %233 = and i32 %231, %232, !mcsema_real_eip !35
  %234 = lshr i32 %233, 31, !mcsema_real_eip !35
  %235 = and i32 %234, 1, !mcsema_real_eip !35
  %236 = trunc i32 %235 to i1, !mcsema_real_eip !35
  store i1 %236, i1* %OF, !mcsema_real_eip !35
  %237 = trunc i32 %222 to i8, !mcsema_real_eip !35
  %238 = call i8 @llvm.ctpop.i8(i8 %237), !mcsema_real_eip !35
  %239 = trunc i8 %238 to i1, !mcsema_real_eip !35
  %240 = xor i1 %239, true, !mcsema_real_eip !35
  store i1 %240, i1* %PF, !mcsema_real_eip !35
  %241 = icmp ult i32 %222, %EAX_val.108, !mcsema_real_eip !35
  store i1 %241, i1* %CF, !mcsema_real_eip !35
  %242 = zext i32 %222 to i64, !mcsema_real_eip !35
  store i64 %242, i64* %XAX, !mcsema_real_eip !35
  %RBP_val.109 = load i64, i64* %XBP, !mcsema_real_eip !36
  %243 = add i64 %RBP_val.109, -92, !mcsema_real_eip !36
  ...
  %245 = ptrtoint i64* %244 to i64, !mcsema_real_eip !36
  %246 = inttoptr i64 %245 to i32*, !mcsema_real_eip !36
  store i32 %EAX_val.111, i32* %246, !mcsema_real_eip !36
...
block_0x1d1:                                      ; preds = %block_0x1a8
  ...
  %247 = add i64 %RBP_val.37, -64, !mcsema_real_eip !39
  %248 = inttoptr i64 %247 to i64*, !mcsema_real_eip !39
  %249 = ptrtoint i64* %248 to i64, !mcsema_real_eip !39
  store i64 %249, i64* %XCX, !mcsema_real_eip !39
  %RBP_val.38 = load i64, i64* %XBP, !mcsema_real_eip !40
  %250 = add i64 %RBP_val.38, -24, !mcsema_real_eip !40
  %251 = inttoptr i64 %250 to i64*, !mcsema_real_eip !40
  %252 = ptrtoint i64* %251 to i64, !mcsema_real_eip !40
  %253 = inttoptr i64 %252 to i32*, !mcsema_real_eip !40
  %254 = load i32, i32* %253, !mcsema_real_eip !40
  %255 = zext i32 %254 to i64, !mcsema_real_eip !40
  store i64 %255, i64* %XDI, !mcsema_real_eip !40
  %RBP_val.39 = load i64, i64* %XBP, !mcsema_real_eip !41
  %256 = add i64 %RBP_val.39, -80, !mcsema_real_eip !41
  %257 = inttoptr i64 %256 to i64*, !mcsema_real_eip !41
  %258 = load i64, i64* %257, !mcsema_real_eip !41
  store i64 %258, i64* %XDX, !mcsema_real_eip !41
  %RBP_val.40 = load i64, i64* %XBP, !mcsema_real_eip !42
  %259 = add i64 %RBP_val.40, -88, !mcsema_real_eip !42
  %260 = inttoptr i64 %259 to i64*, !mcsema_real_eip !42
  %261 = load i64, i64* %260, !mcsema_real_eip !42
  store i64 %261, i64* %XSI, !mcsema_real_eip !42
  %RBP_val.41 = load i64, i64* %XBP, !mcsema_real_eip !43
  %262 = add i64 %RBP_val.41, -24, !mcsema_real_eip !43
  %263 = inttoptr i64 %262 to i64*, !mcsema_real_eip !43
  %264 = ptrtoint i64* %263 to i64, !mcsema_real_eip !43
  %265 = inttoptr i64 %264 to i32*, !mcsema_real_eip !43
  %266 = load i32, i32* %265, !mcsema_real_eip !43
  %267 = zext i32 %266 to i64, !mcsema_real_eip !43
  store i64 %267, i64* %R8, !mcsema_real_eip !43
  %RBP_val.42 = load i64, i64* %XBP, !mcsema_real_eip !44
  %268 = add i64 %RBP_val.42, -80, !mcsema_real_eip !44
  %269 = inttoptr i64 %268 to i64*, !mcsema_real_eip !44
  %270 = load i64, i64* %269, !mcsema_real_eip !44
  store i64 %270, i64* %R9, !mcsema_real_eip !44
  %RBP_val.43 = load i64, i64* %XBP, !mcsema_real_eip !45
  %271 = add i64 %RBP_val.43, -88, !mcsema_real_eip !45
  %272 = inttoptr i64 %271 to i64*, !mcsema_real_eip !45
  %273 = load i64, i64* %272, !mcsema_real_eip !45
  store i64 %273, i64* %R10, !mcsema_real_eip !45
  %RBP_val.44 = load i64, i64* %XBP, !mcsema_real_eip !46
  %274 = add i64 %RBP_val.44, -104, !mcsema_real_eip !46
  %275 = inttoptr i64 %274 to i64*, !mcsema_real_eip !46
  %RSI_val.45 = load i64, i64* %XSI, !mcsema_real_eip !46
  store i64 %RSI_val.45, i64* %275, !mcsema_real_eip !46
  ...
  %276 = add i64 %RBP_val.47, -104, !mcsema_real_eip !48
  %277 = inttoptr i64 %276 to i64*, !mcsema_real_eip !48
  %278 = load i64, i64* %277, !mcsema_real_eip !48
  store i64 %278, i64* %R11, !mcsema_real_eip !48
  %RBP_val.48 = load i64, i64* %XBP, !mcsema_real_eip !49
  %279 = add i64 %RBP_val.48, -112, !mcsema_real_eip !49
  %280 = inttoptr i64 %279 to i64*, !mcsema_real_eip !49
  %RCX_val.49 = load i64, i64* %XCX, !mcsema_real_eip !49
  store i64 %RCX_val.49, i64* %280, !mcsema_real_eip !49
  ...
  %281 = add i64 %RBP_val.51, -116, !mcsema_real_eip !51
  %282 = inttoptr i64 %281 to i64*, !mcsema_real_eip !51
  %R8D.52 = bitcast i64* %R8 to i32*, !mcsema_real_eip !51
  %R8D_val.53 = load i32, i32* %R8D.52, !mcsema_real_eip !51
  %283 = ptrtoint i64* %282 to i64, !mcsema_real_eip !51
  %284 = inttoptr i64 %283 to i32*, !mcsema_real_eip !51
  store i32 %R8D_val.53, i32* %284, !mcsema_real_eip !51
  %EAX.54 = bitcast i64* %XAX to i32*, !mcsema_real_eip !52
  %EAX_val.55 = load i32, i32* %EAX.54, !mcsema_real_eip !52
  %285 = zext i32 %EAX_val.55 to i64, !mcsema_real_eip !52
  store i64 %285, i64* %R8, !mcsema_real_eip !52
  %RBP_val.56 = load i64, i64* %XBP, !mcsema_real_eip !53
  %286 = add i64 %RBP_val.56, -128, !mcsema_real_eip !53
  %287 = inttoptr i64 %286 to i64*, !mcsema_real_eip !53
  %R9_val.57 = load i64, i64* %R9, !mcsema_real_eip !53
  store i64 %R9_val.57, i64* %287, !mcsema_real_eip !53
  %EAX.58 = bitcast i64* %XAX to i32*, !mcsema_real_eip !54
  %EAX_val.59 = load i32, i32* %EAX.58, !mcsema_real_eip !54
  %288 = zext i32 %EAX_val.59 to i64, !mcsema_real_eip !54
  store i64 %288, i64* %R9, !mcsema_real_eip !54
  %RBP_val.60 = load i64, i64* %XBP, !mcsema_real_eip !55
  %289 = add i64 %RBP_val.60, -116, !mcsema_real_eip !55
  ...
  %293 = load i32, i32* %292, !mcsema_real_eip !55
  %294 = zext i32 %293 to i64, !mcsema_real_eip !55
  store i64 %294, i64* %XAX, !mcsema_real_eip !55
  %RSP_val.61 = load i64, i64* %XSP, !mcsema_real_eip !56
  %295 = add i64 %RSP_val.61, 0, !mcsema_real_eip !56
  %296 = inttoptr i64 %295 to i64*, !mcsema_real_eip !56
  %EAX.62 = bitcast i64* %XAX to i32*, !mcsema_real_eip !56
  %EAX_val.63 = load i32, i32* %EAX.62, !mcsema_real_eip !56
  %297 = ptrtoint i64* %296 to i64, !mcsema_real_eip !56
  %298 = inttoptr i64 %297 to i32*, !mcsema_real_eip !56
  store i32 %EAX_val.63, i32* %298, !mcsema_real_eip !56
  %RBP_val.64 = load i64, i64* %XBP, !mcsema_real_eip !57
  %299 = add i64 %RBP_val.64, -112, !mcsema_real_eip !57
  %300 = inttoptr i64 %299 to i64*, !mcsema_real_eip !57
  %301 = load i64, i64* %300, !mcsema_real_eip !57
  store i64 %301, i64* %XBX, !mcsema_real_eip !57
  %RSP_val.65 = load i64, i64* %XSP, !mcsema_real_eip !58
  %302 = add i64 %RSP_val.65, 8, !mcsema_real_eip !58
  %303 = inttoptr i64 %302 to i64*, !mcsema_real_eip !58
  %RBX_val.66 = load i64, i64* %XBX, !mcsema_real_eip !58
  store i64 %RBX_val.66, i64* %303, !mcsema_real_eip !58
  %RBP_val.67 = load i64, i64* %XBP, !mcsema_real_eip !59
  %304 = add i64 %RBP_val.67, -128, !mcsema_real_eip !59
  %305 = inttoptr i64 %304 to i64*, !mcsema_real_eip !59
  %306 = load i64, i64* %305, !mcsema_real_eip !59
  store i64 %306, i64* %R14, !mcsema_real_eip !59
  %RSP_val.68 = load i64, i64* %XSP, !mcsema_real_eip !60
  %307 = add i64 %RSP_val.68, 16, !mcsema_real_eip !60
  %308 = inttoptr i64 %307 to i64*, !mcsema_real_eip !60
  %R14_val.69 = load i64, i64* %R14, !mcsema_real_eip !60
  store i64 %R14_val.69, i64* %308, !mcsema_real_eip !60
  %RSP_val.70 = load i64, i64* %XSP, !mcsema_real_eip !61
  %309 = add i64 %RSP_val.70, 24, !mcsema_real_eip !61
  %310 = inttoptr i64 %309 to i64*, !mcsema_real_eip !61
  %R10_val.71 = load i64, i64* %R10, !mcsema_real_eip !61
  store i64 %R10_val.71, i64* %310, !mcsema_real_eip !61
  %RSP_val.72 = load i64, i64* %XSP, !mcsema_real_eip !62
  %311 = sub i64 %RSP_val.72, 8, !mcsema_real_eip !62
  %312 = inttoptr i64 %311 to i64*, !mcsema_real_eip !62
  store i64 -4981261766360305936, i64* %312, !mcsema_real_eip !62
  store i64 %311, i64* %XSP, !mcsema_real_eip !62
  ...
  %313 = add i64 %RBP_val.73, -96, !mcsema_real_eip !64
  %314 = inttoptr i64 %313 to i64*, !mcsema_real_eip !64
  %EAX.74 = bitcast i64* %XAX to i32*, !mcsema_real_eip !64
  %EAX_val.75 = load i32, i32* %EAX.74, !mcsema_real_eip !64
  %315 = ptrtoint i64* %314 to i64, !mcsema_real_eip !64
  %316 = inttoptr i64 %315 to i32*, !mcsema_real_eip !64
  store i32 %EAX_val.75, i32* %316, !mcsema_real_eip !64
  %RBP_val.76 = load i64, i64* %XBP, !mcsema_real_eip !65
  %317 = add i64 %RBP_val.76, -96, !mcsema_real_eip !65
  %318 = inttoptr i64 %317 to i64*, !mcsema_real_eip !65
  %319 = ptrtoint i64* %318 to i64, !mcsema_real_eip !65
  %320 = inttoptr i64 %319 to i32*, !mcsema_real_eip !65
  %321 = load i32, i32* %320, !mcsema_real_eip !65
  %322 = zext i32 %321 to i64, !mcsema_real_eip !65
  store i64 %322, i64* %XSI, !mcsema_real_eip !65
  ...
  %323 = inttoptr i64 %RSP_val.84 to i64*, !mcsema_real_eip !67
  %324 = load i64, i64* %323, !mcsema_real_eip !67
  %325 = add i64 %RSP_val.84, 8, !mcsema_real_eip !67
  %326 = inttoptr i64 %325 to i64*, !mcsema_real_eip !67
  %327 = load i64, i64* %326, !mcsema_real_eip !67
  %328 = add i64 %325, 8, !mcsema_real_eip !67
  %329 = inttoptr i64 %328 to i64*, !mcsema_real_eip !67
  %330 = load i64, i64* %329, !mcsema_real_eip !67
  %331 = add i64 %328, 8, !mcsema_real_eip !67
  %332 = inttoptr i64 %331 to i64*, !mcsema_real_eip !67
  %333 = load i64, i64* %332, !mcsema_real_eip !67
  %334 = add i64 %331, 8, !mcsema_real_eip !67
  %335 = inttoptr i64 %334 to i64*, !mcsema_real_eip !67
  %336 = load i64, i64* %335, !mcsema_real_eip !67
  %337 = add i64 %334, 8, !mcsema_real_eip !67
  %338 = inttoptr i64 %337 to i64*, !mcsema_real_eip !67
  %339 = load i64, i64* %338, !mcsema_real_eip !67
  %RSP_val.85 = load i64, i64* %XSP, !mcsema_real_eip !67
  %340 = sub i64 %RSP_val.85, 8, !mcsema_real_eip !67
  %341 = inttoptr i64 %340 to i64*, !mcsema_real_eip !67
  store i64 -2415393069852865332, i64* %341, !mcsema_real_eip !67
  store i64 %340, i64* %XSP, !mcsema_real_eip !67
  %342 = call x86_64_sysvcc i64 @_printf(i64 %RDI_val.78, i64 %RSI_val.79, i64 %RDX_val.80, i64 %RCX_val.81, i64 %R8_val.82, i64 %R9_val.83, i64 %324, i64 %327, i64 %330, i64 %333, i64 %336, i64 %339), !mcsema_real_eip !67
  store i64 %342, i64* %XAX, !mcsema_real_eip !67
  %RBP_val.86 = load i64, i64* %XBP, !mcsema_real_eip !68
  %343 = add i64 %RBP_val.86, -96, !mcsema_real_eip !68
  %344 = inttoptr i64 %343 to i64*, !mcsema_real_eip !68
  %345 = ptrtoint i64* %344 to i64, !mcsema_real_eip !68
  %346 = inttoptr i64 %345 to i32*, !mcsema_real_eip !68
  %347 = load i32, i32* %346, !mcsema_real_eip !68
  %348 = zext i32 %347 to i64, !mcsema_real_eip !68
  store i64 %348, i64* %XSI, !mcsema_real_eip !68
  %RBP_val.87 = load i64, i64* %XBP, !mcsema_real_eip !69
  %349 = add i64 %RBP_val.87, -132, !mcsema_real_eip !69
  %350 = inttoptr i64 %349 to i64*, !mcsema_real_eip !69
  %EAX.88 = bitcast i64* %XAX to i32*, !mcsema_real_eip !69
  %EAX_val.89 = load i32, i32* %EAX.88, !mcsema_real_eip !69
  %351 = ptrtoint i64* %350 to i64, !mcsema_real_eip !69
  %352 = inttoptr i64 %351 to i32*, !mcsema_real_eip !69
  store i32 %EAX_val.89, i32* %352, !mcsema_real_eip !69
  %ESI.90 = bitcast i64* %XSI to i32*, !mcsema_real_eip !70
  %ESI_val.91 = load i32, i32* %ESI.90, !mcsema_real_eip !70
  %353 = zext i32 %ESI_val.91 to i64, !mcsema_real_eip !70
  store i64 %353, i64* %XAX, !mcsema_real_eip !70
  %RSP_val.92 = load i64, i64* %XSP, !mcsema_real_eip !71
  %354 = add i64 160, %RSP_val.92, !mcsema_real_eip !71
  %355 = xor i64 %354, %RSP_val.92, !mcsema_real_eip !71
  %356 = xor i64 %355, 160, !mcsema_real_eip !71
  %357 = and i64 %356, 16, !mcsema_real_eip !71
  %358 = icmp ne i64 %357, 0, !mcsema_real_eip !71
  store i1 %358, i1* %AF, !mcsema_real_eip !71
  %359 = lshr i64 %354, 63, !mcsema_real_eip !71
  %360 = trunc i64 %359 to i1, !mcsema_real_eip !71
  store i1 %360, i1* %SF, !mcsema_real_eip !71
  %361 = icmp eq i64 %354, 0, !mcsema_real_eip !71
  store i1 %361, i1* %ZF, !mcsema_real_eip !71
  %362 = xor i64 %RSP_val.92, 160, !mcsema_real_eip !71
  %363 = xor i64 %362, -1, !mcsema_real_eip !71
  %364 = xor i64 %RSP_val.92, %354, !mcsema_real_eip !71
  %365 = and i64 %363, %364, !mcsema_real_eip !71
  %366 = lshr i64 %365, 63, !mcsema_real_eip !71
  %367 = and i64 %366, 1, !mcsema_real_eip !71
  %368 = trunc i64 %367 to i1, !mcsema_real_eip !71
  store i1 %368, i1* %OF, !mcsema_real_eip !71
  %369 = trunc i64 %354 to i8, !mcsema_real_eip !71
  %370 = call i8 @llvm.ctpop.i8(i8 %369), !mcsema_real_eip !71
  %371 = trunc i8 %370 to i1, !mcsema_real_eip !71
  %372 = xor i1 %371, true, !mcsema_real_eip !71
  store i1 %372, i1* %PF, !mcsema_real_eip !71
  %373 = icmp ult i64 %354, %RSP_val.92, !mcsema_real_eip !71
  store i1 %373, i1* %CF, !mcsema_real_eip !71
  store i64 %354, i64* %XSP, !mcsema_real_eip !71
  %RSP_val.93 = load i64, i64* %XSP, !mcsema_real_eip !72
  %374 = inttoptr i64 %RSP_val.93 to i64*, !mcsema_real_eip !72
  %375 = load i64, i64* %374, !mcsema_real_eip !72
  store i64 %375, i64* %XBX, !mcsema_real_eip !72
  %376 = add i64 %RSP_val.93, 8, !mcsema_real_eip !72
  store i64 %376, i64* %XSP, !mcsema_real_eip !72
  %RSP_val.94 = load i64, i64* %XSP, !mcsema_real_eip !73
  %377 = inttoptr i64 %RSP_val.94 to i64*, !mcsema_real_eip !73
  %378 = load i64, i64* %377, !mcsema_real_eip !73
  store i64 %378, i64* %R14, !mcsema_real_eip !73
  %379 = add i64 %RSP_val.94, 8, !mcsema_real_eip !73
  store i64 %379, i64* %XSP, !mcsema_real_eip !73
  %RSP_val.95 = load i64, i64* %XSP, !mcsema_real_eip !74
  %380 = inttoptr i64 %RSP_val.95 to i64*, !mcsema_real_eip !74
  %381 = load i64, i64* %380, !mcsema_real_eip !74
  store i64 %381, i64* %XBP, !mcsema_real_eip !74
  %382 = add i64 %RSP_val.95, 8, !mcsema_real_eip !74
  store i64 %382, i64* %XSP, !mcsema_real_eip !74
  %RSP_val.96 = load i64, i64* %XSP, !mcsema_real_eip !75
  %383 = add i64 %RSP_val.96, 8, !mcsema_real_eip !75
  %384 = inttoptr i64 %RSP_val.96 to i64*, !mcsema_real_eip !75
  %385 = load i64, i64* %384, !mcsema_real_eip !75
  store i64 %385, i64* %XIP, !mcsema_real_eip !75
  store i64 %383, i64* %XSP, !mcsema_real_eip !75
