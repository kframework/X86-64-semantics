...
entry:
  ...
  %_new_gep_17 = getelementptr i8, i8* %_load_rbp_ptr_16, i64 -32
...
block_0x27:                                       ; preds = %entry
  ...
  %132 = bitcast i64* %_allin_new_bt_24 to i32*
...
block_0x32:                                       ; preds = %entry
  ...
  %141 = load i64, i64* %_allin_new_bt_29, !mcsema_real_eip !12
  ...
  %162 = load i64, i64* %_allin_new_bt_35, !mcsema_real_eip !18
...
block_0x53:                                       ; preds = %block_0x32
  %_new_gep_37 = getelementptr i8, i8* %_load_rbp_ptr_36, i64 -4
...
block_0x46d:                                      ; preds = %block_0x467, %block_0x37e, %block_0x32d, %block_0x309, %block_0x1fa, %block_0x127, %block_0xdb, %block_0xa4, %block_0x77, %block_0x53, %block_0x27
  ...
  %214 = bitcast i64* %_allin_new_bt_44 to i32*
  ...
  %219 = xor i64 %218, %_new_ptr2int_46, !mcsema_real_eip !31
  %220 = and i64 %219, 16
  ...
  %224 = xor i64 %_new_ptr2int_46, -9223372036854775808, !mcsema_real_eip !31
  ...
  %_new_int2ptr_ = inttoptr i64 %218 to i8*
  ...
  %_new_int2ptr_47 = inttoptr i64 %233 to i8*
  ...
  %_new_int2ptr_48 = inttoptr i64 %234 to i8*
...
block_0x77:                                       ; preds = %block_0x5f
  %_new_gep_53 = getelementptr i8, i8* %_load_rbp_ptr_41, i64 -4
...
block_0x83:                                       ; preds = %block_0x5f
  ...
  %311 = load i64, i64* %_allin_new_bt_56, !mcsema_real_eip !29
  ...
  %_new_gep_58 = getelementptr i8, i8* %_load_rbp_ptr_57, i64 -24
  ...
  %322 = bitcast i64* %_allin_new_bt_59 to i32*
  ...
  %326 = bitcast i64* %_allin_new_bt_62 to i32*
...
block_0xa4:                                       ; preds = %block_0x83
  %_new_gep_64 = getelementptr i8, i8* %_load_rbp_ptr_63, i64 -4
...
block_0xb0:                                       ; preds = %block_0x83
  ...
  %350 = load i64, i64* %_allin_new_bt_67, !mcsema_real_eip !43
  ...
  %_new_gep_69 = getelementptr i8, i8* %_load_rbp_ptr_68, i64 -28
  ...
  %361 = bitcast i64* %_allin_new_bt_70 to i32*
  ...
  %365 = bitcast i64* %_allin_new_bt_73 to i32*
...
block_0xdb:                                       ; preds = %block_0xb0
  %_new_gep_75 = getelementptr i8, i8* %_load_rbp_ptr_74, i64 -4
...
block_0xe7:                                       ; preds = %block_0xb0
  ...
  %399 = load i64, i64* %_allin_new_bt_78, !mcsema_real_eip !55
...
block_0x101:                                      ; preds = %block_0xe7
  ...
  %_new_gep_80 = getelementptr i8, i8* %_load_rbp_ptr_79, i64 -16
  ...
  %419 = load i64, i64* %_allin_new_bt_81, !mcsema_real_eip !62
...
block_0x127:                                      ; preds = %block_0x101, %block_0xe7
  ...
  %_new_gep_83 = getelementptr i8, i8* %_load_rbp_ptr_82, i64 -4
  ...
  %441 = bitcast i64* %_allin_new_bt_84 to i32*
...
block_0x11b:                                      ; preds = %block_0x101
  ...
  %_new_gep_86 = getelementptr i8, i8* %_load_rbp_ptr_85, i64 -20
  ...
  %445 = bitcast i64* %_allin_new_bt_87 to i32*
  ...
  %449 = load i64, i64* %_allin_new_bt_90, !mcsema_real_eip !70
  ...
  %_new_gep_92 = getelementptr i8, i8* %_load_rbp_ptr_91, i64 -33
  ...
  %468 = bitcast i64* %_allin_new_bt_93 to i8*
  ...
  %472 = load i64, i64* %_allin_new_bt_96, !mcsema_real_eip !75
  ...
  %_new_gep_98 = getelementptr i8, i8* %_load_rbp_ptr_97, i64 -34
  ...
  %491 = bitcast i64* %_allin_new_bt_99 to i8*
  ...
  %495 = bitcast i64* %_allin_new_bt_102 to i8*
...
block_0x169:                                      ; preds = %block_0x11b
  ...
  %_new_gep_104 = getelementptr i8, i8* %_load_rbp_ptr_103, i64 -34
  ...
  %513 = bitcast i64* %_allin_new_bt_105 to i8*
...
block_0x188:                                      ; preds = %block_0x169, %block_0x11b
  ...
  %_new_gep_107 = getelementptr i8, i8* %_load_rbp_ptr_106, i64 -20
  ...
  %531 = bitcast i64* %_allin_new_bt_108 to i32*
  ...
  %551 = bitcast i64* %_allin_new_bt_111 to i32*
...
block_0x193:                                      ; preds = %block_0x178, %block_0x188
  ...
  %555 = load i64, i64* %_allin_new_bt_114, !mcsema_real_eip !89
  ...
  %_new_gep_116 = getelementptr i8, i8* %_load_rbp_ptr_115, i64 -35
  ...
  %570 = bitcast i64* %_allin_new_bt_117 to i8*
  ...
  %574 = load i64, i64* %_allin_new_bt_120, !mcsema_real_eip !94
  ...
  %_new_gep_122 = getelementptr i8, i8* %_load_rbp_ptr_121, i64 -35
  ...
  %584 = bitcast i64* %_allin_new_bt_123 to i8*
  ...
  %_new_gep_125 = getelementptr i8, i8* %_load_rbp_ptr_124, i64 -35
  ...
  %604 = bitcast i64* %_allin_new_bt_126 to i8*
  ...
  %_new_gep_128 = getelementptr i8, i8* %_load_rbp_ptr_127, i64 -35
  ...
  %608 = bitcast i64* %_allin_new_bt_129 to i8*
  ...
  %626 = bitcast i64* %_allin_new_bt_132 to i32*
  ...
  %_new_gep_134 = getelementptr i8, i8* %_load_rbp_ptr_133, i64 -20
  ...
  %632 = bitcast i64* %_allin_new_bt_135 to i32*
  ...
  %_new_gep_137 = getelementptr i8, i8* %_load_rbp_ptr_136, i64 -20
  ...
  %664 = bitcast i64* %_allin_new_bt_138 to i32*
  ...
  %668 = bitcast i64* %_allin_new_bt_141 to i32*
...
block_0x178:                                      ; preds = %block_0x169
  ...
  %_new_gep_143 = getelementptr i8, i8* %_load_rbp_ptr_142, i64 -20
  ...
  %679 = bitcast i64* %_allin_new_bt_144 to i32*
  ...
  %_new_gep_146 = getelementptr i8, i8* %_load_rbp_ptr_145, i64 -20
  ...
  %699 = bitcast i64* %_allin_new_bt_147 to i32*
...
block_0x1fa:                                      ; preds = %block_0x193
  ...
  %_new_gep_149 = getelementptr i8, i8* %_load_rbp_ptr_148, i64 -4
  ...
  %703 = bitcast i64* %_allin_new_bt_150 to i32*
...
block_0x206:                                      ; preds = %block_0x193
  ...
  %_new_gep_152 = getelementptr i8, i8* %_load_rbp_ptr_151, i64 -16
  ...
  %707 = load i64, i64* %_allin_new_bt_153, !mcsema_real_eip !118
  ...
  %_new_gep_155 = getelementptr i8, i8* %_load_rbp_ptr_154, i64 -38
  ...
  %733 = bitcast i64* %_allin_new_bt_156 to i16*
  ...
  %737 = bitcast i64* %_allin_new_bt_159 to i16*
...
block_0x23d:                                      ; preds = %block_0x206
  ...
  %_new_gep_161 = getelementptr i8, i8* %_load_rbp_ptr_160, i64 -38
  ...
  %755 = bitcast i64* %_allin_new_bt_162 to i16*
...
block_0x25d:                                      ; preds = %block_0x23d, %block_0x206
  ...
  %_new_gep_164 = getelementptr i8, i8* %_load_rbp_ptr_163, i64 -20
  ...
  %774 = bitcast i64* %_allin_new_bt_165 to i32*
...
block_0x264:                                      ; preds = %block_0x251, %block_0x25d
  ...
  %778 = load i64, i64* %_allin_new_bt_168, !mcsema_real_eip !135
  ...
  %_new_gep_170 = getelementptr i8, i8* %_load_rbp_ptr_169, i64 -44
  ...
  %800 = bitcast i64* %_allin_new_bt_171 to i32*
  ...
  %804 = bitcast i64* %_allin_new_bt_174 to i32*
  ...
  %_new_gep_176 = getelementptr i8, i8* %_load_rbp_ptr_175, i64 -48
  ...
  %817 = bitcast i64* %_allin_new_bt_177 to i32*
  ...
  %821 = bitcast i64* %_allin_new_bt_180 to i32*
  ...
  %_new_gep_182 = getelementptr i8, i8* %_load_rbp_ptr_181, i64 -52
  ...
  %835 = bitcast i64* %_allin_new_bt_183 to i32*
  ...
  %839 = bitcast i64* %_allin_new_bt_186 to i32*
  ...
  %_new_gep_188 = getelementptr i8, i8* %_load_rbp_ptr_187, i64 -56
  ...
  %851 = bitcast i64* %_allin_new_bt_189 to i32*
  ...
  %855 = bitcast i64* %_allin_new_bt_192 to i32*
...
block_0x251:                                      ; preds = %block_0x23d
  ...
  %_new_gep_194 = getelementptr i8, i8* %_load_rbp_ptr_193, i64 -20
  ...
  %874 = bitcast i64* %_allin_new_bt_195 to i32*
...
block_0x2af:                                      ; preds = %block_0x264
  ...
  %_new_gep_197 = getelementptr i8, i8* %_load_rbp_ptr_196, i64 -56
  ...
  %878 = bitcast i64* %_allin_new_bt_198 to i32*
  ...
  %_new_gep_200 = getelementptr i8, i8* %_load_rbp_ptr_199, i64 -20
  ...
  %884 = bitcast i64* %_allin_new_bt_201 to i32*
...
block_0x2c7:                                      ; preds = %block_0x2af, %block_0x264
  ...
  %_new_gep_203 = getelementptr i8, i8* %_load_rbp_ptr_202, i64 -20
  ...
  %905 = bitcast i64* %_allin_new_bt_204 to i32*
...
block_0x2ce:                                      ; preds = %block_0x2bb, %block_0x2c7
  ...
  %909 = bitcast i64* %_allin_new_bt_207 to i32*
  ...
  %_new_gep_209 = getelementptr i8, i8* %_load_rbp_ptr_208, i64 -16
  ...
  %915 = load i64, i64* %_allin_new_bt_210, !mcsema_real_eip !159
  ...
  %_load_rbp_ptr_211 = load i8*, i8** %_RBP_ptr_
  %933 = load i64, i64* %RBP_val, !mcsema_real_eip !163
  %_new_gep_212 = getelementptr i8, i8* %_load_rbp_ptr_211, i64 -60
  ...
  %937 = bitcast i64* %_allin_new_bt_213 to i32*
  ...
  %941 = bitcast i64* %_allin_new_bt_216 to i32*
  ...
  %_new_gep_218 = getelementptr i8, i8* %_load_rbp_ptr_217, i64 -60
  ...
  %960 = bitcast i64* %_allin_new_bt_219 to i32*
  ...
  %964 = bitcast i64* %_allin_new_bt_222 to i32*
...
block_0x2bb:                                      ; preds = %block_0x2af
  ...
  %_new_gep_225 = getelementptr i8, i8* %_load_rbp_ptr_224, i64 -20
...
block_0x315:                                      ; preds = %block_0x2ce
  ...
  %983 = bitcast i64* %_allin_new_bt_230 to i32*
  ...
  %_new_gep_232 = getelementptr i8, i8* %_load_rbp_ptr_231, i64 -60
  ...
  %996 = bitcast i64* %_allin_new_bt_233 to i32*
  ...
  %1000 = bitcast i64* %_allin_new_bt_236 to i32*
...
block_0x32d:                                      ; preds = %block_0x315
  ...
  %_new_gep_238 = getelementptr i8, i8* %_load_rbp_ptr_237, i64 -4
  ...
  %1020 = bitcast i64* %_allin_new_bt_239 to i32*
...
block_0x339:                                      ; preds = %block_0x315
  ...
  %_new_gep_241 = getelementptr i8, i8* %_load_rbp_ptr_240, i64 -60
  ...
  %1024 = bitcast i64* %_allin_new_bt_242 to i32*
  ...
  %1037 = bitcast i64* %_allin_new_bt_245 to i32*
  ...
  %1041 = bitcast i64* %_allin_new_bt_248 to i32*
  ...
  %1055 = bitcast i64* %_allin_new_bt_251 to i32*
  ...
  %1059 = bitcast i64* %_allin_new_bt_254 to i32*
  ...
  %_new_gep_256 = getelementptr i8, i8* %_load_rbp_ptr_255, i64 -60
  ...
  %1078 = bitcast i64* %_allin_new_bt_257 to i32*
  ...
  %1082 = bitcast i64* %_allin_new_bt_260 to i32*
  ...
  %_new_gep_262 = getelementptr i8, i8* %_load_rbp_ptr_261, i64 -68
  ...
  %1090 = bitcast i64* %_allin_new_bt_263 to i32*
  ...
  %1096 = bitcast i64* %_allin_new_bt_266 to i32*
  ...
  %_new_gep_268 = getelementptr i8, i8* %_load_rbp_ptr_267, i64 -60
  ...
  %1112 = bitcast i64* %_allin_new_bt_269 to i32*
  ...
  %1116 = bitcast i64* %_allin_new_bt_272 to i32*
...
block_0x37e:                                      ; preds = %block_0x339
  ...
  %1135 = bitcast i64* %_allin_new_bt_275 to i32*
  ...
  %_new_gep_277 = getelementptr i8, i8* %_load_rbp_ptr_276, i64 -4
  ...
  %1141 = bitcast i64* %_allin_new_bt_278 to i32*
...
block_0x389:                                      ; preds = %block_0x339
  ...
  %_new_gep_280 = getelementptr i8, i8* %_load_rbp_ptr_279, i64 -20
  ...
  %1145 = bitcast i64* %_allin_new_bt_281 to i32*
  ...
  %_new_gep_283 = getelementptr i8, i8* %_load_rbp_ptr_282, i64 -16
  ...
  %1151 = load i64, i64* %_allin_new_bt_284, !mcsema_real_eip !206
  ...
  %_new_gep_286 = getelementptr i8, i8* %_load_rbp_ptr_285, i64 -64
  ...
  %1173 = bitcast i64* %_allin_new_bt_287 to i32*
  ...
  %1177 = load i64, i64* %_allin_new_bt_290, !mcsema_real_eip !211
...
block_0x3b9:                                      ; preds = %block_0x389
  ...
  %_new_gep_292 = getelementptr i8, i8* %_load_rbp_ptr_291, i64 -16
  ...
  %1201 = load i64, i64* %_allin_new_bt_293, !mcsema_real_eip !215
...
block_0x3dd:                                      ; preds = %block_0x3b9, %block_0x389
  ...
  %_new_gep_295 = getelementptr i8, i8* %_load_rbp_ptr_294, i64 -16
  ...
  %1225 = load i64, i64* %_allin_new_bt_296, !mcsema_real_eip !219
  ...
  %_new_gep_298 = getelementptr i8, i8* %_load_rbp_ptr_297, i64 -16
  ...
  %1235 = load i64, i64* %_allin_new_bt_299, !mcsema_real_eip !221
...
block_0x3f5:                                      ; preds = %block_0x3dd
  ...
  %_new_gep_301 = getelementptr i8, i8* %_load_rbp_ptr_300, i64 -16
  ...
  %1263 = load i64, i64* %_allin_new_bt_302, !mcsema_real_eip !226
  ...
  %_new_gep_304 = getelementptr i8, i8* %_load_rbp_ptr_303, i64 -16
  ...
  %1273 = load i64, i64* %_allin_new_bt_305, !mcsema_real_eip !228
  ...
  %_new_gep_307 = getelementptr i8, i8* %_load_rbp_ptr_306, i64 -20
  ...
  %1305 = bitcast i64* %_allin_new_bt_308 to i32*
  ...
  %_new_gep_310 = getelementptr i8, i8* %_load_rbp_ptr_309, i64 -20
  ...
  %1327 = bitcast i64* %_allin_new_bt_311 to i32*
  ...
  %1331 = load i64, i64* %_allin_new_bt_314, !mcsema_real_eip !235
  ...
  %_new_gep_316 = getelementptr i8, i8* %_load_rbp_ptr_315, i64 -20
  ...
  %1341 = bitcast i64* %_allin_new_bt_317 to i32*
  ...
  %_new_gep_319 = getelementptr i8, i8* %_load_rbp_ptr_318, i64 -20
  ...
  %1363 = bitcast i64* %_allin_new_bt_320 to i32*
  ...
  %1367 = bitcast i64* %_allin_new_bt_323 to i32*
...
block_0x45c:                                      ; preds = %block_0x3dd
  ...
  %_new_gep_325 = getelementptr i8, i8* %_load_rbp_ptr_324, i64 -64
  ...
  %1378 = bitcast i64* %_allin_new_bt_326 to i32*
  ...
  %_new_gep_328 = getelementptr i8, i8* %_load_rbp_ptr_327, i64 -20
  ...
  %1384 = bitcast i64* %_allin_new_bt_329 to i32*
...
block_0x3cd:                                      ; preds = %block_0x3b9
  ...
  %_new_gep_331 = getelementptr i8, i8* %_load_rbp_ptr_330, i64 -64
  ...
  %1388 = bitcast i64* %_allin_new_bt_332 to i32*
  ...
  %_new_gep_334 = getelementptr i8, i8* %_load_rbp_ptr_333, i64 -20
  ...
  %1394 = bitcast i64* %_allin_new_bt_335 to i32*
  ...
  %_new_gep_337 = getelementptr i8, i8* %_load_rbp_ptr_336, i64 -20
  ...
  %1407 = bitcast i64* %_allin_new_bt_338 to i32*
...
block_0x438:                                      ; preds = %block_0x3f5
  ...
  %1411 = load i64, i64* %_allin_new_bt_341, !mcsema_real_eip !250
...
block_0x467:                                      ; preds = %block_0x450, %block_0x438, %block_0x3cd, %block_0x45c, %block_0x3f5
  ...
  %1436 = bitcast i64* %_allin_new_bt_344 to i32*
  ...
  %1442 = bitcast i64* %_allin_new_bt_347 to i32*
...
block_0x450:                                      ; preds = %block_0x438
  ...
  %_new_gep_349 = getelementptr i8, i8* %_load_rbp_ptr_348, i64 -20
  ...
  %1446 = bitcast i64* %_allin_new_bt_350 to i32*
