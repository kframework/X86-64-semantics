...
driverBlockRaw:
  ...
  %_local_stack_start_ptr_7.i = alloca [24 x i8], align 1
  ...
  %1 = getelementptr inbounds [24 x i8], [24 x i8]* %_local_stack_start_ptr_7.i, i64 0, i64 0
  call void @llvm.lifetime.start(i64 24, i8* nonnull %1)
  %STi_val.i.0..sroa_cast = bitcast [8 x x86_fp80]* %STi_val.i to i8*
  call void @llvm.lifetime.start(i64 128, i8* nonnull %STi_val.i.0..sroa_cast)
  %_local_stack_end_ptr_.i = getelementptr inbounds [24 x i8], [24 x i8]* %_local_stack_start_ptr_7.i, i64 0, i64 24
  ...
  %66 = bitcast i64* %_RSP_ptr_.sroa.0.i to i8**
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_12.i4 = load i8*, i8** %66, align 8
  %_new_gep_.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_12.i4, i64 -8
  ...
  %_new_gep_1.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_12.i4, i64 -24
  %68 = ptrtoint i8* %_new_gep_1.i to i64
  store volatile i64 %68, i64* %_RSP_ptr_.sroa.0.i, align 8
  %_new_gep_2.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_12.i4, i64 -12
  %69 = bitcast i8* %_new_gep_2.i to i32*
  store i32 0, i32* %69, align 4, !mcsema_real_eip !3
  %70 = tail call x86_64_sysvcc i64 @printf(i64 ptrtoint (%0* @data_0x2d to i64)), !mcsema_real_eip !4
  %71 = bitcast i64* %_RBP_ptr_.sroa.0.i to i8**
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_413.i5 = load i8*, i8** %71, align 8
  %_new_gep_5.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_413.i5, i64 -8
  %72 = trunc i64 %70 to i32, !mcsema_real_eip !5
  %73 = bitcast i8* %_new_gep_5.i to i32*
  store i32 %72, i32* %73, align 4, !mcsema_real_eip !5
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_79.i = load i64, i64* %_RSP_ptr_.sroa.0.i, align 8
  %uadd.i = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_79.i, i64 16)
  %74 = extractvalue { i64, i1 } %uadd.i, 0
  %75 = xor i64 %74, %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_79.i, !mcsema_real_eip !6
  %76 = and i64 %75, 16
  %77 = icmp eq i64 %76, 0
  %78 = icmp slt i64 %74, 0
  %79 = icmp eq i64 %74, 0, !mcsema_real_eip !6
  %80 = xor i64 %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_79.i, -9223372036854775808, !mcsema_real_eip !6
  %81 = and i64 %75, %80, !mcsema_real_eip !6
  %82 = icmp slt i64 %81, 0
  %83 = trunc i64 %74 to i8, !mcsema_real_eip !6
  %84 = tail call i8 @llvm.ctpop.i8(i8 %83), !mcsema_real_eip !6
  %85 = and i8 %84, 1
  %86 = icmp eq i8 %85, 0
  %87 = extractvalue { i64, i1 } %uadd.i, 1
  store volatile i64 %74, i64* %_RSP_ptr_.sroa.0.i, align 8
  %88 = inttoptr i64 %74 to i64*, !mcsema_real_eip !7
  ...
  store <2 x i64> %7, <2 x i64>* %92, align 8
  ...
  store i1 %86, i1* %PF.i, align 1, !mcsema_real_eip !8
  store i1 %77, i1* %AF.i, align 1, !mcsema_real_eip !8
  store i1 %79, i1* %ZF.i, align 1, !mcsema_real_eip !8
  store i1 %78, i1* %SF.i, align 1, !mcsema_real_eip !8
  ...
  store <2 x i64> %65, <2 x i64>* %96, align 1
