...
entry:
  ...
  %uadd = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %94, i64 16)
  %95 = extractvalue { i64, i1 } %uadd, 0
  %96 = xor i64 %95, %94, !mcsema_real_eip !11
  %97 = and i64 %96, 16
  %98 = icmp eq i64 %97, 0
  ...
  %101 = xor i64 %94, -9223372036854775808, !mcsema_real_eip !11
  ...
  store i64 %118, i64* %RSP, !mcsema_real_eip !13
  %119 = load i64, i64* %RBP_val, !mcsema_real_eip !13
  store i64 %119, i64* %RBP, !mcsema_real_eip !13
