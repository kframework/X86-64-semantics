...
driverBlockRaw:
  ...
  %71 = extractelement <2 x i64> %5, i32 1
  %72 = trunc i64 %71 to i32, !mcsema_real_eip !3
  %73 = inttoptr i64 %70 to i32*
  store i32 %72, i32* %73, align 4, !mcsema_real_eip !3
  %74 = load i32* bitcast (%0* @data_0x2d to i32*), align 64, !mcsema_real_eip !4
  %75 = add i64 %6, -12, !mcsema_real_eip !5
  %76 = inttoptr i64 %75 to i32*
  store i32 %74, i32* %76, align 4, !mcsema_real_eip !5
  %77 = load i32* bitcast (%0* @data_0x2d to i32*), align 64, !mcsema_real_eip !6
  %78 = zext i32 %77 to i64, !mcsema_real_eip !6
  %79 = load i32* %73, align 4, !mcsema_real_eip !7
  %uadd.i = tail call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %77, i32 %79) #0
  ...
  %92 = tail call i8 @llvm.ctpop.i8(i8 %91) #0, !mcsema_real_eip !8
  %93 = and i8 %92, 1
  %94 = icmp eq i8 %93, 0
  %95 = extractvalue { i32, i1 } %uadd.i, 1
  store i32 %80, i32* bitcast (%0* @data_0x2d to i32*), align 64, !mcsema_real_eip !9
  %96 = load i32* %76, align 4, !mcsema_real_eip !10
  %97 = zext i32 %96 to i64, !mcsema_real_eip !10
  %98 = load i64* %69, align 8, !mcsema_real_eip !11
  %99 = add i64 %6, 8, !mcsema_real_eip !12
  store i64 %97, i64* %RAX.i, align 8, !mcsema_real_eip !12
  store <2 x i64> %3, <2 x i64>* %2, align 8
  store i64 %78, i64* %RDX.i, align 8, !mcsema_real_eip !12
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %19, i8* %1, i32 128, i32 8, i1 false) #0, !mcsema_real_eip !12
...
!3 = metadata !{i64 11, [22 x i8] c"\09movl\09%edi, -20(%rbp)\00"}
!4 = metadata !{i64 14, [19 x i8] c"\09movl\09(%rip), %eax\00"}
!5 = metadata !{i64 20, [21 x i8] c"\09movl\09%eax, -4(%rbp)\00"}
!6 = metadata !{i64 23, [19 x i8] c"\09movl\09(%rip), %edx\00"}
!7 = metadata !{i64 29, [22 x i8] c"\09movl\09-20(%rbp), %eax\00"}
!8 = metadata !{i64 32, [17 x i8] c"\09addl\09%edx, %eax\00"}
!9 = metadata !{i64 34, [19 x i8] c"\09movl\09%eax, (%rip)\00"}
!10 = metadata !{i64 40, [21 x i8] c"\09movl\09-4(%rbp), %eax\00"}
!11 = metadata !{i64 43, [11 x i8] c"\09popq\09%rbp\00"}
!12 = metadata !{i64 44, [6 x i8] c"\09retq\00"}
