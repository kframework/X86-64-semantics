...
entry:
  ...
  %86 = load i32, i32* bitcast (%0* @data_0x39 to i32*), !mcsema_real_eip !5
  ...
  %98 = load i32, i32* bitcast (%0* @data_0x39 to i32*), !mcsema_real_eip !8
  ...
  %126 = load i64, i64* %RAX_val, !mcsema_real_eip !13
  store i64 %126, i64* %RAX, !mcsema_real_eip !13
  %127 = load i64, i64* %RBX_val, !mcsema_real_eip !13
  store i64 %127, i64* %RBX, !mcsema_real_eip !13
  %128 = load i64, i64* %RCX_val, !mcsema_real_eip !13
  store i64 %128, i64* %RCX, !mcsema_real_eip !13
  %129 = load i64, i64* %RDX_val, !mcsema_real_eip !13
  store i64 %129, i64* %RDX, !mcsema_real_eip !13
  %130 = load i64, i64* %RSI_val, !mcsema_real_eip !13
  store i64 %130, i64* %RSI, !mcsema_real_eip !13
  %131 = load i64, i64* %RDI_val, !mcsema_real_eip !13
  store i64 %131, i64* %RDI, !mcsema_real_eip !13
  %132 = load i64, i64* %RSP_val, !mcsema_real_eip !13
  ...
  %134 = load i64, i64* %R8_val, !mcsema_real_eip !13
  store i64 %134, i64* %R8, !mcsema_real_eip !13
  %135 = load i64, i64* %R9_val, !mcsema_real_eip !13
  store i64 %135, i64* %R9, !mcsema_real_eip !13
  %136 = load i64, i64* %R10_val, !mcsema_real_eip !13
  store i64 %136, i64* %R10, !mcsema_real_eip !13
  %137 = load i64, i64* %R11_val, !mcsema_real_eip !13
  store i64 %137, i64* %R11, !mcsema_real_eip !13
  %138 = load i64, i64* %R12_val, !mcsema_real_eip !13
  store i64 %138, i64* %R12, !mcsema_real_eip !13
  %139 = load i64, i64* %R13_val, !mcsema_real_eip !13
  store i64 %139, i64* %R13, !mcsema_real_eip !13
  %140 = load i64, i64* %R14_val, !mcsema_real_eip !13
  store i64 %140, i64* %R14, !mcsema_real_eip !13
  %141 = load i64, i64* %R15_val, !mcsema_real_eip !13
  store i64 %141, i64* %R15, !mcsema_real_eip !13
  %142 = load i64, i64* %RIP_val, !mcsema_real_eip !13
  store i64 %142, i64* %RIP, !mcsema_real_eip !13
  %143 = load i1, i1* %CF_val, !mcsema_real_eip !13
  store i1 %143, i1* %CF, align 1, !mcsema_real_eip !13
  %144 = load i1, i1* %PF_val, !mcsema_real_eip !13
  store i1 %144, i1* %PF, align 1, !mcsema_real_eip !13
  %145 = load i1, i1* %AF_val, !mcsema_real_eip !13
  store i1 %145, i1* %AF, align 1, !mcsema_real_eip !13
  %146 = load i1, i1* %ZF_val, !mcsema_real_eip !13
  store i1 %146, i1* %ZF, align 1, !mcsema_real_eip !13
  %147 = load i1, i1* %SF_val, !mcsema_real_eip !13
  store i1 %147, i1* %SF, align 1, !mcsema_real_eip !13
  %148 = load i1, i1* %OF_val, !mcsema_real_eip !13
  store i1 %148, i1* %OF, align 1, !mcsema_real_eip !13
  %149 = load i1, i1* %DF_val, !mcsema_real_eip !13
...
!8 = !{i64 36, [14 x i8] c"\09movl\090, %eax\00"}
!9 = !{i64 43, [17 x i8] c"\09addl\09%edi, %eax\00"}
!10 = !{i64 45, [14 x i8] c"\09movl\09%eax, 0\00"}
!11 = !{i64 52, [21 x i8] c"\09movl\09-8(%rbp), %eax\00"}
!12 = !{i64 55, [11 x i8] c"\09popq\09%rbp\00"}
!13 = !{i64 56, [6 x i8] c"\09retq\00"}
