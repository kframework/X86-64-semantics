...
block_0x33.i:                                     ; preds = %block_0x67.i, %block_0x33.preheader.i
  ...
  %98 = sext i32 %97 to i64, !mcsema_real_eip !14
  %99 = add i64 %RBP_val.1.i, -8, !mcsema_real_eip !15
  %100 = inttoptr i64 %99 to i64*, !mcsema_real_eip !15
  %101 = load i64, i64* %100, align 8, !mcsema_real_eip !15
  %102 = shl nsw i64 %98, 3
  %103 = add i64 %101, %102, !mcsema_real_eip !16
...
block_0xbb.i.i:                                   ; preds = %block_0x33.i
  ...
  %137 = load i32, i32* %122, align 4, !mcsema_real_eip !28
  %138 = add i32 %137, -1
  %139 = sext i32 %138 to i64, !mcsema_real_eip !29
  %140 = load i64, i64* %114, align 8, !mcsema_real_eip !30
  %141 = add i64 %139, %140, !mcsema_real_eip !31
...
!14 = !{i64 51, [24 x i8] c"\09movslq\09-16(%rbp), %rax\00"}
!15 = !{i64 55, [21 x i8] c"\09movq\09-8(%rbp), %rcx\00"}
!16 = !{i64 59, [26 x i8] c"\09movq\09(%rcx,%rax,8), %rax\00"}
...
!28 = !{i64 196, [22 x i8] c"\09movl\09-16(%rbp), %edx\00"}
!29 = !{i64 202, [19 x i8] c"\09movslq\09%edx, %rax\00"}
!30 = !{i64 205, [21 x i8] c"\09movq\09-8(%rbp), %rsi\00"}
!31 = !{i64 209, [23 x i8] c"\09movb\09(%rsi,%rax), %cl\00"}
