...
block_0x33.i:                                     ; preds = %block_0x69.i, %block_0x33.preheader.i
  %104 = phi i32 [ %272, %block_0x69.i ], [ %85, %block_0x33.preheader.i ]
  %R15_val.1.i = phi i64 [ %R15_val.2.i, %block_0x69.i ], [ %16, %block_0x33.preheader.i ]
  %STACK_LIMIT_val.1.i = phi i64 [ %STACK_LIMIT_val.2.i, %block_0x69.i ], [ %68, %block_0x33.preheader.i ]
  %STACK_BASE_val.1.i = phi i64 [ %STACK_BASE_val.2.i, %block_0x69.i ], [ %67, %block_0x33.preheader.i ]
  %OF_val.0.i = phi i1 [ %286, %block_0x69.i ], [ %92, %block_0x33.preheader.i ]
  %SF_val.0.i = phi i1 [ %282, %block_0x69.i ], [ %89, %block_0x33.preheader.i ]
  %CF_val.0.i = phi i1 [ %283, %block_0x69.i ], [ %93, %block_0x33.preheader.i ]
  %AF_val.0.in.in.i = phi i32 [ %278, %block_0x69.i ], [ %97, %block_0x33.preheader.i ]
  %PF_val.0.in.in.i = phi i8 [ %280, %block_0x69.i ], [ %96, %block_0x33.preheader.i ]
  %ZF_val.0.i = phi i1 [ %281, %block_0x69.i ], [ %94, %block_0x33.preheader.i ]
  %R14_val.1.i = phi i64 [ %R14_val.2.i, %block_0x69.i ], [ %15, %block_0x33.preheader.i ]
  %R13_val.1.i = phi i64 [ %R13_val.2.i, %block_0x69.i ], [ %14, %block_0x33.preheader.i ]
  %R12_val.1.i = phi i64 [ %R12_val.2.i, %block_0x69.i ], [ %13, %block_0x33.preheader.i ]
  %R11_val.1.i = phi i64 [ %R11_val.2.i, %block_0x69.i ], [ %12, %block_0x33.preheader.i ]
  %R10_val.1.i = phi i64 [ %R10_val.2.i, %block_0x69.i ], [ %11, %block_0x33.preheader.i ]
  %R9_val.1.i = phi i64 [ %R9_val.2.i, %block_0x69.i ], [ %10, %block_0x33.preheader.i ]
  %R8_val.1.i = phi i64 [ %R8_val.2.i, %block_0x69.i ], [ %9, %block_0x33.preheader.i ]
  %RSP_val.1.i = phi i64 [ %184, %block_0x69.i ], [ %71, %block_0x33.preheader.i ]
  %RBP_val.1.i = phi i64 [ %RBP_val.2.i, %block_0x69.i ], [ %69, %block_0x33.preheader.i ]
  %RSI_val.1.i = phi i64 [ %RSI_val.2.i, %block_0x69.i ], [ %5, %block_0x33.preheader.i ]
  %RDX_val.1.i = phi i64 [ %RDX_val.0.i.i, %block_0x69.i ], [ %4, %block_0x33.preheader.i ]
  ...
  br i1 %142, label %sub_90.exitthread-pre-split.i, label %block_0xbe.i.i, !mcsema_real_eip !25
...
block_0xbe.i.i:                                   ; preds = %block_0x33.i
  ...
  br i1 %165, label %block_0xed.i.i, label %sub_90.exitthread-pre-split.i, !mcsema_real_eip !35
...
sub_90.exitthread-pre-split.i:                    ; preds = %block_0xbe.i.i, %block_0x33.i
  %RDI_val.0.i.ph.i = phi i64 [ %164, %block_0xbe.i.i ], [ %129, %block_0x33.i ]
  %RSI_val.0.i.ph.i = phi i64 [ %152, %block_0xbe.i.i ], [ %RSI_val.1.i, %block_0x33.i ]
  %RDX_val.0.i.ph.i = phi i64 [ %162, %block_0xbe.i.i ], [ %RDX_val.1.i, %block_0x33.i ]
  %RCX_val.0.i.ph.i = phi i64 [ %157, %block_0xbe.i.i ], [ %131, %block_0x33.i ]
  %.pr.i = load i32* %128, align 4
  br label %sub_90.exit.i

sub_90.exit.i:                                    ; preds = %sub_90.exitthread-pre-split.i, %block_0xed.i.i
  %166 = phi i32 [ %.pr.i, %sub_90.exitthread-pre-split.i ], [ 0, %block_0xed.i.i ]
  %RDI_val.0.i.i = phi i64 [ %RDI_val.0.i.ph.i, %sub_90.exitthread-pre-split.i ], [ %164, %block_0xed.i.i ]
  %RSI_val.0.i.i = phi i64 [ %RSI_val.0.i.ph.i, %sub_90.exitthread-pre-split.i ], [ %152, %block_0xed.i.i ]
  %RDX_val.0.i.i = phi i64 [ %RDX_val.0.i.ph.i, %sub_90.exitthread-pre-split.i ], [ %162, %block_0xed.i.i ]
  %RCX_val.0.i.i = phi i64 [ %RCX_val.0.i.ph.i, %sub_90.exitthread-pre-split.i ], [ %157, %block_0xed.i.i ]
  ...
  br i1 %200, label %block_0x57.i, label %block_0x69.i, !mcsema_real_eip !43
...
block_0x57.i:                                     ; preds = %sub_90.exit.i
  ...
  br i1 %227, label %sub_110.exit.i, label %block_0x144.i.i.preheader, !mcsema_real_eip !57
...
block_0x144.i.i:                                  ; preds = %block_0x135.i.i, %block_0x144.i.i.preheader
  %228 = phi i8 [ %storemerge.i.i, %block_0x135.i.i ], [ %223, %block_0x144.i.i.preheader ]
  ...
  br i1 %229, label %block_0x153.i.i, label %block_0x15f.i.i, !mcsema_real_eip !59
...
block_0x135.i.i:                                  ; preds = %block_0x153.i.i, %block_0x15f.i.i
  %storemerge.i.i = phi i8 [ %248, %block_0x153.i.i ], [ %238, %block_0x15f.i.i ]
  %RCX_val.2.i.i = phi i64 [ %251, %block_0x153.i.i ], [ %241, %block_0x15f.i.i ]
  store i8 %storemerge.i.i, i8* %225, align 1
  %252 = icmp eq i8 %storemerge.i.i, 0
  br i1 %252, label %sub_110.exit.i.loopexit, label %block_0x144.i.i, !mcsema_real_eip !57
...
sub_110.exit.i:                                   ; preds = %sub_110.exit.i.loopexit, %block_0x57.i
  %PF_val.0.in.in.i.i = phi i8 [ %226, %block_0x57.i ], [ 0, %sub_110.exit.i.loopexit ]
  %RCX_val.0.i66.i = phi i64 [ %RCX_val.0.i.i, %block_0x57.i ], [ %RCX_val.2.i.i.lcssa, %sub_110.exit.i.loopexit ]
...
block_0x69.i:                                     ; preds = %sub_110.exit.i, %sub_90.exit.i
  %R15_val.2.i = phi i64 [ %265, %sub_110.exit.i ], [ %196, %sub_90.exit.i ]
  %STACK_LIMIT_val.2.i = phi i64 [ %268, %sub_110.exit.i ], [ %199, %sub_90.exit.i ]
  %STACK_BASE_val.2.i = phi i64 [ %trunc75.i, %sub_110.exit.i ], [ %trunc70.i, %sub_90.exit.i ]
  %R14_val.2.i = phi i64 [ %trunc74.i, %sub_110.exit.i ], [ %trunc69.i, %sub_90.exit.i ]
  %R13_val.2.i = phi i64 [ %262, %sub_110.exit.i ], [ %193, %sub_90.exit.i ]
  %R12_val.2.i = phi i64 [ %trunc73.i, %sub_110.exit.i ], [ %trunc68.i, %sub_90.exit.i ]
  %R11_val.2.i = phi i64 [ %259, %sub_110.exit.i ], [ %190, %sub_90.exit.i ]
  %R10_val.2.i = phi i64 [ %trunc72.i, %sub_110.exit.i ], [ %trunc67.i, %sub_90.exit.i ]
  %R9_val.2.i = phi i64 [ %256, %sub_110.exit.i ], [ %187, %sub_90.exit.i ]
  %R8_val.2.i = phi i64 [ %trunc71.i, %sub_110.exit.i ], [ %trunc.i, %sub_90.exit.i ]
  %RBP_val.2.i = phi i64 [ %253, %sub_110.exit.i ], [ %183, %sub_90.exit.i ]
  %RDI_val.1.i = phi i64 [ %203, %sub_110.exit.i ], [ %RDI_val.0.i.i, %sub_90.exit.i ]
  %RSI_val.2.i = phi i64 [ %221, %sub_110.exit.i ], [ %RSI_val.0.i.i, %sub_90.exit.i ]
  %RCX_val.1.i = phi i64 [ %RCX_val.0.i66.i, %sub_110.exit.i ], [ %RCX_val.0.i.i, %sub_90.exit.i ]
...
sub_0.exit.loopexit:                              ; preds = %block_0x69.i
  ...
  %.lcssa = phi i64 [ %184, %block_0x69.i ]
  %RDX_val.0.i.i.lcssa = phi i64 [ %RDX_val.0.i.i, %block_0x69.i ]
  br label %sub_0.exit

sub_0.exit:                                       ; preds = %sub_0.exit.loopexit, %driverBlockRaw
  %R15_val.0.i = phi i64 [ %16, %driverBlockRaw ], [ %R15_val.2.i.lcssa, %sub_0.exit.loopexit ]
  %STACK_LIMIT_val.0.i = phi i64 [ %68, %driverBlockRaw ], [ %STACK_LIMIT_val.2.i.lcssa, %sub_0.exit.loopexit ]
  %STACK_BASE_val.0.i = phi i64 [ %67, %driverBlockRaw ], [ %STACK_BASE_val.2.i.lcssa, %sub_0.exit.loopexit ]
  %R14_val.0.i = phi i64 [ %15, %driverBlockRaw ], [ %R14_val.2.i.lcssa, %sub_0.exit.loopexit ]
  %R13_val.0.i = phi i64 [ %14, %driverBlockRaw ], [ %R13_val.2.i.lcssa, %sub_0.exit.loopexit ]
  %R12_val.0.i = phi i64 [ %13, %driverBlockRaw ], [ %R12_val.2.i.lcssa, %sub_0.exit.loopexit ]
  %R11_val.0.i = phi i64 [ %12, %driverBlockRaw ], [ %R11_val.2.i.lcssa, %sub_0.exit.loopexit ]
  %R10_val.0.i = phi i64 [ %11, %driverBlockRaw ], [ %R10_val.2.i.lcssa, %sub_0.exit.loopexit ]
  %R9_val.0.i = phi i64 [ %10, %driverBlockRaw ], [ %R9_val.2.i.lcssa, %sub_0.exit.loopexit ]
  %R8_val.0.i = phi i64 [ %9, %driverBlockRaw ], [ %R8_val.2.i.lcssa, %sub_0.exit.loopexit ]
  %RSP_val.0.i = phi i64 [ %71, %driverBlockRaw ], [ %.lcssa, %sub_0.exit.loopexit ]
  %RBP_val.0.i = phi i64 [ %69, %driverBlockRaw ], [ %RBP_val.2.i.lcssa, %sub_0.exit.loopexit ]
  %RDI_val.0.i = phi i64 [ %81, %driverBlockRaw ], [ %RDI_val.1.i.lcssa, %sub_0.exit.loopexit ]
  %RSI_val.0.i = phi i64 [ %5, %driverBlockRaw ], [ %RSI_val.2.i.lcssa, %sub_0.exit.loopexit ]
  %RDX_val.0.i = phi i64 [ %4, %driverBlockRaw ], [ %RDX_val.0.i.i.lcssa, %sub_0.exit.loopexit ]
  %RCX_val.0.i = phi i64 [ %3, %driverBlockRaw ], [ %RCX_val.1.i.lcssa, %sub_0.exit.loopexit ]
