...
entry:
  ...
  %tmp = xor i1 %151, %150
  br i1 %tmp, label %block_0x43.preheader, label %block_0x89, !mcsema_real_eip !14

block_0x43.preheader:                             ; preds = %entry
  br label %block_0x43

block_0x89.loopexit:                              ; preds = %block_0x79
  br label %block_0x89

block_0x89:                                       ; preds = %block_0x89.loopexit, %entry
...
block_0x43:                                       ; preds = %block_0x79, %block_0x43.preheader
  ...
  tail call x86_64_sysvcc void @sub_a0(%struct.regs* %0), !mcsema_real_eip !25
  ...
  br i1 %417, label %block_0x67, label %block_0x79, !mcsema_real_eip !27

block_0x67:                                       ; preds = %block_0x43
  ...
  tail call x86_64_sysvcc void @sub_120(%struct.regs* %0), !mcsema_real_eip !30
  ...
  br label %block_0x79, !mcsema_real_eip !31

block_0x79:                                       ; preds = %block_0x67, %block_0x43
  ...
  br i1 %tmp349, label %block_0x43, label %block_0x89.loopexit, !mcsema_real_eip !14
}

; Function Attrs: nounwind
define internal x86_64_sysvcc void @sub_120(%struct.regs*) #0 {
entry:
  ...
  br i1 %125, label %block_0x1a2, label %block_0x154.preheader, !mcsema_real_eip !48

block_0x154.preheader:                            ; preds = %entry
  br label %block_0x154

block_0x1a2.loopexit:                             ; preds = %block_0x145
  br label %block_0x1a2

block_0x1a2:                                      ; preds = %block_0x1a2.loopexit, %entry
...
block_0x154:                                      ; preds = %block_0x145, %block_0x154.preheader
  ...
  br i1 %221, label %block_0x163, label %block_0x16f, !mcsema_real_eip !53

block_0x16f:                                      ; preds = %block_0x154
  ...
  br label %block_0x145, !mcsema_real_eip !66

block_0x163:                                      ; preds = %block_0x154
...
block_0x145:                                      ; preds = %block_0x163, %block_0x16f
  ...
  store i1 false, i1* %CF_val, !mcsema_real_eip !47
  store i1 false, i1* %OF_val, !mcsema_real_eip !47
  br i1 %368, label %block_0x1a2.loopexit, label %block_0x154, !mcsema_real_eip !48
}
...
entry:
  ...
  br i1 %133, label %block_0x109, label %block_0xce, !mcsema_real_eip !79

block_0x109:                                      ; preds = %block_0xfd, %block_0xce, %entry
...
block_0xce:                                       ; preds = %entry
  ...
  br i1 %310, label %block_0xfd, label %block_0x109, !mcsema_real_eip !96

block_0xfd:                                       ; preds = %block_0xce
  ...
  br label %block_0x109, !mcsema_real_eip !98
}
...
!5 = metadata !{i64 24, [21 x i8] c"\09movq\09%rdi, -8(%rbp)\00"}
!6 = metadata !{i64 28, [22 x i8] c"\09movl\09%esi, -12(%rbp)\00"}
!7 = metadata !{i64 31, [20 x i8] c"\09movl\09$0, -16(%rbp)\00"}
!8 = metadata !{i64 38, [24 x i8] c"\09movslq\09-12(%rbp), %rdi\00"}
!9 = metadata !{i64 42, [15 x i8] c"\09shlq\09$3, %rdi\00"}
!10 = metadata !{i64 46, [9 x i8] c"\09callq\090\00"}
!11 = metadata !{i64 51, [22 x i8] c"\09movq\09%rax, -24(%rbp)\00"}
!12 = metadata !{i64 55, [22 x i8] c"\09movl\09-16(%rbp), %eax\00"}
!13 = metadata !{i64 58, [22 x i8] c"\09cmpl\09-12(%rbp), %eax\00"}
!14 = metadata !{i64 61, [8 x i8] c"\09jge\0970\00"}
!15 = metadata !{i64 137, [22 x i8] c"\09movq\09-24(%rbp), %rax\00"}
!16 = metadata !{i64 141, [18 x i8] c"\09movb\09$2, 1(%rax)\00"}
!17 = metadata !{i64 145, [16 x i8] c"\09addq\09$32, %rsp\00"}
!18 = metadata !{i64 149, [11 x i8] c"\09popq\09%rbp\00"}
!19 = metadata !{i64 150, [6 x i8] c"\09retq\00"}
!20 = metadata !{i64 67, [24 x i8] c"\09movslq\09-16(%rbp), %rax\00"}
!21 = metadata !{i64 71, [21 x i8] c"\09movq\09-8(%rbp), %rcx\00"}
!22 = metadata !{i64 75, [26 x i8] c"\09movq\09(%rcx,%rax,8), %rax\00"}
!23 = metadata !{i64 79, [22 x i8] c"\09movq\09%rax, -32(%rbp)\00"}
!24 = metadata !{i64 83, [22 x i8] c"\09movq\09-32(%rbp), %rdi\00"}
!25 = metadata !{i64 87, [10 x i8] c"\09callq\0968\00"}
!26 = metadata !{i64 92, [15 x i8] c"\09cmpl\09$0, %eax\00"}
!27 = metadata !{i64 97, [8 x i8] c"\09jne\0913\00"}
!28 = metadata !{i64 103, [22 x i8] c"\09movq\09-32(%rbp), %rdi\00"}
!29 = metadata !{i64 107, [22 x i8] c"\09movq\09-32(%rbp), %rsi\00"}
!30 = metadata !{i64 111, [11 x i8] c"\09callq\09172\00"}
!31 = metadata !{i64 116, [7 x i8] c"\09jmp\090\00"}
!32 = metadata !{i64 121, [22 x i8] c"\09movl\09-16(%rbp), %eax\00"}
!33 = metadata !{i64 124, [15 x i8] c"\09addl\09$1, %eax\00"}
!34 = metadata !{i64 129, [22 x i8] c"\09movl\09%eax, -16(%rbp)\00"}
!35 = metadata !{i64 288, [12 x i8] c"\09pushq\09%rbp\00"}
!36 = metadata !{i64 289, [17 x i8] c"\09movq\09%rsp, %rbp\00"}
!37 = metadata !{i64 292, [21 x i8] c"\09movq\09%rdi, -8(%rbp)\00"}
!38 = metadata !{i64 296, [22 x i8] c"\09movq\09%rsi, -16(%rbp)\00"}
!39 = metadata !{i64 300, [21 x i8] c"\09movq\09-8(%rbp), %rsi\00"}
!40 = metadata !{i64 304, [22 x i8] c"\09movq\09%rsi, -24(%rbp)\00"}
!41 = metadata !{i64 308, [22 x i8] c"\09movq\09-16(%rbp), %rsi\00"}
!42 = metadata !{i64 312, [22 x i8] c"\09movq\09%rsi, -32(%rbp)\00"}
!43 = metadata !{i64 316, [22 x i8] c"\09movq\09-24(%rbp), %rsi\00"}
!44 = metadata !{i64 320, [18 x i8] c"\09movb\09(%rsi), %al\00"}
!45 = metadata !{i64 322, [21 x i8] c"\09movb\09%al, -33(%rbp)\00"}
!46 = metadata !{i64 325, [24 x i8] c"\09movsbl\09-33(%rbp), %eax\00"}
!47 = metadata !{i64 329, [15 x i8] c"\09cmpl\09$0, %eax\00"}
!48 = metadata !{i64 334, [7 x i8] c"\09je\0978\00"}
!49 = metadata !{i64 418, [11 x i8] c"\09popq\09%rbp\00"}
!50 = metadata !{i64 419, [6 x i8] c"\09retq\00"}
!51 = metadata !{i64 340, [24 x i8] c"\09movsbl\09-33(%rbp), %eax\00"}
!52 = metadata !{i64 344, [16 x i8] c"\09cmpl\09$47, %eax\00"}
!53 = metadata !{i64 349, [8 x i8] c"\09jne\0912\00"}
!54 = metadata !{i64 367, [21 x i8] c"\09movb\09-33(%rbp), %al\00"}
!55 = metadata !{i64 370, [22 x i8] c"\09movq\09-32(%rbp), %rcx\00"}
!56 = metadata !{i64 374, [18 x i8] c"\09movb\09%al, (%rcx)\00"}
!57 = metadata !{i64 376, [22 x i8] c"\09movq\09-24(%rbp), %rax\00"}
!58 = metadata !{i64 380, [15 x i8] c"\09addq\09$1, %rax\00"}
!59 = metadata !{i64 386, [22 x i8] c"\09movq\09%rax, -24(%rbp)\00"}
!60 = metadata !{i64 390, [22 x i8] c"\09movq\09-32(%rbp), %rax\00"}
!61 = metadata !{i64 394, [15 x i8] c"\09addq\09$1, %rax\00"}
!62 = metadata !{i64 400, [22 x i8] c"\09movq\09%rax, -32(%rbp)\00"}
!63 = metadata !{i64 404, [22 x i8] c"\09movq\09-24(%rbp), %rax\00"}
!64 = metadata !{i64 408, [18 x i8] c"\09movb\09(%rax), %cl\00"}
!65 = metadata !{i64 410, [21 x i8] c"\09movb\09%cl, -33(%rbp)\00"}
!66 = metadata !{i64 413, [9 x i8] c"\09jmp\09-93\00"}
!67 = metadata !{i64 355, [22 x i8] c"\09movq\09-32(%rbp), %rax\00"}
!68 = metadata !{i64 359, [18 x i8] c"\09movb\09$92, (%rax)\00"}
!69 = metadata !{i64 160, [12 x i8] c"\09pushq\09%rbp\00"}
!70 = metadata !{i64 161, [17 x i8] c"\09movq\09%rsp, %rbp\00"}
!71 = metadata !{i64 164, [16 x i8] c"\09subq\09$32, %rsp\00"}
!72 = metadata !{i64 168, [21 x i8] c"\09movq\09%rdi, -8(%rbp)\00"}
!73 = metadata !{i64 172, [20 x i8] c"\09movl\09$1, -12(%rbp)\00"}
!74 = metadata !{i64 179, [21 x i8] c"\09movq\09-8(%rbp), %rdi\00"}
!75 = metadata !{i64 183, [9 x i8] c"\09callq\090\00"}
!76 = metadata !{i64 188, [17 x i8] c"\09movl\09%eax, %ecx\00"}
!77 = metadata !{i64 190, [22 x i8] c"\09movl\09%ecx, -16(%rbp)\00"}
!78 = metadata !{i64 193, [20 x i8] c"\09cmpl\09$1, -16(%rbp)\00"}
!79 = metadata !{i64 200, [8 x i8] c"\09jle\0959\00"}
!80 = metadata !{i64 265, [22 x i8] c"\09movl\09-12(%rbp), %eax\00"}
!81 = metadata !{i64 268, [16 x i8] c"\09addq\09$32, %rsp\00"}
!82 = metadata !{i64 272, [11 x i8] c"\09popq\09%rbp\00"}
!83 = metadata !{i64 273, [6 x i8] c"\09retq\00"}
!84 = metadata !{i64 206, [21 x i8] c"\09movq\09-8(%rbp), %rax\00"}
!85 = metadata !{i64 210, [18 x i8] c"\09movb\09(%rax), %cl\00"}
!86 = metadata !{i64 212, [21 x i8] c"\09movb\09%cl, -17(%rbp)\00"}
!87 = metadata !{i64 215, [22 x i8] c"\09movl\09-16(%rbp), %edx\00"}
!88 = metadata !{i64 218, [15 x i8] c"\09subl\09$1, %edx\00"}
!89 = metadata !{i64 224, [19 x i8] c"\09movslq\09%edx, %rax\00"}
!90 = metadata !{i64 227, [21 x i8] c"\09movq\09-8(%rbp), %rsi\00"}
!91 = metadata !{i64 231, [23 x i8] c"\09movb\09(%rsi,%rax), %cl\00"}
!92 = metadata !{i64 234, [21 x i8] c"\09movb\09%cl, -18(%rbp)\00"}
!93 = metadata !{i64 237, [24 x i8] c"\09movsbl\09-17(%rbp), %edx\00"}
!94 = metadata !{i64 241, [24 x i8] c"\09movsbl\09-18(%rbp), %edi\00"}
!95 = metadata !{i64 245, [17 x i8] c"\09cmpl\09%edi, %edx\00"}
!96 = metadata !{i64 247, [7 x i8] c"\09jne\097\00"}
!97 = metadata !{i64 253, [20 x i8] c"\09movl\09$0, -12(%rbp)\00"}
!98 = metadata !{i64 260, [7 x i8] c"\09jmp\090\00"}
