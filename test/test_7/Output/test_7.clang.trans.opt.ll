...
driverBlockRaw:
  ...
  call void @llvm.lifetime.start(i64 1408, i8* %1)
  ...
  %6 = load i64* %R14.i, align 8, !mcsema_real_eip !2
...
block_0x190.i:                                    ; preds = %block_0x190.i, %driverBlockRaw
  ...
  %86 = load i32* %71, align 4, !mcsema_real_eip !14
  %87 = add i32 %86, 1
  ...
  br i1 %tmp210.i, label %block_0x190.i, label %block_0x1b0.i, !mcsema_real_eip !16

block_0x202.i:                                    ; preds = %block_0x1df.i
  %.lcssa16 = phi i1 [ %141, %block_0x1df.i ]
  %.lcssa15 = phi i1 [ %139, %block_0x1df.i ]
  %.lcssa14 = phi i32 [ %138, %block_0x1df.i ]
  %.lcssa13 = phi i32 [ %137, %block_0x1df.i ]
  %.lcssa = phi i32 [ %136, %block_0x1df.i ]
  ...
  %94 = icmp ult i32 %.lcssa, 10, !mcsema_real_eip !17
  %95 = icmp eq i32 %.lcssa13, 0, !mcsema_real_eip !17
  %96 = trunc i32 %.lcssa13 to i8, !mcsema_real_eip !17
  %97 = tail call i8 @llvm.ctpop.i8(i8 %96), !mcsema_real_eip !17
  %98 = and i8 %97, 1
  %99 = icmp eq i8 %98, 0
  %100 = and i32 %.lcssa14, 16, !mcsema_real_eip !17
  %101 = icmp ne i32 %100, 0, !mcsema_real_eip !17
  %102 = load i32* %69, align 8, !mcsema_real_eip !18
  %103 = zext i32 %102 to i64, !mcsema_real_eip !18
  %104 = load i64* %74, align 8, !mcsema_real_eip !19
  %105 = load i64* %77, align 8, !mcsema_real_eip !20
  ...
  %120 = load i64* %113, align 8, !mcsema_real_eip !29
  ...
  %125 = getelementptr inbounds [176 x i64]* %_local_stack_alloc_124.i, i64 0, i64 0
  store i64 -4981261766360305936, i64* %125, align 8, !mcsema_real_eip !32
  ...
  %126 = bitcast i64* %R8.i to <2 x i64>*
  store <2 x i64> <i64 10, i64 10>, <2 x i64>* %126, align 8
  ...
  %127 = bitcast i64* %R15.i to <2 x i64>*
  store <2 x i64> %8, <2 x i64>* %127, align 8
  ...
  store i1 %.lcssa15, i1* %SF.i, align 1, !mcsema_real_eip !32
  store i1 %.lcssa16, i1* %OF.i, align 1, !mcsema_real_eip !32
  store i1 %9, i1* %DF.i, align 1, !mcsema_real_eip !32
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %11, i8* %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false), !mcsema_real_eip !32
...
block_0x1df.i:                                    ; preds = %block_0x1df.i, %block_0x1b0.i
  ...
  br i1 %tmp214.i, label %block_0x1df.i, label %block_0x202.i, !mcsema_real_eip !38
}
...
!3 = metadata !{i64 356, [12 x i8] c"\09pushq\09%r14\00"}
!4 = metadata !{i64 358, [12 x i8] c"\09pushq\09%rbx\00"}
!5 = metadata !{i64 366, [20 x i8] c"\09movl\09$0, -20(%rbp)\00"}
!6 = metadata !{i64 373, [20 x i8] c"\09movl\09$1, -24(%rbp)\00"}
!7 = metadata !{i64 380, [20 x i8] c"\09movl\09$0, -68(%rbp)\00"}
!8 = metadata !{i64 412, [29 x i8] c"\09movl\09%eax, -64(%rbp,%rcx,4)\00"}
!9 = metadata !{i64 446, [22 x i8] c"\09movq\09%rax, -80(%rbp)\00"}
!10 = metadata !{i64 450, [9 x i8] c"\09callq\090\00"}
!11 = metadata !{i64 455, [22 x i8] c"\09movq\09%rax, -88(%rbp)\00"}
!12 = metadata !{i64 459, [20 x i8] c"\09movl\09$0, -92(%rbp)\00"}
!13 = metadata !{i64 408, [24 x i8] c"\09movslq\09-68(%rbp), %rcx\00"}
!14 = metadata !{i64 416, [22 x i8] c"\09movl\09-68(%rbp), %eax\00"}
!15 = metadata !{i64 424, [22 x i8] c"\09movl\09%eax, -68(%rbp)\00"}
!16 = metadata !{i64 394, [8 x i8] c"\09jge\0932\00"}
!17 = metadata !{i64 466, [21 x i8] c"\09cmpl\09$10, -92(%rbp)\00"}
!18 = metadata !{i64 523, [22 x i8] c"\09movl\09-24(%rbp), %edi\00"}
!19 = metadata !{i64 526, [22 x i8] c"\09movq\09-80(%rbp), %rdx\00"}
!20 = metadata !{i64 530, [22 x i8] c"\09movq\09-88(%rbp), %rsi\00"}
!21 = metadata !{i64 546, [23 x i8] c"\09movq\09%rsi, -104(%rbp)\00"}
!22 = metadata !{i64 557, [23 x i8] c"\09movq\09%rcx, -112(%rbp)\00"}
!23 = metadata !{i64 564, [23 x i8] c"\09movl\09%r8d, -116(%rbp)\00"}
!24 = metadata !{i64 571, [22 x i8] c"\09movq\09%r9, -128(%rbp)\00"}
!25 = metadata !{i64 578, [23 x i8] c"\09movl\09-116(%rbp), %eax\00"}
!26 = metadata !{i64 581, [19 x i8] c"\09movl\09%eax, (%rsp)\00"}
!27 = metadata !{i64 584, [23 x i8] c"\09movq\09-112(%rbp), %rbx\00"}
!28 = metadata !{i64 588, [20 x i8] c"\09movq\09%rbx, 8(%rsp)\00"}
!29 = metadata !{i64 593, [23 x i8] c"\09movq\09-128(%rbp), %r14\00"}
!30 = metadata !{i64 597, [21 x i8] c"\09movq\09%r14, 16(%rsp)\00"}
!31 = metadata !{i64 602, [21 x i8] c"\09movq\09%r10, 24(%rsp)\00"}
!32 = metadata !{i64 607, [12 x i8] c"\09callq\09-612\00"}
!33 = metadata !{i64 487, [24 x i8] c"\09movslq\09-92(%rbp), %rcx\00"}
!34 = metadata !{i64 491, [22 x i8] c"\09movq\09-88(%rbp), %rdx\00"}
!35 = metadata !{i64 495, [26 x i8] c"\09movl\09%eax, (%rdx,%rcx,4)\00"}
!36 = metadata !{i64 498, [22 x i8] c"\09movl\09-92(%rbp), %eax\00"}
!37 = metadata !{i64 506, [22 x i8] c"\09movl\09%eax, -92(%rbp)\00"}
!38 = metadata !{i64 473, [8 x i8] c"\09jge\0935\00"}
