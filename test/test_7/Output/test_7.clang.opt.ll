...
block_0x5d.i.i:                                   ; preds = %block_0x5d.i.i.preheader, %block_0x5d.i.i
  ...
  %181 = load i64, i64* %139, align 8, !mcsema_real_eip !56
  %182 = sext i32 %180 to i64, !mcsema_real_eip !57
  %183 = shl nsw i64 %182, 2
  %184 = add i64 %183, %181, !mcsema_real_eip !58
...
block_0x9b.i.i:                                   ; preds = %block_0x9b.i.i.preheader, %block_0x9b.i.i
  ...
  %210 = load i64, i64* %143, align 8, !mcsema_real_eip !69
  %211 = sext i32 %209 to i64, !mcsema_real_eip !70
  %212 = shl nsw i64 %211, 2
  %213 = add i64 %212, %210, !mcsema_real_eip !71
...
block_0xd6.i.i:                                   ; preds = %block_0xd6.i.i.preheader, %block_0xd6.i.i
  ...
  %247 = load i64, i64* %151, align 8, !mcsema_real_eip !82
  %248 = sext i32 %246 to i64, !mcsema_real_eip !83
  %249 = shl nsw i64 %248, 2
  %250 = add i64 %249, %247, !mcsema_real_eip !84
...
block_0x114.i.i:                                  ; preds = %block_0x114.i.i.preheader, %block_0x114.i.i
  ...
  %271 = load i64, i64* %155, align 8, !mcsema_real_eip !89
  %272 = sext i32 %270 to i64, !mcsema_real_eip !90
  %273 = shl nsw i64 %272, 2
  %274 = add i64 %273, %271, !mcsema_real_eip !91
...
block_0x1b2.i:                                    ; preds = %block_0x1b2.i, %block_0x189.i
  ...
  %289 = add i32 %288, 1
  %290 = load i64, i64* %77, align 8, !mcsema_real_eip !95
  %291 = sext i32 %288 to i64, !mcsema_real_eip !96
  %292 = shl nsw i64 %291, 2
  %293 = add i64 %292, %290, !mcsema_real_eip !97
...
!56 = !{i64 93, [22 x i8] c"\09movq\09-24(%rbp), %rax\00"}
!57 = !{i64 97, [24 x i8] c"\09movslq\09-88(%rbp), %rcx\00"}
!58 = !{i64 101, [26 x i8] c"\09movl\09(%rax,%rcx,4), %edx\00"}
...
!69 = !{i64 155, [22 x i8] c"\09movq\09-40(%rbp), %rax\00"}
!70 = !{i64 159, [24 x i8] c"\09movslq\09-92(%rbp), %rcx\00"}
!71 = !{i64 163, [26 x i8] c"\09movl\09(%rax,%rcx,4), %edx\00"}
...
!82 = !{i64 214, [22 x i8] c"\09movq\09-64(%rbp), %rax\00"}
!83 = !{i64 218, [24 x i8] c"\09movslq\09-96(%rbp), %rcx\00"}
!84 = !{i64 222, [26 x i8] c"\09movl\09(%rax,%rcx,4), %edx\00"}
...
!89 = !{i64 276, [22 x i8] c"\09movq\09-80(%rbp), %rax\00"}
!90 = !{i64 280, [25 x i8] c"\09movslq\09-100(%rbp), %rcx\00"}
!91 = !{i64 284, [26 x i8] c"\09movl\09(%rax,%rcx,4), %edx\00"}
...
!95 = !{i64 440, [22 x i8] c"\09movq\09-88(%rbp), %rcx\00"}
!96 = !{i64 444, [24 x i8] c"\09movslq\09-92(%rbp), %rdx\00"}
!97 = !{i64 448, [26 x i8] c"\09movl\09%eax, (%rcx,%rdx,4)\00"}
