...
driverBlockRaw:
  ...
  %74 = tail call i8 @llvm.ctpop.i8(i8 %73) #0, !mcsema_real_eip !3
  %75 = and i8 %74, 1
  %76 = icmp eq i8 %75, 0
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %18, i8* %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false) #0, !mcsema_real_eip !5
