...
block_0x51.i.i:                                   ; preds = %block_0x51.i.i.preheader, %block_0x51.i.i
  ...
  %188 = sext i32 %187 to i64, !mcsema_real_eip !61
  %189 = load i64, i64* %172, align 8, !mcsema_real_eip !62
  %190 = shl nsw i64 %188, 2
  %191 = add i64 %190, %189, !mcsema_real_eip !63
...
!61 = !{i64 81, [24 x i8] c"\09movslq\09-72(%rbp), %rax\00"}
!62 = !{i64 85, [22 x i8] c"\09movq\09-48(%rbp), %rcx\00"}
!63 = !{i64 89, [26 x i8] c"\09movl\09(%rcx,%rax,4), %edx\00"}
!64 = !{i64 96, [22 x i8] c"\09movq\09-64(%rbp), %rcx\00"}
!65 = !{i64 100, [26 x i8] c"\09subl\09(%rcx,%rax,4), %edx\00"}
