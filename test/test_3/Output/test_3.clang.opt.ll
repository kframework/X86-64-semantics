...
block_0x48.loopexit.i:                            ; preds = %block_0x25.i
  %.lcssa33 = phi i1 [ %113, %block_0x25.i ]
  %.lcssa32 = phi i1 [ %110, %block_0x25.i ]
  %.lcssa31 = phi i32 [ %109, %block_0x25.i ]
  %.lcssa30 = phi i32 [ %108, %block_0x25.i ]
  %.lcssa29 = phi i32 [ %107, %block_0x25.i ]
  %.lcssa28 = phi i32 [ %106, %block_0x25.i ]
  %.lcssa27 = phi i32 [ %104, %block_0x25.i ]
  %.lcssa26 = phi i32 [ %102, %block_0x25.i ]
  %.lcssa = phi i64 [ %98, %block_0x25.i ]
  %89 = zext i32 %.lcssa26 to i64, !mcsema_real_eip !9
  %90 = zext i32 %.lcssa27 to i64, !mcsema_real_eip !10
  %91 = xor i32 %.lcssa31, %.lcssa29, !mcsema_real_eip !7
  %92 = trunc i32 %.lcssa30 to i8, !mcsema_real_eip !7
  %93 = tail call i8 @llvm.ctpop.i8(i8 %92) #0, !mcsema_real_eip !7
  %94 = icmp eq i32 %.lcssa28, %.lcssa29
  %95 = icmp ult i32 %.lcssa28, %.lcssa29, !mcsema_real_eip !7
  br label %sub_0.exit

block_0x25.i:                                     ; preds = %block_0x25.i, %block_0x25.i.preheader
  %96 = phi i32 [ %106, %block_0x25.i ], [ 0, %block_0x25.i.preheader ]
  %97 = sext i32 %96 to i64, !mcsema_real_eip !11
  %98 = load i64* %71, align 8, !mcsema_real_eip !12
  %99 = shl nsw i64 %97, 2
  %100 = add i64 %99, %98, !mcsema_real_eip !9
  %101 = inttoptr i64 %100 to i32*
  %102 = load i32* %101, align 4, !mcsema_real_eip !9
  %103 = load i32* %76, align 4, !mcsema_real_eip !13
  %104 = add i32 %103, %102
  store i32 %104, i32* %76, align 4, !mcsema_real_eip !14
  %105 = load i32* %78, align 4, !mcsema_real_eip !15
  %106 = add i32 %105, 1
  store i32 %106, i32* %78, align 4, !mcsema_real_eip !16
  %107 = load i32* %74, align 4, !mcsema_real_eip !7
  %108 = sub i32 %106, %107, !mcsema_real_eip !7
  %109 = xor i32 %108, %106, !mcsema_real_eip !7
  %110 = icmp slt i32 %108, 0
  %111 = xor i32 %107, %106, !mcsema_real_eip !7
  %112 = and i32 %109, %111, !mcsema_real_eip !7
  %113 = icmp slt i32 %112, 0
  %tmp71.i = xor i1 %110, %113
...
sub_0.exit:                                       ; preds = %block_0x48.loopexit.i, %driverBlockRaw
  %ZF_val.0.i = phi i1 [ %84, %driverBlockRaw ], [ %94, %block_0x48.loopexit.i ]
  %PF_val.0.in.in.i = phi i8 [ %83, %driverBlockRaw ], [ %93, %block_0x48.loopexit.i ]
  %AF_val.0.in.in.i = phi i32 [ %81, %driverBlockRaw ], [ %91, %block_0x48.loopexit.i ]
  %CF_val.0.i = phi i1 [ %86, %driverBlockRaw ], [ %95, %block_0x48.loopexit.i ]
  %SF_val.0.i = phi i1 [ %85, %driverBlockRaw ], [ %.lcssa32, %block_0x48.loopexit.i ]
  %RSI_val.0.i = phi i64 [ %4, %driverBlockRaw ], [ %90, %block_0x48.loopexit.i ]
  %RDX_val.0.i = phi i64 [ %3, %driverBlockRaw ], [ %89, %block_0x48.loopexit.i ]
  %RCX_val.0.i = phi i64 [ %2, %driverBlockRaw ], [ %.lcssa, %block_0x48.loopexit.i ]
  %OF_val.0.i = phi i1 [ %88, %driverBlockRaw ], [ %.lcssa33, %block_0x48.loopexit.i ]
  ...
  %114 = load i32* %76, align 4, !mcsema_real_eip !17
  %115 = zext i32 %114 to i64, !mcsema_real_eip !17
  %116 = load i64* %69, align 8, !mcsema_real_eip !18
  %117 = add i64 %6, 8, !mcsema_real_eip !19
  store i64 %115, i64* %RAX.i, align 8, !mcsema_real_eip !19
  store i64 %1, i64* %RBX.i, align 8, !mcsema_real_eip !19
  ...
  store i64 %117, i64* %RSP.i, align 8, !mcsema_real_eip !19
  store i64 %116, i64* %RBP.i, align 8, !mcsema_real_eip !19
