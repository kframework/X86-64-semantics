...
driverBlockRaw:
  %_local_stack_alloc_88.i = alloca [24 x i64], align 8
  %STi_val.i = alloca [8 x x86_fp80], align 16, !mcsema_real_eip !2
  %1 = bitcast [24 x i64]* %_local_stack_alloc_88.i to i8*
  call void @llvm.lifetime.start(i64 192, i8* %1)
  %STi_val.i.0..sroa_cast = bitcast [8 x x86_fp80]* %STi_val.i to i8*
  call void @llvm.lifetime.start(i64 128, i8* %STi_val.i.0..sroa_cast)
  %_local_stack_start_.i = ptrtoint [24 x i64]* %_local_stack_alloc_88.i to i64
  ...
  %73 = add i64 %_local_stack_start_.i, -16, !mcsema_real_eip !4
  %74 = trunc i64 %5 to i32, !mcsema_real_eip !4
  %75 = inttoptr i64 %73 to i32*
  store i32 %74, i32* %75, align 8, !mcsema_real_eip !4
  %76 = load i32* %72, align 4, !mcsema_real_eip !5
  %77 = add i32 %76, %74
  %78 = zext i32 %77 to i64, !mcsema_real_eip !6
  %79 = add i64 %_local_stack_start_.i, -20, !mcsema_real_eip !7
  %80 = inttoptr i64 %79 to i32*
  store i32 %77, i32* %80, align 4, !mcsema_real_eip !7
  %81 = load i32* %72, align 4, !mcsema_real_eip !8
  %82 = add i32 %81, -40
  %83 = icmp eq i32 %82, 0, !mcsema_real_eip !8
  %84 = icmp slt i32 %82, 0
  %85 = sub i32 39, %81
  %86 = and i32 %85, %81
  %87 = icmp slt i32 %86, 0
  %88 = xor i1 %84, %87
  %89 = or i1 %83, %88, !mcsema_real_eip !9
  br i1 %89, label %block_0x30.i, label %block_0x20.i, !mcsema_real_eip !9

block_0x30.i:                                     ; preds = %driverBlockRaw
  %90 = add i32 %77, -10
  %91 = xor i32 %90, %77, !mcsema_real_eip !10
  %92 = and i32 %91, 16, !mcsema_real_eip !10
  %93 = icmp ne i32 %92, 0, !mcsema_real_eip !10
  %94 = trunc i32 %90 to i8, !mcsema_real_eip !10
  %95 = tail call i8 @llvm.ctpop.i8(i8 %94) #0, !mcsema_real_eip !10
  %96 = and i8 %95, 1
  %97 = icmp eq i8 %96, 0
  %98 = icmp eq i32 %90, 0, !mcsema_real_eip !10
  %99 = icmp slt i32 %90, 0
  %100 = icmp ult i32 %77, 10, !mcsema_real_eip !10
  %101 = and i32 %91, %77, !mcsema_real_eip !10
  %102 = icmp slt i32 %101, 0
  %103 = add i64 %_local_stack_start_.i, -24, !mcsema_real_eip !11
  %104 = inttoptr i64 %103 to i32*
  store i32 %90, i32* %104, align 8, !mcsema_real_eip !11
  %105 = load i32* %80, align 4, !mcsema_real_eip !12
  %106 = zext i32 %105 to i64, !mcsema_real_eip !12
  %107 = load i64* %69, align 8, !mcsema_real_eip !13
  %108 = add i64 %_local_stack_start_.i, 8, !mcsema_real_eip !14
  ...
  store i64 %78, i64* %RSI.i, align 8, !mcsema_real_eip !14
  store i64 %6, i64* %RDI.i, align 8, !mcsema_real_eip !14
  store i64 %108, i64* %RSP.i, align 8, !mcsema_real_eip !14
  store i64 %107, i64* %RBP.i, align 8, !mcsema_real_eip !14
  ...
  store i1 %97, i1* %PF.i, align 1, !mcsema_real_eip !14
  store i1 %93, i1* %AF.i, align 1, !mcsema_real_eip !14
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %19, i8* %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false) #0, !mcsema_real_eip !14
...
block_0x20.i:                                     ; preds = %driverBlockRaw
  %uadd140.i = tail call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %77, i32 10) #0
  %109 = extractvalue { i32, i1 } %uadd140.i, 0
  %110 = xor i32 %109, %77, !mcsema_real_eip !15
  %111 = and i32 %110, 16, !mcsema_real_eip !15
  %112 = icmp ne i32 %111, 0, !mcsema_real_eip !15
  %113 = icmp slt i32 %109, 0
  %114 = icmp eq i32 %109, 0, !mcsema_real_eip !15
  %115 = xor i32 %77, -2147483648, !mcsema_real_eip !15
  %116 = and i32 %110, %115, !mcsema_real_eip !15
  %117 = icmp slt i32 %116, 0
  %118 = trunc i32 %109 to i8, !mcsema_real_eip !15
  %119 = tail call i8 @llvm.ctpop.i8(i8 %118) #0, !mcsema_real_eip !15
  %120 = and i8 %119, 1
  %121 = icmp eq i8 %120, 0
  %122 = extractvalue { i32, i1 } %uadd140.i, 1
  store i32 %109, i32* %80, align 4, !mcsema_real_eip !16
  %123 = zext i32 %109 to i64, !mcsema_real_eip !12
  %124 = load i64* %69, align 8, !mcsema_real_eip !13
  %125 = add i64 %_local_stack_start_.i, 8, !mcsema_real_eip !14
  store i64 %123, i64* %RAX.i, align 8, !mcsema_real_eip !14
  store i64 %2, i64* %RBX.i, align 8, !mcsema_real_eip !14
  store i64 %3, i64* %RCX.i, align 8, !mcsema_real_eip !14
  store i64 %4, i64* %RDX.i, align 8, !mcsema_real_eip !14
  store i64 %78, i64* %RSI.i, align 8, !mcsema_real_eip !14
  store i64 %6, i64* %RDI.i, align 8, !mcsema_real_eip !14
  store i64 %125, i64* %RSP.i, align 8, !mcsema_real_eip !14
  store i64 %124, i64* %RBP.i, align 8, !mcsema_real_eip !14
  store i64 %8, i64* %R8.i, align 8, !mcsema_real_eip !14
  store i64 %9, i64* %R9.i, align 8, !mcsema_real_eip !14
  store i64 %10, i64* %R10.i, align 8, !mcsema_real_eip !14
  store i64 %11, i64* %R11.i, align 8, !mcsema_real_eip !14
  ...
  store i64 %15, i64* %R15.i, align 8, !mcsema_real_eip !14
  store i64 %16, i64* %RIP.i, align 8, !mcsema_real_eip !14
  store i1 %122, i1* %CF.i, align 1, !mcsema_real_eip !14
  store i1 %121, i1* %PF.i, align 1, !mcsema_real_eip !14
  store i1 %112, i1* %AF.i, align 1, !mcsema_real_eip !14
  store i1 %114, i1* %ZF.i, align 1, !mcsema_real_eip !14
  store i1 %113, i1* %SF.i, align 1, !mcsema_real_eip !14
  store i1 %117, i1* %OF.i, align 1, !mcsema_real_eip !14
  store i1 %17, i1* %DF.i, align 1, !mcsema_real_eip !14
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %19, i8* %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false) #0, !mcsema_real_eip !14
  store i1 %20, i1* %FPU_B.i, align 1, !mcsema_real_eip !14
  store i1 %21, i1* %FPU_C3.i, align 1, !mcsema_real_eip !14
...
sub_0.exit:                                       ; preds = %block_0x20.i, %block_0x30.i
  ret void
}
...
!4 = metadata !{i64 7, [21 x i8] c"\09movl\09%esi, -8(%rbp)\00"}
!5 = metadata !{i64 10, [21 x i8] c"\09movl\09-4(%rbp), %esi\00"}
!6 = metadata !{i64 13, [21 x i8] c"\09addl\09-8(%rbp), %esi\00"}
!7 = metadata !{i64 16, [22 x i8] c"\09movl\09%esi, -12(%rbp)\00"}
!8 = metadata !{i64 19, [20 x i8] c"\09cmpl\09$40, -4(%rbp)\00"}
!9 = metadata !{i64 26, [8 x i8] c"\09jle\0916\00"}
!10 = metadata !{i64 51, [16 x i8] c"\09subl\09$10, %eax\00"}
!11 = metadata !{i64 56, [22 x i8] c"\09movl\09%eax, -16(%rbp)\00"}
!12 = metadata !{i64 59, [22 x i8] c"\09movl\09-12(%rbp), %eax\00"}
!13 = metadata !{i64 62, [11 x i8] c"\09popq\09%rbp\00"}
!14 = metadata !{i64 63, [6 x i8] c"\09retq\00"}
!15 = metadata !{i64 35, [16 x i8] c"\09addl\09$10, %eax\00"}
!16 = metadata !{i64 40, [22 x i8] c"\09movl\09%eax, -12(%rbp)\00"}
