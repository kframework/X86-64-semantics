...
driverBlockRaw:
  ...
  %73 = add i64 %7, -56, !mcsema_real_eip !4
  ...
  %76 = add i64 %7, -16, !mcsema_real_eip !6
  ...
  %79 = add i64 %7, -24, !mcsema_real_eip !8
  ...
  %84 = add i64 %7, -25, !mcsema_real_eip !11
  %85 = inttoptr i64 %84 to i8*
  store i8 %83, i8* %85, align 1, !mcsema_real_eip !11
  %86 = tail call i8 @llvm.ctpop.i8(i8 %83) #0, !mcsema_real_eip !12
  %87 = icmp eq i8 %83, 0, !mcsema_real_eip !12
  br i1 %87, label %sub_0.exit, label %block_0x28.outer.i.preheader, !mcsema_real_eip !13

block_0x28.outer.i.preheader:                     ; preds = %driverBlockRaw
  br label %block_0x28.outer.i

block_0x28.outer.i:                               ; preds = %block_0x37.i, %block_0x28.outer.i.preheader
  %.ph.i = phi i8 [ %95, %block_0x37.i ], [ %83, %block_0x28.outer.i.preheader ]
  %RDX_val.0.ph.i = phi i64 [ %91, %block_0x37.i ], [ %4, %block_0x28.outer.i.preheader ]
  br label %block_0x28.i

block_0x28.i:                                     ; preds = %block_0x2e.i, %block_0x28.outer.i
  %88 = phi i8 [ %100, %block_0x2e.i ], [ %.ph.i, %block_0x28.outer.i ]
  %89 = icmp eq i8 %88, 47
  %90 = load i64* %80, align 8, !mcsema_real_eip !14
  br i1 %89, label %block_0x2e.i, label %block_0x37.i, !mcsema_real_eip !15

block_0x37.i:                                     ; preds = %block_0x28.i
  %.lcssa20 = phi i64 [ %90, %block_0x28.i ]
  %.lcssa = phi i8 [ %88, %block_0x28.i ]
  %91 = zext i8 %.lcssa to i64
  %92 = inttoptr i64 %.lcssa20 to i8*
  store i8 %.lcssa, i8* %92, align 1, !mcsema_real_eip !16
  %93 = load i64* %77, align 8, !mcsema_real_eip !17
  %94 = inttoptr i64 %93 to i8*
  %95 = load i8* %94, align 1, !mcsema_real_eip !18
  store i8 %95, i8* %85, align 1, !mcsema_real_eip !19
  %96 = icmp eq i8 %95, 0, !mcsema_real_eip !12
  br i1 %96, label %sub_0.exit.loopexit18, label %block_0x28.outer.i, !mcsema_real_eip !13

block_0x2e.i:                                     ; preds = %block_0x28.i
  %97 = inttoptr i64 %90 to i8*
  store i8 92, i8* %97, align 1, !mcsema_real_eip !20
  %98 = load i64* %77, align 8, !mcsema_real_eip !17
  %99 = inttoptr i64 %98 to i8*
  %100 = load i8* %99, align 1, !mcsema_real_eip !18
  store i8 %100, i8* %85, align 1, !mcsema_real_eip !19
  %101 = icmp eq i8 %100, 0, !mcsema_real_eip !12
  br i1 %101, label %sub_0.exit.loopexit, label %block_0x28.i, !mcsema_real_eip !13

sub_0.exit.loopexit:                              ; preds = %block_0x2e.i
  %RDX_val.0.ph.i.lcssa22 = phi i64 [ %RDX_val.0.ph.i, %block_0x2e.i ]
  br label %sub_0.exit

sub_0.exit.loopexit18:                            ; preds = %block_0x37.i
  %.lcssa23 = phi i64 [ %91, %block_0x37.i ]
  br label %sub_0.exit

sub_0.exit:                                       ; preds = %sub_0.exit.loopexit18, %sub_0.exit.loopexit, %driverBlockRaw
  %PF_val.0.in.in.i = phi i8 [ %86, %driverBlockRaw ], [ 0, %sub_0.exit.loopexit ], [ 0, %sub_0.exit.loopexit18 ]
  %RDX_val.1.i = phi i64 [ %4, %driverBlockRaw ], [ %RDX_val.0.ph.i.lcssa22, %sub_0.exit.loopexit ], [ %.lcssa23, %sub_0.exit.loopexit18 ]
  %PF_val.0.in.i = and i8 %PF_val.0.in.in.i, 1
  %PF_val.0.i = icmp eq i8 %PF_val.0.in.i, 0
  %102 = load i64* %70, align 8, !mcsema_real_eip !21
  %103 = add i64 %7, 8, !mcsema_real_eip !22
  store i64 0, i64* %RAX.i, align 8, !mcsema_real_eip !22
  store <2 x i64> %3, <2 x i64>* %2, align 8
  store i64 %RDX_val.1.i, i64* %RDX.i, align 8, !mcsema_real_eip !22
  store i64 %5, i64* %RSI.i, align 8, !mcsema_real_eip !22
  store i64 %6, i64* %RDI.i, align 8, !mcsema_real_eip !22
  store i64 %103, i64* %RSP.i, align 8, !mcsema_real_eip !22
  store i64 %102, i64* %RBP.i, align 8, !mcsema_real_eip !22
  ...
  store i1 %PF_val.0.i, i1* %PF.i, align 1, !mcsema_real_eip !22
...
!3 = metadata !{i64 4, [22 x i8] c"\09movq\09%rdi, -40(%rbp)\00"}
!4 = metadata !{i64 8, [22 x i8] c"\09movq\09%rsi, -48(%rbp)\00"}
!5 = metadata !{i64 12, [22 x i8] c"\09movq\09-40(%rbp), %rax\00"}
!6 = metadata !{i64 16, [21 x i8] c"\09movq\09%rax, -8(%rbp)\00"}
!7 = metadata !{i64 20, [22 x i8] c"\09movq\09-48(%rbp), %rax\00"}
!8 = metadata !{i64 24, [22 x i8] c"\09movq\09%rax, -16(%rbp)\00"}
!9 = metadata !{i64 28, [21 x i8] c"\09movq\09-8(%rbp), %rax\00"}
!10 = metadata !{i64 32, [21 x i8] c"\09movzbl\09(%rax), %eax\00"}
!11 = metadata !{i64 35, [21 x i8] c"\09movb\09%al, -17(%rbp)\00"}
!12 = metadata !{i64 85, [20 x i8] c"\09cmpb\09$0, -17(%rbp)\00"}
!13 = metadata !{i64 89, [9 x i8] c"\09jne\09-51\00"}
!14 = metadata !{i64 55, [22 x i8] c"\09movq\09-16(%rbp), %rax\00"}
!15 = metadata !{i64 44, [7 x i8] c"\09jne\099\00"}
!16 = metadata !{i64 63, [18 x i8] c"\09movb\09%dl, (%rax)\00"}
!17 = metadata !{i64 75, [21 x i8] c"\09movq\09-8(%rbp), %rax\00"}
!18 = metadata !{i64 79, [21 x i8] c"\09movzbl\09(%rax), %eax\00"}
!19 = metadata !{i64 82, [21 x i8] c"\09movb\09%al, -17(%rbp)\00"}
!20 = metadata !{i64 50, [18 x i8] c"\09movb\09$92, (%rax)\00"}
!21 = metadata !{i64 92, [11 x i8] c"\09popq\09%rbp\00"}
