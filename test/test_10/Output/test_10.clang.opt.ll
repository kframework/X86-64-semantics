...
block_0x34.i:                                     ; preds = %block_0x25.i, %block_0x34.i.preheader
  ...
  %RCX_val.1.i = phi i64 [ %RCX_val.2.i, %block_0x25.i ], [ %2, %block_0x34.i.preheader ]
  %88 = icmp eq i8 %87, 47
...
sub_0.exit:                                       ; preds = %sub_0.exit.loopexit, %driverBlockRaw
  ...
  store i64 %3, i64* %RDX.i, align 8, !mcsema_real_eip !26
  store i64 %80, i64* %RSI.i, align 8, !mcsema_real_eip !26
  store i64 %5, i64* %RDI.i, align 8, !mcsema_real_eip !26
