...
driverBlockRaw:
  ...
  %17 = load i1* %AF.i, align 1, !mcsema_real_eip !2
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %20, i8* %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false) #0, !mcsema_real_eip !9
