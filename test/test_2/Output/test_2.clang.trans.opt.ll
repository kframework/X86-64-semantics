...
driverBlockRaw:
  %_local_stack_alloc_85.i = alloca [48 x i64], align 8
  %STi_val.i = alloca [8 x x86_fp80], align 16, !mcsema_real_eip !2
  %1 = bitcast [48 x i64]* %_local_stack_alloc_85.i to i8*
  call void @llvm.lifetime.start(i64 384, i8* %1)
  %STi_val.i.0..sroa_cast = bitcast [8 x x86_fp80]* %STi_val.i to i8*
  call void @llvm.lifetime.start(i64 128, i8* %STi_val.i.0..sroa_cast)
  %_local_stack_start_.i = ptrtoint [48 x i64]* %_local_stack_alloc_85.i to i64
  ...
  %68 = tail call i8 @llvm.ctpop.i8(i8 %67) #0, !mcsema_real_eip !3
  %69 = and i8 %68, 1
  %70 = icmp eq i8 %69, 0
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %12, i8* %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false) #0, !mcsema_real_eip !9
...
!3 = metadata !{i64 116, [16 x i8] c"\09subq\09$32, %rsp\00"}
!4 = metadata !{i64 163, [19 x i8] c"\09movl\09$0, -4(%rbp)\00"}
!5 = metadata !{i64 170, [18 x i8] c"\09movl\09$70, (%rsp)\00"}
!6 = metadata !{i64 177, [19 x i8] c"\09movl\09$80, 8(%rsp)\00"}
!7 = metadata !{i64 185, [23 x i8] c"\09movl\09%r10d, -12(%rbp)\00"}
!8 = metadata !{i64 189, [22 x i8] c"\09movl\09%eax, -16(%rbp)\00"}
!9 = metadata !{i64 192, [12 x i8] c"\09callq\09-197\00"}
