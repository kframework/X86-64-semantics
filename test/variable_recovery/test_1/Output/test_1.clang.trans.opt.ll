...
driverBlockRaw:
  ...
  %_local_stack_start_ptr_6.i = alloca [16 x i8], align 1
  ...
  %1 = getelementptr inbounds [16 x i8], [16 x i8]* %_local_stack_start_ptr_6.i, i64 0, i64 0
  call void @llvm.lifetime.start(i64 16, i8* nonnull %1)
  %STi_val.i.0..sroa_cast = bitcast [8 x x86_fp80]* %STi_val.i to i8*
  call void @llvm.lifetime.start(i64 128, i8* nonnull %STi_val.i.0..sroa_cast)
  %_local_stack_end_ptr_.i = getelementptr inbounds [16 x i8], [16 x i8]* %_local_stack_start_ptr_6.i, i64 0, i64 16
  ...
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_10.i4 = load i8*, i8** %74, align 8
  %_new_gep_.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_10.i4, i64 -8
  ...
  %_new_gep_1.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_10.i4, i64 -12
  %76 = bitcast i8* %_new_gep_1.i to i32*
  store i32 0, i32* %76, align 4, !mcsema_real_eip !3
  %77 = bitcast i64* %_RBP_ptr_.sroa.0.i to i8**
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_311.i5 = load i8*, i8** %77, align 8
  %_new_gep_4.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_311.i5, i64 -8
  %78 = bitcast i8* %_new_gep_4.i to i32*
  store i32 1, i32* %78, align 4, !mcsema_real_eip !4
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_612.i6 = load i8*, i8** %77, align 8
  %_new_gep_7.i = getelementptr i8, i8* %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_612.i6, i64 -8
  %79 = bitcast i8* %_new_gep_7.i to i32*
  %80 = load i32, i32* %79, align 4, !mcsema_real_eip !5
  %81 = zext i32 %80 to i64, !mcsema_real_eip !5
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_913.i7 = load i8*, i8** %74, align 8
  %_allin_new_bt_10.i = bitcast i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_913.i7 to i64*
  %82 = load i64, i64* %_allin_new_bt_10.i, align 8
  store volatile i64 %82, i64* %_RBP_ptr_.sroa.0.i, align 8
  %_new_gep_11.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_913.i7, i64 16
  %83 = ptrtoint i8* %_new_gep_11.i to i64
  store volatile i64 %83, i64* %_RSP_ptr_.sroa.0.i, align 8
  store i64 %81, i64* %RAX.i, align 8, !mcsema_real_eip !6
  %84 = bitcast i64* %RBX.i to <2 x i64>*
  store <2 x i64> %4, <2 x i64>* %84, align 8
  %85 = bitcast i64* %RDX.i to <2 x i64>*
  store <2 x i64> %6, <2 x i64>* %85, align 8
  store i64 %7, i64* %RDI.i, align 8, !mcsema_real_eip !6
  store volatile i64 %83, i64* %RSP.i, align 8
  store volatile i64 %82, i64* %RBP.i, align 8
  %86 = bitcast i64* %R8.i to <2 x i64>*
  store <2 x i64> %9, <2 x i64>* %86, align 8
  %87 = bitcast i64* %R10.i to <2 x i64>*
  store <2 x i64> %11, <2 x i64>* %87, align 8
  %88 = bitcast i64* %R12.i to <2 x i64>*
  store <2 x i64> %13, <2 x i64>* %88, align 8
  %89 = bitcast i64* %R14.i to <2 x i64>*
  store <2 x i64> %15, <2 x i64>* %89, align 8
  ...
  %90 = bitcast i64* %STACK_BASE.i to <2 x i64>*
  store <2 x i64> %73, <2 x i64>* %90, align 1
