...
driverBlockRaw:
  ...
  store i32 0, i32* %75, align 4, !mcsema_real_eip !3
  %76 = bitcast [16 x i8]* %_local_stack_start_ptr_1.i to i32*
  store i32 1, i32* %76, align 4, !mcsema_real_eip !4
  ...
  %_new_gep_11.i = getelementptr [16 x i8], [16 x i8]* %_local_stack_start_ptr_1.i, i64 0, i64 24
  store volatile i8* %_new_gep_11.i, i8** %_RSP_ptr_.i, align 8
  store i64 1, i64* %RAX.i, align 8, !mcsema_real_eip !5
  %77 = bitcast i64* %RBX.i to <2 x i64>*
  store <2 x i64> %3, <2 x i64>* %77, align 8
  %78 = bitcast i64* %RDX.i to <2 x i64>*
  store <2 x i64> %5, <2 x i64>* %78, align 8
  ...
  store <2 x i64> %8, <2 x i64>* %79, align 8
  %80 = bitcast i64* %R10.i to <2 x i64>*
  store <2 x i64> %10, <2 x i64>* %80, align 8
  %81 = bitcast i64* %R12.i to <2 x i64>*
  store <2 x i64> %12, <2 x i64>* %81, align 8
  %82 = bitcast i64* %R14.i to <2 x i64>*
  store <2 x i64> %14, <2 x i64>* %82, align 8
  ...
  store <2 x i64> %73, <2 x i64>* %83, align 1
