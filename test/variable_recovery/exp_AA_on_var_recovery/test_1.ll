...
entry:
  %foo_local_stack_start_ptr_ = alloca i8, i64 32
  %foo_local_stack_end_ptr_ = getelementptr inbounds i8, i8* %foo_local_stack_start_ptr_, i64 32
  %foo_bt_local_stack_start_ptr_ = bitcast i8* %foo_local_stack_start_ptr_ to i64*
  %foo_bt_local_stack_end_ptr_ = bitcast i8* %foo_local_stack_end_ptr_ to i64*
  %foo_local_stack_start_ = ptrtoint i64* %foo_bt_local_stack_start_ptr_ to i64
  %foo_local_stack_end_ = ptrtoint i64* %foo_bt_local_stack_end_ptr_ to i64
  ...
  store i64 %foo_local_stack_end_, i64* %fooRSP_val
  ...
  call void @bar(%struct.regs* %0, i64 %foo_local_stack_start_, i64 %foo_local_stack_end_)
...
entry:
  %bar_local_stack_start_ptr_ = alloca i8, i64 28
  %bar_local_stack_end_ptr_ = getelementptr inbounds i8, i8* %bar_local_stack_start_ptr_, i64 28
  %bar_bt_local_stack_start_ptr_ = bitcast i8* %bar_local_stack_start_ptr_ to i64*
  %bar_bt_local_stack_end_ptr_ = bitcast i8* %bar_local_stack_end_ptr_ to i64*
  %bar_local_stack_start_ = ptrtoint i64* %bar_bt_local_stack_start_ptr_ to i64
  %bar_local_stack_end_ = ptrtoint i64* %bar_bt_local_stack_end_ptr_ to i64
  ...
  store i64 %bar_local_stack_end_, i64* %barRSP_val
