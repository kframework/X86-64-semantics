...
driverBlockRaw:
  ...
  store volatile i64 %7, i64* %_RSP_ptr_.sroa.0.i, align 8
  store volatile i64 %7, i64* %_RBP_ptr_.sroa.0.i, align 8
  ...
  %9 = bitcast i64* %_RBP_ptr_.sroa.0.i to i8**
  %foo101.i = or i64 %foo83.i, 4
  %foo103.i = inttoptr i64 %foo101.i to i32*
  store i32 2, i32* %foo103.i, align 4
  %_RBP_ptr_.sroa.0.i.0._RBP_ptr_.sroa.0.0._RBP_ptr_.sroa.0.0._RBP_ptr_.0._load_rbp_ptr_1419.i4 = load i8*, i8** %9, align 8
  ...
  %10 = bitcast i64* %_RSP_ptr_.sroa.0.i to i8**
  %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_1720.i5 = load i8*, i8** %10, align 8
  %_allin_new_bt_18.i = bitcast i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_1720.i5 to i64*
  %foo1151314.i = load i64, i64* %_allin_new_bt_18.i, align 8
  store volatile i64 %foo1151314.i, i64* %_RBP_ptr_.sroa.0.i, align 8
  %_new_gep_19.i = getelementptr i8, i8* %_RSP_ptr_.sroa.0.i.0._RSP_ptr_.sroa.0.0._RSP_ptr_.sroa.0.0._RSP_ptr_.0._load_rsp_ptr_1720.i5, i64 16
  %11 = ptrtoint i8* %_new_gep_19.i to i64
  store volatile i64 %11, i64* %_RSP_ptr_.sroa.0.i, align 8
  ...
  store volatile i64 %foo1151314.i, i64* %RBP.i, align 8
