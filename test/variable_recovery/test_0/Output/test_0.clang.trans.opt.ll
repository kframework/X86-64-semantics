...
driverBlockRaw:
  ...
  %_local_stack_start_ptr_11.i = alloca [32 x i8], align 8
  ...
  %_new_gep_.i = getelementptr inbounds [32 x i8], [32 x i8]* %_local_stack_start_ptr_11.i, i64 0, i64 24
  %_allin_new_bt_.i = bitcast i8* %_new_gep_.i to i64*
  store volatile i64 undef, i64* %_allin_new_bt_.i, align 8
  %7 = ptrtoint i8* %_new_gep_.i to i64
  store volatile i64 %7, i64* %_RSP_ptr_9.sroa.0.i, align 8
  store volatile i64 %7, i64* %_RBP_ptr_10.sroa.0.i, align 8
  %_new_gep_1.i = getelementptr inbounds [32 x i8], [32 x i8]* %_local_stack_start_ptr_11.i, i64 0, i64 8
  %foo83.i = ptrtoint i8* %_new_gep_1.i to i64
  %_new_gep_3.i = getelementptr inbounds [32 x i8], [32 x i8]* %_local_stack_start_ptr_11.i, i64 0, i64 20
  %foo86.i = bitcast i8* %_new_gep_3.i to i32*
  store i32 0, i32* %foo86.i, align 4
  %_allin_new_bt_7.i = bitcast [32 x i8]* %_local_stack_start_ptr_11.i to i64*
  store i64 %foo83.i, i64* %_allin_new_bt_7.i, align 8
  %8 = bitcast i8* %_new_gep_1.i to i32*
  store i32 1, i32* %8, align 8
  %9 = bitcast i64* %_RBP_ptr_10.sroa.0.i to i8**
  %foo101.i = or i64 %foo83.i, 4
  %foo103.i = inttoptr i64 %foo101.i to i32*
  store i32 2, i32* %foo103.i, align 4
  %_RBP_ptr_10.sroa.0.i.0._RBP_ptr_10.sroa.0.0._RBP_ptr_10.sroa.0.0._load_rbp_ptr_1421.i4 = load i8*, i8** %9, align 8
  %_new_gep_15.i = getelementptr i8, i8* %_RBP_ptr_10.sroa.0.i.0._RBP_ptr_10.sroa.0.0._RBP_ptr_10.sroa.0.0._load_rbp_ptr_1421.i4, i64 -24
  ...
  %10 = bitcast i64* %_RSP_ptr_9.sroa.0.i to i8**
  %_RSP_ptr_9.sroa.0.i.0._RSP_ptr_9.sroa.0.0._RSP_ptr_9.sroa.0.0._load_rsp_ptr_1722.i5 = load i8*, i8** %10, align 8
  %_allin_new_bt_18.i = bitcast i8* %_RSP_ptr_9.sroa.0.i.0._RSP_ptr_9.sroa.0.0._RSP_ptr_9.sroa.0.0._load_rsp_ptr_1722.i5 to i64*
  %foo1151516.i = load i64, i64* %_allin_new_bt_18.i, align 8
  store volatile i64 %foo1151516.i, i64* %_RBP_ptr_10.sroa.0.i, align 8
  %_new_gep_19.i = getelementptr i8, i8* %_RSP_ptr_9.sroa.0.i.0._RSP_ptr_9.sroa.0.0._RSP_ptr_9.sroa.0.0._load_rsp_ptr_1722.i5, i64 16
  %11 = ptrtoint i8* %_new_gep_19.i to i64
  store volatile i64 %11, i64* %_RSP_ptr_9.sroa.0.i, align 8
  ...
  store volatile i64 %foo1151516.i, i64* %RBP.i, align 8
