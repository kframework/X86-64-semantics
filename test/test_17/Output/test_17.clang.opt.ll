...
driverBlockRaw:
  ...
  %72 = add i64 %6, -12, !mcsema_real_eip !4
  %73 = inttoptr i64 %72 to i32*
  store i32 0, i32* %73, align 4, !mcsema_real_eip !4
  br label %block_0x22.i

block_0x22.i:                                     ; preds = %block_0x53.i, %driverBlockRaw
  %74 = phi i32 [ 0, %driverBlockRaw ], [ %88, %block_0x53.i ]
  %RDX_val.1.i = phi i64 [ %3, %driverBlockRaw ], [ %RDX_val.2.i, %block_0x53.i ]
  %RCX_val.1.i = phi i64 [ %2, %driverBlockRaw ], [ %RCX_val.2.i, %block_0x53.i ]
  %75 = sext i32 %74 to i64, !mcsema_real_eip !5
  %76 = shl nsw i64 %75, 3
  %77 = add i64 %76, add (i64 ptrtoint (%0* @data_0x68 to i64), i64 16), !mcsema_real_eip !6
  %78 = inttoptr i64 %77 to i64*, !mcsema_real_eip !6
  %79 = load i64* %78, align 8, !mcsema_real_eip !6
  %80 = icmp eq i64 %79, 0, !mcsema_real_eip !6
  br i1 %80, label %block_0x53.i, label %block_0x38.i, !mcsema_real_eip !7

block_0x38.i:                                     ; preds = %block_0x22.i
  %81 = inttoptr i64 %79 to i32*
  %82 = load i32* %81, align 4, !mcsema_real_eip !8
  %83 = zext i32 %82 to i64, !mcsema_real_eip !8
  %84 = load i32* %71, align 4, !mcsema_real_eip !9
  %85 = add i32 %84, %82
  %86 = zext i32 %85 to i64, !mcsema_real_eip !10
  store i32 %85, i32* %71, align 4, !mcsema_real_eip !11
  %.pre.i = load i32* %73, align 4
  br label %block_0x53.i, !mcsema_real_eip !12

block_0x53.i:                                     ; preds = %block_0x38.i, %block_0x22.i
  %87 = phi i32 [ %74, %block_0x22.i ], [ %.pre.i, %block_0x38.i ]
  %RDX_val.2.i = phi i64 [ %RDX_val.1.i, %block_0x22.i ], [ %86, %block_0x38.i ]
  %RCX_val.2.i = phi i64 [ %RCX_val.1.i, %block_0x22.i ], [ %83, %block_0x38.i ]
  %88 = add i32 %87, 1
  store i32 %88, i32* %73, align 4, !mcsema_real_eip !13
  %89 = icmp ult i32 %88, 10
  br i1 %89, label %block_0x22.i, label %sub_0.exit, !mcsema_real_eip !14

sub_0.exit:                                       ; preds = %block_0x53.i
  %.lcssa = phi i32 [ %88, %block_0x53.i ]
  ...
  %90 = sext i32 %.lcssa to i64, !mcsema_real_eip !15
  %91 = add nsw i64 %90, -10
  %92 = xor i64 %91, %90, !mcsema_real_eip !16
  %93 = and i64 %92, %90, !mcsema_real_eip !16
  %94 = icmp slt i64 %93, 0
  %95 = icmp slt i64 %91, 0
  %96 = icmp eq i64 %91, 0, !mcsema_real_eip !16
  %97 = trunc i64 %91 to i8, !mcsema_real_eip !16
  %98 = tail call i8 @llvm.ctpop.i8(i8 %97) #0, !mcsema_real_eip !16
  %99 = and i8 %98, 1
  %100 = icmp eq i8 %99, 0
  %101 = and i64 %92, 16, !mcsema_real_eip !16
  %102 = icmp ne i64 %101, 0, !mcsema_real_eip !16
  %103 = load i32* %71, align 4, !mcsema_real_eip !17
  %104 = zext i32 %103 to i64, !mcsema_real_eip !17
  %105 = load i64* %69, align 8, !mcsema_real_eip !18
  %106 = add i64 %6, 8, !mcsema_real_eip !19
  store i64 %104, i64* %RAX.i, align 8, !mcsema_real_eip !19
  ...
  store i64 %106, i64* %RSP.i, align 8, !mcsema_real_eip !19
  store i64 %105, i64* %RBP.i, align 8, !mcsema_real_eip !19
  ...
  store i1 %100, i1* %PF.i, align 1, !mcsema_real_eip !19
  store i1 %102, i1* %AF.i, align 1, !mcsema_real_eip !19
  store i1 %96, i1* %ZF.i, align 1, !mcsema_real_eip !19
  store i1 %95, i1* %SF.i, align 1, !mcsema_real_eip !19
  store i1 %94, i1* %OF.i, align 1, !mcsema_real_eip !19
...
!16 = metadata !{i64 22, [16 x i8] c"\09cmpq\09$10, %rax\00"}
