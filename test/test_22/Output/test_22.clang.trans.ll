...
entry:
  ...
  %84 = load x86_fp80* %83, !mcsema_real_eip !4
  %85 = load i3* %FPU_TOP_val, !mcsema_real_eip !4
  %86 = add i3 %85, -1
  store i3 %86, i3* %FPU_TOP_val, !mcsema_real_eip !4
  %87 = zext i3 %86 to i32, !mcsema_real_eip !4
  %88 = getelementptr inbounds [8 x x86_fp80]* %STi_val, i32 0, i32 %87, !mcsema_real_eip !4
  %89 = getelementptr inbounds [8 x i2]* %FPU_TAG_val, i32 0, i32 %87, !mcsema_real_eip !4
  %90 = load i2* %89, !mcsema_real_eip !4
...
fpu_write:                                        ; preds = %fpu_exception, %entry
  ...
  %92 = load i64* %RBP_val, !mcsema_real_eip !5
  %93 = add i64 %92, -16, !mcsema_real_eip !5
  %94 = inttoptr i64 %93 to i64*, !mcsema_real_eip !5
  %95 = load i3* %FPU_TOP_val, !mcsema_real_eip !5
  %96 = zext i3 %95 to i32, !mcsema_real_eip !5
  %97 = getelementptr inbounds [8 x i2]* %FPU_TAG_val, i32 0, i32 %96, !mcsema_real_eip !5
  %98 = load i2* %97, !mcsema_real_eip !5
...
fpu_read_normal:                                  ; preds = %fpu_write
  %99 = getelementptr inbounds [8 x x86_fp80]* %STi_val, i32 0, i32 %96, !mcsema_real_eip !5
  %100 = load x86_fp80* %99, !mcsema_real_eip !5
...
fpu_read_continue:                                ; preds = %fpu_read_normal, %fpu_write
  ...
  %102 = load i3* %FPU_TOP_val, !mcsema_real_eip !5
  %103 = zext i3 %102 to i32, !mcsema_real_eip !5
  %104 = getelementptr inbounds [8 x i2]* %FPU_TAG_val, i32 0, i32 %103, !mcsema_real_eip !5
  store i2 -1, i2* %104, !mcsema_real_eip !5
  %105 = load i3* %FPU_TOP_val, !mcsema_real_eip !5
  store i64 ptrtoint (%0* @data_0x2c to i64), i64* %FPU_LASTDATA_OFF_val, !mcsema_real_eip !6
  %106 = load double* bitcast (%0* @data_0x2c to double*), !mcsema_real_eip !6
  %107 = fpext double %106 to x86_fp80, !mcsema_real_eip !6
  %108 = zext i3 %105 to i32, !mcsema_real_eip !6
  %109 = getelementptr inbounds [8 x x86_fp80]* %STi_val, i32 0, i32 %108, !mcsema_real_eip !6
  %110 = getelementptr inbounds [8 x i2]* %FPU_TAG_val, i32 0, i32 %108, !mcsema_real_eip !6
  %111 = load i2* %110, !mcsema_real_eip !6
...
fpu_write1:                                       ; preds = %fpu_exception2, %fpu_read_continue
  ...
  %113 = load i3* %FPU_TOP_val, !mcsema_real_eip !7
  %114 = zext i3 %113 to i32, !mcsema_real_eip !7
  %115 = getelementptr inbounds [8 x i2]* %FPU_TAG_val, i32 0, i32 %114, !mcsema_real_eip !7
  %116 = load i2* %115, !mcsema_real_eip !7
...
fpu_read_normal4:                                 ; preds = %fpu_write1
  %117 = getelementptr inbounds [8 x x86_fp80]* %STi_val, i32 0, i32 %114, !mcsema_real_eip !7
  %118 = load x86_fp80* %117, !mcsema_real_eip !7
...
fpu_read_continue6:                               ; preds = %fpu_read_normal4, %fpu_write1
  ...
  store i1 false, i1* %FPU_C1_val
  %119 = load i3* %FPU_TOP_val, !mcsema_real_eip !7
  %120 = add i3 %119, -1
  store i3 %120, i3* %FPU_TOP_val, !mcsema_real_eip !7
  %121 = zext i3 %120 to i32, !mcsema_real_eip !7
  %122 = getelementptr inbounds [8 x x86_fp80]* %STi_val, i32 0, i32 %121, !mcsema_real_eip !7
  %123 = getelementptr inbounds [8 x i2]* %FPU_TAG_val, i32 0, i32 %121, !mcsema_real_eip !7
  %124 = load i2* %123, !mcsema_real_eip !7
...
fpu_write8:                                       ; preds = %fpu_exception9, %fpu_read_continue6
  ...
  %126 = load i64* %RBP_val, !mcsema_real_eip !8
  %127 = add i64 %126, -32, !mcsema_real_eip !8
  %128 = inttoptr i64 %127 to i64*, !mcsema_real_eip !8
  %129 = load i3* %FPU_TOP_val, !mcsema_real_eip !8
  %130 = zext i3 %129 to i32, !mcsema_real_eip !8
  %131 = getelementptr inbounds [8 x i2]* %FPU_TAG_val, i32 0, i32 %130, !mcsema_real_eip !8
  %132 = load i2* %131, !mcsema_real_eip !8
...
fpu_read_normal12:                                ; preds = %fpu_write8
  %133 = getelementptr inbounds [8 x x86_fp80]* %STi_val, i32 0, i32 %130, !mcsema_real_eip !8
  %134 = load x86_fp80* %133, !mcsema_real_eip !8
...
fpu_read_continue14:                              ; preds = %fpu_read_normal12, %fpu_write8
  ...
  %136 = load i3* %FPU_TOP_val, !mcsema_real_eip !8
  %137 = zext i3 %136 to i32, !mcsema_real_eip !8
  %138 = getelementptr inbounds [8 x i2]* %FPU_TAG_val, i32 0, i32 %137, !mcsema_real_eip !8
  store i2 -1, i2* %138, !mcsema_real_eip !8
  %139 = load i3* %FPU_TOP_val, !mcsema_real_eip !8
  %140 = add i3 %139, 1, !mcsema_real_eip !8
  store i3 %140, i3* %FPU_TOP_val, !mcsema_real_eip !8
  %141 = load i64* %RBP_val, !mcsema_real_eip !9
  ...
  %145 = load x86_fp80* %144, !mcsema_real_eip !9
  store i3 %139, i3* %FPU_TOP_val, !mcsema_real_eip !9
  %146 = zext i3 %139 to i32, !mcsema_real_eip !9
  %147 = getelementptr inbounds [8 x x86_fp80]* %STi_val, i32 0, i32 %146, !mcsema_real_eip !9
  %148 = getelementptr inbounds [8 x i2]* %FPU_TAG_val, i32 0, i32 %146, !mcsema_real_eip !9
  %149 = load i2* %148, !mcsema_real_eip !9
...
fpu_write17:                                      ; preds = %fpu_exception18, %fpu_read_continue14
  ...
  %151 = load i3* %FPU_TOP_val, !mcsema_real_eip !10
  %152 = zext i3 %151 to i32, !mcsema_real_eip !10
  %153 = getelementptr inbounds [8 x i2]* %FPU_TAG_val, i32 0, i32 %152, !mcsema_real_eip !10
  %154 = load i2* %153, !mcsema_real_eip !10
...
fpu_read_normal20:                                ; preds = %fpu_write17
  %155 = getelementptr inbounds [8 x x86_fp80]* %STi_val, i32 0, i32 %152, !mcsema_real_eip !10
  %156 = load x86_fp80* %155, !mcsema_real_eip !10
...
fpu_read_continue22:                              ; preds = %fpu_read_normal20, %fpu_write17
  ...
  store i1 false, i1* %FPU_C1_val
  %157 = load i3* %FPU_TOP_val, !mcsema_real_eip !10
  %158 = add i3 %157, 1, !mcsema_real_eip !10
  %159 = zext i3 %158 to i32, !mcsema_real_eip !10
  %160 = getelementptr inbounds [8 x i2]* %FPU_TAG_val, i32 0, i32 %159, !mcsema_real_eip !10
  %161 = load i2* %160, !mcsema_real_eip !10
...
fpu_read_normal24:                                ; preds = %fpu_read_continue22
  %162 = getelementptr inbounds [8 x x86_fp80]* %STi_val, i32 0, i32 %159, !mcsema_real_eip !10
  %163 = load x86_fp80* %162, !mcsema_real_eip !10
...
fpu_read_continue26:                              ; preds = %fpu_read_normal24, %fpu_read_continue22
  ...
  %165 = load i3* %FPU_TOP_val, !mcsema_real_eip !10
  %166 = add i3 %165, 1, !mcsema_real_eip !10
  %167 = zext i3 %166 to i32, !mcsema_real_eip !10
  %168 = getelementptr inbounds [8 x x86_fp80]* %STi_val, i32 0, i32 %167, !mcsema_real_eip !10
  %169 = getelementptr inbounds [8 x i2]* %FPU_TAG_val, i32 0, i32 %167, !mcsema_real_eip !10
  %170 = load i2* %169, !mcsema_real_eip !10
...
fpu_write28:                                      ; preds = %fpu_exception29, %fpu_read_continue26
  ...
  %172 = load i3* %FPU_TOP_val, !mcsema_real_eip !10
  %173 = zext i3 %172 to i32, !mcsema_real_eip !10
  %174 = getelementptr inbounds [8 x i2]* %FPU_TAG_val, i32 0, i32 %173, !mcsema_real_eip !10
  store i2 -1, i2* %174, !mcsema_real_eip !10
  %175 = load i3* %FPU_TOP_val, !mcsema_real_eip !10
  %176 = add i3 %175, 1, !mcsema_real_eip !10
  store i3 %176, i3* %FPU_TOP_val, !mcsema_real_eip !10
  %177 = load i64* %RSP_val, !mcsema_real_eip !11
  %178 = inttoptr i64 %177 to i64*, !mcsema_real_eip !11
  %179 = load i64* %178, !mcsema_real_eip !11
...
!4 = metadata !{i64 20, [15 x i8] c"\09fldt\0916(%rbp)\00"}
!5 = metadata !{i64 23, [17 x i8] c"\09fstpt\09-16(%rbp)\00"}
!6 = metadata !{i64 26, [13 x i8] c"\09fldl\09(%rip)\00"}
!7 = metadata !{i64 32, [12 x i8] c"\09fld\09%st(0)\00"}
!8 = metadata !{i64 34, [17 x i8] c"\09fstpt\09-32(%rbp)\00"}
!9 = metadata !{i64 37, [16 x i8] c"\09fldt\09-16(%rbp)\00"}
!10 = metadata !{i64 40, [14 x i8] c"\09fmulp\09%st(1)\00"}
!11 = metadata !{i64 42, [11 x i8] c"\09popq\09%rbp\00"}
!12 = metadata !{i64 43, [6 x i8] c"\09retq\00"}
