...
block_0x25.i:                                     ; preds = %block_0x25.i.preheader, %block_0x25.i
  ...
  %96 = load i64, i64* %71, align 8, !mcsema_real_eip !10
  %97 = sext i32 %95 to i64, !mcsema_real_eip !11
  %98 = shl nsw i64 %97, 2
  %99 = add i64 %98, %96, !mcsema_real_eip !12
...
sub_0.exit:                                       ; preds = %driverBlockRaw, %block_0x44.loopexit.i
  ...
  %RDX_val.0.i = phi i64 [ %3, %driverBlockRaw ], [ %89, %block_0x44.loopexit.i ]
  %RCX_val.0.i = phi i64 [ %2, %driverBlockRaw ], [ %97, %block_0x44.loopexit.i ]
  ...
  %116 = add i64 %6, 8, !mcsema_real_eip !18
  ...
  store i64 %4, i64* %RSI.i, align 8, !mcsema_real_eip !18
  store i64 %5, i64* %RDI.i, align 8, !mcsema_real_eip !18
...
!10 = !{i64 37, [21 x i8] c"\09movq\09-8(%rbp), %rax\00"}
!11 = !{i64 41, [24 x i8] c"\09movslq\09-20(%rbp), %rcx\00"}
!12 = !{i64 45, [26 x i8] c"\09movl\09(%rax,%rcx,4), %edx\00"}
