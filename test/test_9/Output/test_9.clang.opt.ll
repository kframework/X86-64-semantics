...
driverBlockRaw:
  ...
  %1 = load i64* %RAX.i, align 8, !mcsema_real_eip !2
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %STi_val.i.0..sroa_cast, i8* %18, i32 128, i32 4, i1 false) #0, !mcsema_real_eip !2
  ...
  %72 = tail call i8 @llvm.ctpop.i8(i8 %71) #0, !mcsema_real_eip !3
  %73 = icmp eq i32 %68, 0
...
block_0x13.loopexit.i:                            ; preds = %block_0xd.i
  %.lcssa = phi i32 [ %78, %block_0xd.i ]
  %75 = zext i32 %.lcssa to i64, !mcsema_real_eip !5
  br label %sub_1.exit
...
sub_1.exit:                                       ; preds = %block_0x13.loopexit.i, %driverBlockRaw
  ...
  %81 = add i64 %5, 8, !mcsema_real_eip !7
  ...
  store i64 %4, i64* %RDI.i, align 8, !mcsema_real_eip !7
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %18, i8* %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false) #0, !mcsema_real_eip !7
