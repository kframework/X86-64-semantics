...
entry:
  ...
  %108 = load i64* %107, !mcsema_real_eip !10
  ...
  %125 = load i1* %SF_val, !mcsema_real_eip !13
  ...
  %128 = load i1* %PF_val, !mcsema_real_eip !13
  ...
  %145 = load i64* %RSP_val, !mcsema_real_eip !18
  %146 = inttoptr i64 %145 to i64*, !mcsema_real_eip !18
  %147 = load i64* %146, !mcsema_real_eip !18
  ...
  %149 = load i64* %RAX_val, !mcsema_real_eip !19
  store i64 %149, i64* %RAX, !mcsema_real_eip !19
  %150 = load i64* %RBX_val, !mcsema_real_eip !19
  store i64 %150, i64* %RBX, !mcsema_real_eip !19
  %151 = load i64* %RCX_val, !mcsema_real_eip !19
  store i64 %151, i64* %RCX, !mcsema_real_eip !19
  %152 = load i64* %RDX_val, !mcsema_real_eip !19
  store i64 %152, i64* %RDX, !mcsema_real_eip !19
  %153 = load i64* %RSI_val, !mcsema_real_eip !19
  store i64 %153, i64* %RSI, !mcsema_real_eip !19
  %154 = load i64* %RDI_val, !mcsema_real_eip !19
  store i64 %154, i64* %RDI, !mcsema_real_eip !19
  %155 = load i64* %RSP_val, !mcsema_real_eip !19
  store i64 %155, i64* %RSP, !mcsema_real_eip !19
  %156 = load i64* %RBP_val, !mcsema_real_eip !19
  store i64 %156, i64* %RBP, !mcsema_real_eip !19
  %157 = load i64* %R8_val, !mcsema_real_eip !19
  store i64 %157, i64* %R8, !mcsema_real_eip !19
  %158 = load i64* %R9_val, !mcsema_real_eip !19
  store i64 %158, i64* %R9, !mcsema_real_eip !19
  %159 = load i64* %R10_val, !mcsema_real_eip !19
  store i64 %159, i64* %R10, !mcsema_real_eip !19
  %160 = load i64* %R11_val, !mcsema_real_eip !19
  store i64 %160, i64* %R11, !mcsema_real_eip !19
  %161 = load i64* %R12_val, !mcsema_real_eip !19
  store i64 %161, i64* %R12, !mcsema_real_eip !19
  %162 = load i64* %R13_val, !mcsema_real_eip !19
  store i64 %162, i64* %R13, !mcsema_real_eip !19
  %163 = load i64* %R14_val, !mcsema_real_eip !19
  store i64 %163, i64* %R14, !mcsema_real_eip !19
  %164 = load i64* %R15_val, !mcsema_real_eip !19
  store i64 %164, i64* %R15, !mcsema_real_eip !19
  %165 = load i64* %RIP_val, !mcsema_real_eip !19
  store i64 %165, i64* %RIP, !mcsema_real_eip !19
  %166 = load i1* %CF_val, !mcsema_real_eip !19
  store i1 %166, i1* %CF, align 1, !mcsema_real_eip !19
  %167 = load i1* %PF_val, !mcsema_real_eip !19
  store i1 %167, i1* %PF, align 1, !mcsema_real_eip !19
  %168 = load i1* %AF_val, !mcsema_real_eip !19
  store i1 %168, i1* %AF, align 1, !mcsema_real_eip !19
  %169 = load i1* %ZF_val, !mcsema_real_eip !19
  store i1 %169, i1* %ZF, align 1, !mcsema_real_eip !19
  %170 = load i1* %SF_val, !mcsema_real_eip !19
  store i1 %170, i1* %SF, align 1, !mcsema_real_eip !19
  %171 = load i1* %OF_val, !mcsema_real_eip !19
  store i1 %171, i1* %OF, align 1, !mcsema_real_eip !19
  %172 = load i1* %DF_val, !mcsema_real_eip !19
...
!5 = metadata !{i64 7, [22 x i8] c"\09movq\09%rsi, -16(%rbp)\00"}
!6 = metadata !{i64 11, [22 x i8] c"\09movq\09-16(%rbp), %rsi\00"}
!7 = metadata !{i64 15, [19 x i8] c"\09movq\09(%rsi), %rsi\00"}
!8 = metadata !{i64 18, [22 x i8] c"\09movq\09%rsi, -24(%rbp)\00"}
!9 = metadata !{i64 22, [21 x i8] c"\09movl\09-4(%rbp), %edi\00"}
!10 = metadata !{i64 25, [22 x i8] c"\09movq\09-24(%rbp), %rsi\00"}
!11 = metadata !{i64 29, [17 x i8] c"\09movl\09%edi, %edi\00"}
!12 = metadata !{i64 31, [17 x i8] c"\09movl\09%edi, %ecx\00"}
!13 = metadata !{i64 33, [16 x i8] c"\09shrq\09%cl, %rsi\00"}
!14 = metadata !{i64 36, [22 x i8] c"\09movq\09%rsi, -24(%rbp)\00"}
!15 = metadata !{i64 40, [22 x i8] c"\09movq\09-24(%rbp), %rsi\00"}
!16 = metadata !{i64 44, [22 x i8] c"\09movq\09-16(%rbp), %rax\00"}
!17 = metadata !{i64 48, [19 x i8] c"\09movq\09%rsi, (%rax)\00"}
!18 = metadata !{i64 51, [11 x i8] c"\09popq\09%rbp\00"}
!19 = metadata !{i64 52, [6 x i8] c"\09retq\00"}
