...
driverBlockRaw:
  ...
  call void @llvm.lifetime.start(i64 160, i8* %1)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %STi_val.i.0..sroa_cast, i8* %25, i32 128, i32 4, i1 false) #0, !mcsema_real_eip !2
  ...
  %79 = load i64* %75, align 8, !mcsema_real_eip !5
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %25, i8* %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false) #0, !mcsema_real_eip !6
  ...
  call void @llvm.lifetime.end(i64 160, i8* %1)
