...
driverBlockRaw:
  %_local_stack_alloc_22.i = alloca [24 x i64], align 8
  %STi_val.i = alloca [8 x x86_fp80], align 16, !mcsema_real_eip !2
  %1 = bitcast [24 x i64]* %_local_stack_alloc_22.i to i8*
  call void @llvm.lifetime.start(i64 192, i8* %1)
  %STi_val.i.0..sroa_cast = bitcast [8 x x86_fp80]* %STi_val.i to i8*
  call void @llvm.lifetime.start(i64 128, i8* %STi_val.i.0..sroa_cast)
  %_local_stack_start_.i = ptrtoint [24 x i64]* %_local_stack_alloc_22.i to i64
  ...
  %70 = add i64 %_local_stack_start_.i, -16, !mcsema_real_eip !3
  %71 = inttoptr i64 %70 to i64*, !mcsema_real_eip !3
  store i64 %5, i64* %71, align 8, !mcsema_real_eip !3
  %72 = tail call x86_64_sysvcc i64 @printf(i64 ptrtoint (%0* @data_0x7c to i64), i64 %5, i64 %4, i64 %3), !mcsema_real_eip !4
  %73 = add i64 %_local_stack_start_.i, -20, !mcsema_real_eip !5
  %74 = trunc i64 %72 to i32, !mcsema_real_eip !5
  %75 = inttoptr i64 %73 to i32*
  store i32 %74, i32* %75, align 4, !mcsema_real_eip !5
  %76 = load i64* %71, align 8, !mcsema_real_eip !6
  %77 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%0* @data_0x7c to i64), i64 4), i64 %76, i64 %76, i64 %3), !mcsema_real_eip !7
  %78 = trunc i64 %77 to i32, !mcsema_real_eip !8
  store i32 %78, i32* %75, align 4, !mcsema_real_eip !8
  %79 = load i64* %71, align 8, !mcsema_real_eip !9
  %80 = tail call x86_64_sysvcc i64 @printf(i64 add (i64 ptrtoint (%0* @data_0x7c to i64), i64 12), i64 %79, i64 %79, i64 %79), !mcsema_real_eip !10
  %81 = trunc i64 %80 to i32, !mcsema_real_eip !11
  store i32 %81, i32* %75, align 4, !mcsema_real_eip !11
  %82 = and i64 %80, 4294967295
  %uadd.i = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %69, i64 16)
  %83 = extractvalue { i64, i1 } %uadd.i, 0
  %84 = xor i64 %83, %69, !mcsema_real_eip !12
  %85 = and i64 %84, 16
  %86 = icmp eq i64 %85, 0
  %87 = icmp slt i64 %83, 0
  %88 = icmp eq i64 %83, 0, !mcsema_real_eip !12
  %89 = add i64 %_local_stack_start_.i, 9223372036854775784
  %90 = and i64 %84, %89, !mcsema_real_eip !12
  %91 = icmp slt i64 %90, 0
  %92 = trunc i64 %83 to i8, !mcsema_real_eip !12
  %93 = tail call i8 @llvm.ctpop.i8(i8 %92), !mcsema_real_eip !12
  %94 = and i8 %93, 1
  %95 = icmp eq i8 %94, 0
  %96 = extractvalue { i64, i1 } %uadd.i, 1
  %97 = inttoptr i64 %83 to i64*, !mcsema_real_eip !13
  %98 = load i64* %97, align 8, !mcsema_real_eip !13
  %99 = add i64 %83, 16, !mcsema_real_eip !14
  store i64 %82, i64* %RAX.i, align 8, !mcsema_real_eip !14
  store i64 %2, i64* %RBX.i, align 8, !mcsema_real_eip !14
  store i64 %79, i64* %RCX.i, align 8, !mcsema_real_eip !14
  store i64 %79, i64* %RDX.i, align 8, !mcsema_real_eip !14
  ...
  store i64 %99, i64* %RSP.i, align 8, !mcsema_real_eip !14
  store i64 %98, i64* %RBP.i, align 8, !mcsema_real_eip !14
  ...
  store i1 %96, i1* %CF.i, align 1, !mcsema_real_eip !14
  store i1 %95, i1* %PF.i, align 1, !mcsema_real_eip !14
  store i1 %86, i1* %AF.i, align 1, !mcsema_real_eip !14
  store i1 %88, i1* %ZF.i, align 1, !mcsema_real_eip !14
  store i1 %87, i1* %SF.i, align 1, !mcsema_real_eip !14
  store i1 %91, i1* %OF.i, align 1, !mcsema_real_eip !14
  store i1 %16, i1* %DF.i, align 1, !mcsema_real_eip !14
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %18, i8* %STi_val.i.0..sroa_cast, i32 128, i32 8, i1 false), !mcsema_real_eip !14
  ...
  store i128 %49, i128* %XMM0.i, align 1, !mcsema_real_eip !14
  store i128 %50, i128* %XMM1.i, align 1, !mcsema_real_eip !14
  store i128 %51, i128* %XMM2.i, align 1, !mcsema_real_eip !14
  store i128 %52, i128* %XMM3.i, align 1, !mcsema_real_eip !14
  store i128 %53, i128* %XMM4.i, align 1, !mcsema_real_eip !14
  store i128 %54, i128* %XMM5.i, align 1, !mcsema_real_eip !14
  store i128 %55, i128* %XMM6.i, align 1, !mcsema_real_eip !14
  store i128 %56, i128* %XMM7.i, align 1, !mcsema_real_eip !14
  store i128 %57, i128* %XMM8.i, align 1, !mcsema_real_eip !14
  store i128 %58, i128* %XMM9.i, align 1, !mcsema_real_eip !14
  store i128 %59, i128* %XMM10.i, align 1, !mcsema_real_eip !14
  store i128 %60, i128* %XMM11.i, align 1, !mcsema_real_eip !14
  store i128 %61, i128* %XMM12.i, align 1, !mcsema_real_eip !14
  store i128 %62, i128* %XMM13.i, align 1, !mcsema_real_eip !14
  store i128 %63, i128* %XMM14.i, align 1, !mcsema_real_eip !14
  store i128 %64, i128* %XMM15.i, align 1, !mcsema_real_eip !14
